...
Validator Clue is a deprecated game on Berachain

#### Commands 

Make sure to install and build packages from root of the project before running this from `apps/validator-clue`
