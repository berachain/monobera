export default function Rules() {
  return (
    <div className="h-full rounded-sm bg-muted p-4">
      ...
      <div>
        Each player, henceforth known as a "Validator", is secretly assigned a
        Liquidity Pool, referred to as their "Mystery Pool". This information is
        as confidential as your grandmother's secret cookie recipe – guard it
        with your life!
      </div>
    </div>
  );
