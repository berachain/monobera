...
export default function RedelegateQueueTable({
  unbondingQueue,
}: {
    ...
    return (
      <div className="m-6 flex flex-col items-center justify-center gap-4">
        ...
        <div className="flex text-center text-lg font-semibold text-foreground">
          No Redelegate Requests
        </div>
        <div className="font-subtle flex text-sm text-muted-foreground">
          You don’t have any active redelegation requests, they’ll appear here
          when there are active withdrawals in the queue
        </div>
      </div>
    );
  };
