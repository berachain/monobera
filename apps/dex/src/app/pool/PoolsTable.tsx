...
export const PoolSearch = () => {
  ...
  return (
    <div className="w-full flex-col items-center justify-center" id='poolstable'>
      ...
      <div className="w-full text-center ">
        ...
        <div className="flex sm:flex-row flex-col sm:items-center items-center sm:justify-between justify-center mt-12 w-full gap-2">
          ...
          <div className="flex w-full flex-row items-center sm:justify-end justify-start gap-2">
            <FilterBadge
              text={"🚀 New Pools"}
              active={isNewPool}
