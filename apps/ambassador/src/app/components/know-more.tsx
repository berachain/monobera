...
export default function KnowMore() {
  return (
    <div className="p-8 lg:mt-8">
      <div className="mx-auto flex w-full flex-col justify-between rounded-xl border border-solid bg-muted sm:min-h-[300px] sm:flex-row sm:px-8 md:h-[220px] md:max-w-[1080px]">
