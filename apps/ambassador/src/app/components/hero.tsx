  ...
  return (
    <div className="mb-[-120px] mt-[-60px] flex flex-col flex-wrap items-center justify-between p-4 sm:px-8 lg:flex-row lg:px-32 xl:px-48">
      <div className="mb-6 flex flex-col items-center justify-center gap-4 lg:items-start">
        <h1 className="text-[42px] font-extrabold leading-[48px] lg:text-[64px] lg:leading-[72px] lg:text-left text-center">
        ...
        <div className="text-sm text-center font-medium leading-normal text-muted-foreground sm:text-base lg:text-lg lg:text-left">
