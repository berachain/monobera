  ...
  return (
    <div className="mt-8 flex w-full flex-col items-center justify-center gap-4 border-t bg-muted p-x-32 pb-32 pt-32">
      ...
      <Accordion
        type="single"
        collapsible
        className=" lg:w-[520px] md:w-[420px] sm:w-[360px] gap-4"
      >
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent className="lg:w-[520px] md:w-[420px] sm:w-[360px] pl-1 text-sm font-medium leading-tight text-muted-foreground">
            Bera community is based predominantly on twitter and discord. Spence
            Bera recommends joining the official Berachain discord & ecosystem
            projects discords to get involved.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
