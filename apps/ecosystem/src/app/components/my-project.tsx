...
export default function MyProject() {
  return (
    <div className="flex gap-8 px-0 pb-16 pt-[64px]">
      <div className="relative">
        <div className="relative mx-auto flex min-h-[300px] min-w-[400px] gap-4 rounded-xl border border-solid bg-muted px-8 py-4 md:h-[220px] md:min-w-[400px] lg:w-[558px]">
      ...
      <div className="relative">
        ...
        {/* <div className="relative hidden justify-end sm:flex">
          <div className="absolute bottom-0 right-0 xl:bottom-[-10%] xl:right-[-10%]">
            <Image
              src="/ecobear.png"
              alt="Project"
              width={200}
              height={200}
              layout="intrinsic"
              className="lg:h-auto lg:w-auto lg:max-w-full"
            />
          </div>
        </div> */}
      </div>
