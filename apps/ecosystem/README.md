...
Ambassador is an application portal for the Berachain ecosystem projects.

#### Commands 

Make sure to install and build packages from root of the project before running this from `apps/ecosystem`
