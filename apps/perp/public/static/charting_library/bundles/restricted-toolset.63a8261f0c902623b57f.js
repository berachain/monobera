	...
	[5516, 9685],
	{
		...
		81351: (e, t, a) => {
			...
			function d(e) {
				...
				const [i, d] = (0, l.useRovingTabindexElement)(null);
		...
		12165: (e, t, a) => {
			...
			function c(e) {
				...
				const [c, d] = (0, o.useRovingTabindexElement)(null);
		...
		69297: (e, t, a) => {
			...
			function p(e) {
				...
				const S = s()(g.label, a && !h && g.labelOn);
				const _ = s()(
					t,
					g.wrapper,
		...
		54491: (e, t, a) => {
			...
			function x(e) {
				...
				const s = I.PLATFORM_ACCESSIBILITY_ENABLED
					? { role: "radiogroup", "aria-orientation": t }
					: {};
				return i.createElement("div", {
					...n,
					...s,
					onKeyDown: (0, T.createSafeMulticastEventHandler)((e) => {
			...
			const O = (0, y.registryContextType)();
			function H(e) {
				let t;
			...
			class L extends i.PureComponent {
				constructor(e, t) {
					...
					const i = a.activeChartStyle.value();
					const o = n.get();
					const l = (0, E.japaneseChartStyles)();
					this.state = {
						activeStyle: i,
						favorites: o,
				...
				render() {
					...
					return i.createElement(
						...
						(e) => {
							...
							const s = l.map((t) => this._renderPopupMenuItem(t, t === n, e));
							return i.createElement(
								p,
								{ id: a },
								g &&
				...
				_renderPopupMenuItem(e, t, a) {
					...
					const s = this._isStyleFavorited(e);
				...
				_handleAddFavorite(e) {
					...
					const { favoriteChartStylesService: a } = this.context;
					a.set([...t, e]);
				}
			...
			function z(e) {
				const { tooltip: t, ...a } = e;
				const [n, s] = (0, D.useRovingTabindexElement)(null);
			...
			const ee = (0, y.registryContextType)();
			function te(e) {
			...
			const Ce = (0, y.registryContextType)();
			class Se extends i.PureComponent {
					...
					super(e, t),
						...
						(this._handleSelectIndicator = (e) => {
							...
							(() => {
								...
								const { chartWidgetCollection: t } = this.context;
								if ("java" === e.type) {
									const t = (0, re.tryFindStudyLineToolNameByStudyId)(
										e.studyId,
									);
						...
						(this._handleFavoriteIndicatorsChange = () => {
							...
							const t = [...(0, ne.ensureDefined)(e).favorites()];
				...
				componentDidMount() {
					...
					const { favoriteScriptsModel: t, chartWidgetCollection: a } =
						this.context;
				...
				render() {
					...
					const { className: l, displayMode: r, id: h } = this.props;
					const { chartWidgetCollection: c } = this.context;
					return i.createElement(
						i.Fragment,
						null,
						i.createElement(
			...
			function Te(e) {
				const { className: t, ...a } = e;
				const [n, s] = (0, D.useRovingTabindexElement)(null);
				const o = I.PLATFORM_ACCESSIBILITY_ENABLED ? "button" : "div";
			...
			function Oe(e) {
				...
				const u = (0, xe.filterDataProps)(e);
				const [m, p] = (0, Ae.useHover)();
				const g = i.useCallback((e) => h(t, e), [h, t]);
				const b = i.useCallback(() => c(t), [c, t]);
					...
					i.createElement(
						...
						i.createElement(A.AccessibleMenuItem, {
							...
							toolbox: (() => {
								...
								const l = i.createElement(Ne.MenuRemoveButton, {
									key: "remove",
									isActive: n,
									hidden: !Re.touch && !m,
									onClick: g,
								...
								const r = i.createElement(R.MenuFavoriteButton, {
									key: "favorite",
									isActive: n,
									isFilled: o,
									onClick: b,
			...
			const Qe = (0, G.hotKeySerialize)({
				keys: [","],
				text: o.t(null, void 0, a(14605)),
			});
			const qe = (0, y.registryContextType)();
			const je = new Pe.Delegate();
			const Ge = i.lazy(async () => ({
				default: (
					await Promise.all([
						a.e(1013),
						a.e(5145),
			...
			class Ye extends i.PureComponent {
				constructor(e, t) {
					super(e, t),
						...
						(this._getHandleSectionStateChange = (e) => (t) => {
							...
							const { intervalsMenuViewStateService: n } = this.context;
							n.set({ ...a, [e]: !t });
						}),
						...
						(this._handleGlobalClose = () => {
							...
							const { isAddIntervalDialogOpened: t } = this.state;
							e || t || je.fire();
						}),
					...
					const d = c && (0, fe.normalizeIntervalString)(c);
					const u = o.get();
					const v = r.getCustomIntervals();
					const m = h.get();
				...
				render() {
					...
					const l = this._getQuicks();
					const r = (0, fe.sortResolutions)([...l]);
					void 0 !== a && r.includes(a)
						? void 0 !== s && r.push(s)
						: void 0 !== a && r.push(a);
					const h = (!(!e || 0 === l.length) || void 0) && r.length > 1;
					const c = {};
					const v = (0, fe.mergeResolutions)(this._defaultIntervals, n);
				...
				_createMenuItems(e, t) {
					const a = ((e) => {
						...
						const a = De(He.ResolutionKind.Seconds);
						const n = De(He.ResolutionKind.Minutes);
						const i = De(He.SpecialResolutionKind.Hours);
						const s = De(He.ResolutionKind.Days);
						const o = De(He.ResolutionKind.Range);
						return (
							e.forEach((e) => {
				...
				_renderResolutionsGroup(e, t, a) {
					const n = [];
					const s = e.items.map((e) => this._renderPopupMenuItem(e, a));
					if (t) n.push(...s);
					else if (a) {
				...
				_renderPopupMenuItem(e, t) {
					...
					const { activeInterval: n, lastAddedInterval: s } = this.state;
					const o = e === n;
					const l = (0, fe.isAvailable)(e);
					const r = this._isIntervalFavorite(e);
					const h = this._isIntervalDefault(e);
					const c = (0, fe.getTranslatedResolutionModel)(e);
				...
				constructor(e, t) {
					super(e, t),
						(this._handleClick = () => {
							...
							const n = e.activeChartWidget.value();
							n.withModel(null, () => {
			...
			class st extends i.PureComponent {
				constructor(e, t) {
					super(e, t),
						...
						(this._handleClick = (e) => {
							const { chartWidgetCollection: t } = this.context;
							const a = t.activeChartWidget.value();
							(0, V.trackEvent)(
								"GUI",
			...
			const Ct = o.t(null, void 0, a(75789));
			const St = (0, rt.mergeThemes)(P.DEFAULT_TOOL_WIDGET_BUTTON_THEME, gt);
			const _t = (0, rt.mergeThemes)(ie.DEFAULT_POPUP_MENU_ITEM_THEME, {
				shortcut: pt.shortcut,
				withIcon: pt.withIcon,
			});
			const ft = o.t(null, void 0, a(80959));
			const wt = o.t(null, void 0, a(11680));
			const yt = [];
			const Et = (0, G.hotKeySerialize)({
			...
			class Mt extends i.PureComponent {
				...
				render() {
					...
					const C = !t && !h;
					const S = !(r || !l || this.state.isSaving);
					const _ = i.createElement(
						"div",
				...
				_renderMenuItems(e) {
					...
					const y = e ? w.multilineLabelWithIconAndToolboxTheme : _t;
					const E = e ? void 0 : (0, Y.humanReadableHash)(Y.Modifiers.Mod + 83);
					const M = e ? void 0 : o.t(null, { context: "hotkey" }, a(14229));
					const T = [];
					return (
						T.push(
							i.createElement(ie.PopupMenuItem, {
			...
			const Nt = { takeSnapshot: o.t(null, void 0, a(88513)) };
			const Ft = (0, y.registryContextType)();
			...
			function Bt(e) {
				...
				const a = u(!e.isLoading && Pt.hidden);
				return i.createElement(
					"div",
					null,
			...
			function jt(e) {
				...
				const [l, r] = (0, i.useState)(!1);
				const [h, c] = (0, i.useState)(!1);
				const [d, v] = (0, i.useState)(!1);
				const [m, p] = (0, i.useState)(!1);
				const g = (0, Ut.useIsMounted)();
				const b = (0, i.useCallback)(async () => {
					let e;
					const t = n();
					const a = t.then(
						(e) =>
				...
				const S = (e) => Ht(e.then((e) => e.imageUrl));
			...
			function Yt(e) {
				...
				const n = (0, Ut.useIsMounted)();
				const s = (0, i.useCallback)(async () => {
			...
			class ia {
				...
				static preload() {
					null === ia._provider &&
						null === ia._implementation &&
						(ia._implementation = (0, na.loadNewSymbolSearch)());
				}
			}
			(ia._currentShowingInstance = null),
				(ia._provider = null),
			...
			function da(e) {
				...
				const [o, l] = (0, D.useRovingTabindexElement)(null);
								...
								null !==
									(t = ((e) => {
										...
										if (a) {
											...
											const [{ segment: i } = { segment: null }] = n.segment(e);
											return null !==
			...
			const Ca = (0, rt.mergeThemes)(ie.DEFAULT_POPUP_MENU_ITEM_THEME, {
				item: pa.item,
			});
			const Sa = (0, rt.mergeThemes)(ie.DEFAULT_POPUP_MENU_ITEM_THEME, {
			...
			function _a(e) {
				...
				const [c, d] = (0, Ae.useHover)();
				const u = a.meta_info;
				const m = u ? (0, ua.descriptionString)(u.indicators) : void 0;
				const p = h ? ba : ga;
				const g = h ? Sa : Ca;
				const b = (0, i.useCallback)(() => n(a), [n, a]);
				const C = (0, i.useCallback)((e) => s(a, e), [s, a]);
			...
			function xa(e) {
				...
				const c = (0, i.useMemo)(() => t.filter((e) => e.is_default), [t]);
				const d = (0, i.useMemo)(() => t.filter((e) => !e.is_default), [t]);
				const u = (0, i.useMemo)(() => new Set(a.map((e) => e.name)), [a]);
				const m = (0, i.useContext)(ka);
				const p = (0, i.useContext)(Ta.MenuContext);
				const g = (0, Ma.useForceUpdate)();
				(0, i.useEffect)(() => {
					if (null !== m) {
						const e = {};
						return (
				...
				constructor(e, t) {
					...
					const s =
						(null === (a = this._favoriteStudyTemplatesService) || void 0 === a
							? void 0
							: a.get()) || [];
					const o = this._studyTemplates.list();
			...
			function Pa(e) {
				...
				const w = r.filter((e) => l.includes(e.name));
				const y = "small" !== s && m && w.length > 0;
				return i.createElement(
					p,
					{ id: t, className: S },
					i.createElement(
			...
			const Za = (0, rt.mergeThemes)(g.DEFAULT_TOOLBAR_BUTTON_THEME, za);
			const Ka = (0, y.registryContextType)();
			class Qa extends i.PureComponent {
				...
				_getStateFromUndoHistory() {
					const { chartWidgetCollection: e } = this.context;
					const t = e.undoHistory.undoStack();
					const a = e.undoHistory.redoStack();
					const n = a.head();
					const i = t.head();
					return {
