(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5516, 9685],
  {
    ...
    54491: (e, t, a) => {
      "use strict";
      a.r(t), a.d(t, { getRestrictedToolSet: () => Xa });
      var n = a(14483),
        i = a(50959),
        s = a(19036),
        o = a(44352),
      ...
      function I(e) {
        const { orientation: t, onKeyDown: a, ...n } = e,
          s = x.PLATFORM_ACCESSIBILITY_ENABLED
            ? { role: "radiogroup", "aria-orientation": t }
            : {};
        return i.createElement("div", {
          ...n,
          ...s,
          onKeyDown: (0, k.createSafeMulticastEventHandler)(function (e) {
      ...
      function z(e) {
        ...
        return i.createElement(W, {
          "aria-label": x.PLATFORM_ACCESSIBILITY_ENABLED ? t : void 0,
          ...a,
      ...
      function ke(e) {
        const { className: t, ...a } = e,
          [n, s] = (0, D.useRovingTabindexElement)(null),
          o = x.PLATFORM_ACCESSIBILITY_ENABLED ? "button" : "div";
        return i.createElement(o, {
          ...a,
          ref: n,
          tabIndex: s,
          "data-role": x.PLATFORM_ACCESSIBILITY_ENABLED ? "menuitem" : void 0,
          className: v()(x.PLATFORM_ACCESSIBILITY_ENABLED && Me.accessible, t),
        });
      }
      function Te(e) {
        const { className: t, ...a } = e,
      ...
      var Oe = a(36274);
      const Le = {
        [Oe.ResolutionKind.Ticks]: o.t(
          null,
          { context: "interval_group_name" },
          a(30426),
        ),
        [Oe.ResolutionKind.Seconds]: o.t(
          null,
          { context: "interval_group_name" },
          a(74973),
        ),
        [Oe.ResolutionKind.Minutes]: o.t(
          null,
          { context: "interval_group_name" },
          a(57470),
        ),
        [Oe.SpecialResolutionKind.Hours]: o.t(
          null,
          { context: "interval_group_name" },
          a(62346),
        ),
        [Oe.ResolutionKind.Days]: o.t(
          null,
          { context: "interval_group_name" },
          a(74787),
        ),
        [Oe.ResolutionKind.Weeks]: o.t(
          null,
          { context: "interval_group_name" },
          a(86614),
        ),
        [Oe.ResolutionKind.Months]: o.t(
          null,
          { context: "interval_group_name" },
          a(94328),
        ),
        [Oe.ResolutionKind.Range]: o.t(
          null,
          { context: "interval_group_name" },
          a(48801),
        ),
        [Oe.ResolutionKind.Invalid]: "",
      };
      function De(e, t = !1) {
      ...
      function Ve(e) {
        ...
        return i.createElement(We.CollapsibleSection, {
          ...
          tabIndex: s,
          "data-role": x.PLATFORM_ACCESSIBILITY_ENABLED ? "menuitem" : void 0,
          className: v()(x.PLATFORM_ACCESSIBILITY_ENABLED && ze.accessible, t),
          onKeyDown: function (e) {
      ...
      class Ye extends i.PureComponent {
        ...
        _createMenuItems(e, t) {
          const a = (function (e) {
            const t = De(Oe.ResolutionKind.Ticks),
              a = De(Oe.ResolutionKind.Seconds),
              n = De(Oe.ResolutionKind.Minutes),
              i = De(Oe.SpecialResolutionKind.Hours),
              s = De(Oe.ResolutionKind.Days),
              o = De(Oe.ResolutionKind.Range);
            return (
              e.forEach((e) => {
                const l = Oe.Interval.parse(e);
                l.isMinuteHours()
                  ? i.items.push(e)
                  : l.isMinutes()
                  ? (0, Oe.isHour)(Number(l.multiplier()))
                    ? i.items.push(e)
                    : n.items.push(e)
                  : l.isSeconds()
                  ? a.items.push(e)
      ...
      const kt = (0, y.registryContextType)();
      ...
      var xt = a(53166),
        It = a(34928),
        At = a(79982);
      const Rt = new It.DateTimeFormatter({
          dateTimeSeparator: "_",
          timeFormat: "%h-%m-%s",
        }),
        Nt = { takeSnapshot: o.t(null, void 0, a(88513)) },
        Ft = (0, y.registryContextType)();
      const Ht = o.t(null, void 0, a(90879));
      function Ot(e, t, a) {
          ...
          const n = URL.createObjectURL(
            new Blob(
              [
                ...
                }"><head><meta charset="utf-8"><title>${Ht}</title></head><body style="background-color:${
      ...
      function da(e) {
        ...
        return x.PLATFORM_ACCESSIBILITY_ENABLED
          ? i.createElement(
              "button",
              {
                type: "button",
      ...
      function Ia(e) {
        ...
        return i.createElement(
          "div",
          { className: v()(xa.menu, r && xa.menuSmallTablet) },
        ...
        return i.createElement(
          ...
          n.length > 0 &&
            i.createElement(
              ...
              i.createElement(
                ve.ToolWidgetMenuSummary,
                { className: xa.menuItemHeaderTabletSmall },
              ...
              i.createElement(
                d.ToolbarMenuButton,
                {
                  ...
                  content: i.createElement(W, {
                    tag: "div",
                    className: v()(y && Oa.buttonWithFavorites),
                    displayMode: s,
                    isOpened: h,
                    icon: Ha,
                    forceInteractive: !0,
      ...
      function Ya(e) {
        ...
        return i.createElement(z, {
          ...n,
          className: u(t, Ga.customTradingViewStyleButton, Ga.withoutIcon),
          collapseWhen: [],
      ...
      function Xa() {
        return {
          ...
          Custom: qa,
          CustomTradingViewStyledButton: Ya,
          ...
          Properties:
            ...
            n.enabled("show_chart_property_page")
              ? st
              : void 0,
          SaveLoad: n.enabled("header_saveload") ? Tt : void 0,
