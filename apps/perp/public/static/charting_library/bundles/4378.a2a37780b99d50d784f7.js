	...
	[4378],
	{
		...
		64378: (e, t, n) => {
			...
			function b(e) {
				...
				const [p, C] = (0, a.useState)({ visible: t, hidden: [] });
				const k = (0, a.useMemo)(
					() => t.reduce((e, t, n) => (s(t) && e.push(n), e), []),
					[t, s],
				);
				...
				const x = (0, a.useCallback)(() => {
					...
					for (const i of t) {
						const t = n(i);
						const a = b.current.get(t);
						if (a) {
							const n = (0, c.outerWidth)(a, !0);
							e.set(t, n);
						}
					}
					(g.current.widthsMap = e), l?.();
				}, [g, t, n, b, l]);
				...
				const z = (0, o.useResizeObserver)(R);
				const B = (0, o.useResizeObserver)(A);
				const S = (0, a.useRef)(null);
				const N = (0, m.mergeRefs)([B, S]);
				const E = (0, a.useRef)(t);
				const W = (0, a.useRef)(!0);
				const H = (0, a.useRef)([]);
				return (
				...
				const l = (0, a.useCallback)(
					(n, a) => {
						...
						return (({
							...
							const d = [...n];
							if (
								((u = s.map((e) => d[e]).reduce((e, t) => e + t, 0) + a),
								l === i.EndFirst)
							)
				...
				return (
					...
					"automatic" === t
						? ((e) => {
								...
								return (0, R.useKeyboardEventHandler)(
									[(0, z.useItemsKeyboardNavigation)(t, n, s, c, !0)],
									i,
								);
						  })(e)
						: ((e) => {
								...
								const u = (0, a.useCallback)((e) => l(e), [l]);
								const d = (0, z.useItemsKeyboardNavigation)(t, n, s, u, !0);
								const m = (0, R.useKeyboardActionHandler)([13, 32], c);
			...
			function E(e) {
				...
				const g = (0, a.useRef)(new Map());
				const [C, I] = (0, a.useState)();
				const [R, z] = (0, y.useFocus)();
				const B = n.find(m);
				...
				return {
					tabsBindings: n.map((e) => {
						...
						const s =
							null !==
								(n = null !== (t = e.disabled) && void 0 !== t ? t : l) &&
							void 0 !== n &&
							n;
						const r = !s && (R ? i : a);
						return {
							...x(e.id, r, a, e.tabpanelId, s),
							highlighted: i,
							active: a,
							handleItemRef: K,
						};
			...
			const M = (0, a.forwardRef)((e, t) => {
				...
				const i = (0, a.useContext)(O.CustomBehaviourContext);
				const {
					active: s,
					fake: l,
					className: r,
			...
			function q(e) {
				...
				return a.createElement(D.Icon, {
					icon: U(t),
					className: s(V["arrow-icon"], V[`size-${t}`], n && V.dropped),
				});
			}
			const $ = n(45015);
			function Z(e) {
			...
			function se(e) {
				...
				const S = (0, a.useCallback)((e) => e.id, []);
				const N = "none" === z && I;
				const O = null != w ? w : !R;
				const {
					visibleItems: T,
				...
				const P = "collapse" === z ? T : i;
				const j = "collapse" === z ? F : [];
				const X = (0, a.useCallback)((e) => j.includes(e), [j]);
				const {
					tabsBindings: J,
					tablistBinding: V,
					scrollWrapBinding: U,
				...
				const le = (0, a.useCallback)(
					(e) => {
						let t;
						return null !== (t = J.find((t) => t.id === e.id)) && void 0 !== t
							? t
							: {};
					},
					[i, J],
				...
				return (
					...
					a.createElement(
						...
						a.createElement(
							...
							{
								...U,
								className: ne({ size: d, overflowBehaviour: z, className: f }),
								style: v,
								"data-name": A,
							},
							a.createElement(
			...
			(0, a.forwardRef)((e, t) => {
				...
				const s = (0, a.useContext)(O.CustomBehaviourContext);
				const {
					item: l,
					highlighted: r,
					handleItemRef: o,
				...
				const k = null !== (n = l.renderComponent) && void 0 !== n ? n : re;
				return a.createElement(
					k,
					{
						...g,
