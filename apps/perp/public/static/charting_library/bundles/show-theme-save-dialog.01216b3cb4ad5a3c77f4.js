(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7648],
  {
    ...
    89028: (e) => {
      e.exports = {
        ar: [
          "نسق الألوان ‎{themeName}‎موجود بالفعل. هل ترغب حقًا في استبداله؟",
        ],
        ca_ES: [
          "La paleta de colors '{themeName}' ja existeix. De debò que voleu substituir-la?",
        ],
        cs: "Color Theme '{themeName}' already exists. Do you really want to replace it?",
        de: [
          'Das Farbschema "{themeName}" gibt es schon. Wollen Sie es wirklich ersetzen?',
        ],
        ...
        fr: [
          "Le thème couleur '{themeName}' existe déjà. Voulez-vous vraiment le remplacer?",
        ],
        he_IL: [
          "צבע ערכת נושא‎{themeName}‎ כבר קיים. האם אתה באמת רוצה להחליפו?",
        ],
        hu_HU:
          "Color Theme '{themeName}' already exists. Do you really want to replace it?",
        id_ID: [
          "Warna Tema '{themeName}' sudah ada. Apakah benar anda ingin menggantinya?",
        ],
        it: ['Il tema colore "{themeName}" esiste già. Sovrascriverlo?'],
        ja: [
          "カラーテーマ '{themeName}' は既に存在しています。本当に置き換えますか？",
        ],
        ko: ["'{themeName}' 칼라 테마가 이미 있습니다. 바꾸시겠습니까?"],
        ms_MY: [
          "Tema warna '{themeName}' sudah wujud. Adakah anda ingin menggantikannya?",
        ],
        nl_NL:
          "Color Theme '{themeName}' already exists. Do you really want to replace it?",
        pl: [
        ...
        pt: [
          "O tema de cores '{themeName}' já existe. Você realmente quer substituí-lo?",
        ],
        ro: "Color Theme '{themeName}' already exists. Do you really want to replace it?",
        ru: [
          "Цветовая тема '{themeName}' уже существует. Вы действительно хотите её заменить?",
        ],
        sv: [
          "Färgtema '{themeName}' finns redan. Är du säker på att du vill byta ut det?",
        ],
        th: ["ธีมสี {themeName} มีอยู่แล้ว คุณต้องการที่จะแทนที่มันหรือไม่"],
        tr: [
          "{themeName} Renk Teması hali hazırda var. Değiştirmek istediğinizden emin misiniz?",
        ],
        vi: [
          "Chủ đề màu '{themeName}' đã tồn tại. Bạn có thực sự muốn thay thế nó?",
        ],
