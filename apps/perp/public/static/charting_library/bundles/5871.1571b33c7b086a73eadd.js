(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[5871],
	{
		...
		3347: (e, t, r) => {
			...
			function o(e, t, r) {
				const i = new Map();
				const o = void 0 !== t ? t[0] : (e) => e;
				const n = void 0 !== t ? (void 0 !== t[1] ? t[1] : t[0]) : (e) => e;
				const s = {
					value: () => o(e.value()),
					setValue: (t) => {
						e.setValue(n(t));
			...
			function n(e, t, r, n, s, l, p) {
				...
				const u = void 0 !== n ? (void 0 !== n[1] ? n[1] : n[0]) : (e) => e;
				const c = null != s ? s : (i) => e.setProperty(t, u(i), r);
				return (
					(a.setValue = (e) => {
						let t;
						p &&
		...
		43715: (e, t, r) => {
			...
			const s = [1, 2, 3, 4];
			const l = [i.LineEnd.Normal, i.LineEnd.Arrow];
			function p(e, t) {
		...
		46141: (e, t, r) => {
			...
			const D = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40].map((e) => ({
				title: String(e),
				value: e,
			}));
			const T = [1, 2, 3, 4];
			const m = v.t(null, void 0, r(92960));
			const g = v.t(null, void 0, r(90581));
			function h(e, t) {
				const r = {
					propType: "text",
					properties: e,
			...
			function N(e, t, r, i) {
				const o = M(t, i);
				const n = void 0 !== i ? (void 0 !== i[1] ? i[1] : i[0]) : (e) => e;
