		...
		50765: (t, e, i) => {
			...
			class f {
				...
				apply(t, e) {
					...
					const a = void 0 !== n || void 0 !== o || void 0 !== l;
			...
			function m(t) {
				...
				const i = [];
				const s = t.getElementsByTagName("stop");
				for (let t = 0; t < s.length; ++t) {
					const e = s[t];
					const r = u(e, "offset");
					const n = e.getAttribute("stop-color");
			...
			function S(t) {
				...
				const n = (0, s.ensureNotNull)(r.getAttribute("viewBox"))
					.split(" ")
					.map(parseFloat);
				const o = { x: n[0], y: n[1], width: n[2], height: n[3] };
				i.push(new x(o));
				let l = { getStyle: () => {} };
