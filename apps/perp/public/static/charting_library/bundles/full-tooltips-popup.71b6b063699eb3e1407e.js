	...
	[8643],
	{
					...
					(e.disableBodyScroll = (e, n) => {
						if (r) {
							...
							if (e && !a.some((t) => t.targetElement === e)) {
								const m = { targetElement: e, options: n || {} };
								(a = [].concat(t(a), [m])),
									(e.ontouchstart = (e) => {
							...
							const p = { targetElement: e, options: n || {} };
							a = [].concat(t(a), [p]);
						}
						let v;
					}),
		...
		41590: (e, t, o) => {
			...
			function m(e) {
				...
				const f = (0, r.ensureNotNull)((0, n.useContext)(l.DrawerContext));
				const [h] = (0, n.useState)(() => (0, s.randomHash)());
				const g = (0, n.useRef)(null);
				const w = (0, n.useContext)(c.CloseDelegateContext);
				return (
					(0, n.useLayoutEffect)(
						() => (
		...
		20520: (e, t, o) => {
			...
			function m(e) {
				...
				const y = (0, n.useContext)(l.CloseDelegateContext);
				const b = n.useContext(u);
				const C = (0, n.useContext)(c);
				const x = (0, d.useOutsideEvent)({
					handler: (e) => {
						f?.(e);
						if (!p) return;
