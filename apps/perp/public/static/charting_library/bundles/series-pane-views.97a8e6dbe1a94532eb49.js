(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[4079],
	{
		1539: (t, e, a) => {
			...
			const b = (0, r.getHexColorByName)("color-cold-gray-100");
					...
					(T.font = (0, n.makeFont)(12, u.CHART_FONT_FAMILY)),
						r
							...
							: ((g = T.measureText(null != a ? a : "").width),
							  ...
							  (f = Math.max(g, p)));
					const v = l ? 2 : 1;
					const x = (0, d.getThemedColor)("color-goto-label-background");
					(T.fillStyle = x), T.translate(s.x, s.y);
					const S = Math.round(-f / 2) - 8;
					const N = -9 * h;
					const w = N + h * (-17 * v - 8);
					const L = Math.round(S + f + 16);
					T.beginPath(),
						T.moveTo(S + 2, w),
						T.lineTo(L - 2, w),
			...
			class T {
				...
				_updateImpl() {
					...
					const o = this._series.firstValue();
					if (null === o) return;
					let d;
					let u;
					...
					const _ = e.timeScale().indexToCoordinate((0, i.ensureNotNull)(n));
					const b = new l.Point(_, c);
					let m;
					let T;
					if (!t) {
