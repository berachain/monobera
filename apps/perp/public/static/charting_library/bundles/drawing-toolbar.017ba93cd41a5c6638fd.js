	...
	[2878],
	{
		...
		50238: (e, t, o) => {
			...
			function a(e, t = []) {
				...
				const s = (0, i.useFunctionalRefObject)(e);
				return (
					(0, n.useLayoutEffect)(() => {
		...
		77975: (e, t, o) => {
			...
			const i = (e, t = !1) => {
				...
				const [l, a] = (0, n.useState)(o ? o.value() : i);
				return (
		...
		20520: (e, t, o) => {
			...
			function h(e) {
				...
				const C = (0, n.useContext)(r.CloseDelegateContext);
				const _ = n.useContext(d);
		...
		81261: (e, t, o) => {
			...
			function r(e) {
				...
				if (-1 === c) return;
				const v = m(r);
				const b = v.indexOf(document.activeElement);
				const p = -1 !== b;
				const g = (e) => {
		...
		81351: (e, t, o) => {
			...
			function d(e) {
				...
				const [i, d] = (0, s.useRovingTabindexElement)(null);
		...
		12165: (e, t, o) => {
			...
			function u(e) {
				...
				const [u, d] = (0, a.useRovingTabindexElement)(null);
		...
		14186: (e, t, o) => {
				...
				constructor(e) {
					super(e),
						...
						(this._handleScroll = () => {
							...
							e?.(this.currentPosition(), this.isAtTop(), this.isAtBot()),
								this._checkButtonsVisibility();
						}),
						(this._checkButtonsVisibility = () => {
							const { isVisibleTopButton: e, isVisibleBotButton: t } =
								this.state;
							const o = this.isAtTop();
							const n = this.isAtBot();
							o || e
			...
			const ie = ["0xF06C", "0xF185", "0xF186", "0xF188", "0xF0E7"];
			const le = [
				"0xF000",
				"0xF002",
				"0xF00E",
			...
			const ae = [...ee, ...te, ...oe, ...ne, ...ie, ...le].map((e) => +e);
			const se = new Set(ae);
			const re = [
				{
			...
			const Ce = (0, n.forwardRef)((e, t) => {
				...
				const F = (0, pe.mergeThemes)(me.DEFAULT_MENU_THEME, {
					menuBox: g.menuBox,
				});
				const k = I.PLATFORM_ACCESSIBILITY_ENABLED ? "button" : "div";
				const [L, S] = (0, n.useState)(!1);
				const [A, y] = (0, n.useState)(!1);
				const D = (0, n.useRef)(null);
				const N = (0, n.useRef)(null);
				const R = (0, n.useRef)(null);
				const W = (0, n.useRef)(0);
				const O = (0, n.useRef)(0);
				const [P, V] = (0, B.useRovingTabindexElement)(null);
				const [H, j] = (0, B.useRovingTabindexElement)(null);
				return (
			...
			const Ae = n.lazy(async () => {
				...
				return {
					default: (t) => {
						let o;
						const { charCode: i } = t;
						const l = null !== (o = e(i)) && void 0 !== o ? o : void 0;
			...
			const Ue = {
				...
				[O.Stickers]: {
					...
					ItemComponent: (e) => {
						const { emoji: t } = e;
						const { size: i } = (0, Pe.useEnsuredContext)(
							Ve.EmojiListContentContext,
						);
						const [l, a] = (0, n.useState)();
						return (
							(0, n.useEffect)(() => {
								o.e(5598)
									.then(o.bind(o, 31235))
			...
			const $e = (0, pe.mergeThemes)(Te, {
				menuBox: Ye.menuBox,
				drawer: Ye.drawer,
			});
			const Qe = parseInt(Je["default-drawer-min-top-distance"]);
			function Xe(e) {
				const { isGrayed: t, isSmallTablet: o } = e;
				const i = (0, R.filterDataProps)(e);
				const [l, a] = j();
				const [s] = W(d.tool);
				const { toolName: r } = Ue[l];
				return n.createElement(
					Ce,
					{
						theme: $e,
			...
			class ut extends n.PureComponent {
				...
				render() {
					...
					const { current: a, favState: s, isActive: r } = this.state;
					const c = this._getCurrentToolName();
					const u = p.lineToolsInfo[c];
					const d = this._showShortcuts();
					const h = (0, R.filterDataProps)(this.props);
					return n.createElement(
						"span",
						null,
						n.createElement(
			...
			class gt extends n.PureComponent {
				...
				render() {
					...
					const { numOfDrawings: t, numOfIndicators: i } = this.state;
					const l = f.t(
						null,
						{
					...
					const s = f.t(null, { replace: { drawings: l } }, o(30513));
					const r = f.t(null, { replace: { indicators: a } }, o(55084));
					const c = f.t(
						null,
						{ replace: { drawings: l, indicators: a } },
						o(10049),
					);
					return n.createElement(
						Ce,
			...
			function wt(e) {
				...
				const { hideMode: r, isActive: c } = (0, n.useContext)(Et);
				const u = null == l ? void 0 : l();
				return "all" === t || u
					? n.createElement(st.AccessibleMenuItem, {
							label: o,
							isActive: r === t && c,
			...
			function Ft(e) {
				...
				const [{ isActive: o, hideMode: i }, a] = (0, n.useState)(() => ({
					isActive: !1,
				...
				const d = xt[i][o ? "active" : "inactive"];
				const h = o ? c.active : c.inactive;
				return n.createElement(
					Ce,
					{
						buttonIcon: d,
			...
			function Wt(e) {
				const { isSmallTablet: t } = e;
				const o = (0, It.useWatchedValueReadonly)({
					watchedValue: (0, Dt.magnetEnabled)(),
				});
				const i = (0, It.useWatchedValueReadonly)({
			...
			const lo = u.enabled("keep_object_tree_widget_in_right_toolbar");
			const ao = (0, v.onWidget)();
			const so = new m.Delegate();
			const ro = dt.trackEvent.bind(null, "GUI", "Chart Left Toolbar");
			const co = (e, t) => ro(`${e} ${t ? "on" : "off"}`);
			class uo extends n.PureComponent {
				...
				render() {
					...
					const { isHovered: i, isVisible: l } = this.state;
					const s = { backgroundColor: e && `#${e}` };
					let c;
					c = n.createElement($t, {
						toolbarVisible: l,
