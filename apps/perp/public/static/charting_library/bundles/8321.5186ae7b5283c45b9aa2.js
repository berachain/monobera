    ...
    12811: (e, t, o) => {
      ...
      function l(e, t) {
        return (o, l, d, u) => {
          ...
          E === n.AutoStrict &&
            (u < m.y + m.height + b + l
              ? ((E = n.Top), (k = i.FromBottomToTop))
              : ((E = n.Bottom), (k = i.FromTopToBottom)));
          const C = E === n.Top ? -1 * b : b,
            D = f === r.Right ? m.right : m.left,
            x = E === n.Top ? m.top : m.bottom,
            N = {
              x: D - (v === a.FromRightToLeft ? o : 0) + g,
              y: x - (k === i.FromBottomToTop ? l : 0) + C,
            };
      ...
      const s = a,
        c = n.forwardRef((e, t) => {
          const {
            ...
            N = r(w, b.button, (g || D) && "apply-common-tooltip", {
              [b.isActive]: l,
              [b.isOpened]: d,
              [b.isInteractive]: (E || Boolean(m)) && !u && !k,
              [b.isDisabled]: Boolean(u || k),
              [b.isGrouped]: h,
              [b.hover]: p,
            }),
            y =
              ...
              try {
                t &&
                  ...
                  (this._handleToggleDropdown(
                    void 0,
                    (0, m.isKeyboardClick)(e),
                  ),
                  this.props.onClick &&
                    this.props.onClick(e, !this.state.isOpened));
              } catch (e) {
                console.warn(
                  "Using 'skip_event_target_check', code still failed.",
                );
              }
            }),
