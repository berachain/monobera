	...
	[731],
	{
		59142: (e, t) => {
			...
			(r = [t]),
				(o = (e) => {
					function t(e) {
						if (Array.isArray(e)) {
							for (let t = 0, o = Array(e.length); t < e.length; t++)
								o[t] = e[t];
							return o;
						}
						return Array.from(e);
					...
					(e.disableBodyScroll = (e, r) => {
						if (a) {
							...
							if (e && !n.some((t) => t.targetElement === e)) {
								const m = { targetElement: e, options: r || {} };
								(n = [].concat(t(n), [m])),
									(e.ontouchstart = (e) => {
							...
							(p = r),
								setTimeout(() => {
									if (void 0 === c) {
										const e = !!p && !0 === p.reserveScrollBarGap;
										const t =
							...
							const h = { targetElement: e, options: r || {} };
							n = [].concat(t(n), [h]);
						}
						let p;
					}),
		...
		70673: (e, t, o) => {
			...
			function d(e) {
				...
				const o = a(c().wrapper, e.className);
		...
		36383: (e, t, o) => {
			...
			function n(e) {
				...
				const u = (0, r.useRef)(new CustomEvent("timestamp").timeStamp);
				return (
					(0, r.useLayoutEffect)(() => {
						const e = { click: t, mouseDown: o, touchEnd: n, touchStart: s };
						const r = l ? l.current : d.current;
		...
		67961: (e, t, o) => {
			...
			class n {
				...
				setContainer(e) {
					...
					const o = null === e ? this._document.createDocumentFragment() : e;
					!((e, t) => {
		...
		99054: (e, t, o) => {
			...
			function c(e) {
				...
				const o = t.querySelector(".widgetbar-wrap");
				if (e && 1 === ++i) {
					const e = n(t, "overflow");
					const i = s(t, "padding-right");
		...
		89035: (e, t, o) => {
			...
			function z(e) {
				...
				const n = (0, r.useCallback)((e) => o(t, e), [t, o]);
			...
			function T(e) {
				...
				const { callback: y } = (0, k.useEnsuredContext)(x);
				const _ = h.comparableOnSameScale({ isYield: l });
				const E = _ ? M.CompareOption.SameScale : M.CompareOption.SamePctScale;
				const N = _ ? L.sameScale : L.samePctScale;
				return d
					? r.createElement(
							C.DrawerManager,
							null,
			...
			function A(e) {
				...
				const [N, z] = (0, r.useState)(!1);
				const D = (0, r.useRef)(null);
				const L = (0, _.useAccurateHover)(D);
				const A = (0, r.useMemo)(() => ({ callback: P }), [P]);
				const B = !a && !s;
				const j = l === w;
				return r.createElement(
					x.Provider,
			...
			function O(e) {
				...
				const l = (0, h.useWatchedValueReadonly)({
					watchedValue: n.isDataReady(),
				});
				const _ = (0, h.useWatchedValueReadonly)({ watchedValue: n.studies() });
				const k = (0, h.useWatchedValueReadonly)({
					watchedValue: n.highlightedSymbol(),
				});
				const x = (0, r.useMemo)(() => _.filter((e) => e.checked), [_]);
				const w = (0, r.useMemo)(() => _.filter((e) => !e.checked), [_]);
				return (
					(0, r.useEffect)(
						() => (
							n
				...
				constructor(e) {
					super(e),
						...
						(this._clearInput = (e, t) => {
							e?.current && ((e.current.value = ""), t("compare"));
						}),
			...
			function K(e) {
				...
				const M = (0, h.useWatchedValueReadonly)({ watchedValue: b.studies() });
				const D = a[n];
				const L = "compare" === c;
				const T = "exchange" === c;
				return (
			...
			function ee(e) {
				...
				const { currentMode: a } = (0, k.useEnsuredContext)(
		...
		41590: (e, t, o) => {
			...
			function m(e) {
				...
				const v = (0, a.ensureNotNull)((0, r.useContext)(l.DrawerContext));
				const [f] = (0, r.useState)(() => (0, s.randomHash)());
				const b = (0, r.useRef)(null);
				const g = (0, r.useContext)(c.CloseDelegateContext);
				return (
					(0, r.useLayoutEffect)(
						() => (
		...
		16396: (e, t, o) => {
			...
			function m(e) {
				...
				const Y = (0, i.filterDataProps)(e);
				const q = (0, r.useRef)(null);
				const K = (0, r.useMemo)(
					() =>
						((e) => {
							function t(t) {
								const { reference: o, ...a } = t;
								const n = null != e ? e : a.href ? "a" : "div";
								const s =
									"a" === n
										? a
										: ((e) => {
