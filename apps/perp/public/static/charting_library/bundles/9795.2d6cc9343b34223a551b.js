	...
	[9795, 3016, 3179],
	{
		...
		36383: (e, t, n) => {
			...
			function r(e) {
				...
				const u = (0, o.useRef)(new CustomEvent("timestamp").timeStamp);
				return (
					(0, o.useLayoutEffect)(() => {
						const e = { click: t, mouseDown: n, touchEnd: r, touchStart: s };
						const o = l ? l.current : d.current;
		...
		67961: (e, t, n) => {
			...
			class r {
				...
				setContainer(e) {
					...
					const n = null === e ? this._document.createDocumentFragment() : e;
					!((e, t) => {
		...
		99054: (e, t, n) => {
			...
			function c(e) {
				...
				const n = t.querySelector(".widgetbar-wrap");
				if (e && 1 === ++a) {
					const e = r(t, "overflow");
					const a = s(t, "padding-right");
		...
		66045: (e, t, n) => {
			...
			function c(e) {
				...
				return o.createElement(s.Select, {
					id: t,
					disabled: d,
		...
		94697: (e, t, n) => {
			...
			function d(e) {
				return o.createElement(
					...
					o.createElement(a.Icon, { className: l.icon, icon: e.icon }),
				);
			}
			function u(e) {
				return o.createElement(
					...
					o.createElement("div", { className: l.label }, e.label),
				);
			}
		},
		53598: (e, t, n) => {
			...
			const h = n(66220);
			const m = [
				{ type: a.LINESTYLE_SOLID, icon: c, label: o.t(null, void 0, n(1277)) },
				{
			...
			class f extends i.PureComponent {
				render() {
					...
					return (
						a && (d = [{ readonly: !0, content: a }, ...d]),
						i.createElement(l.IconDropdown, {
							id: e,
							disabled: r,
		...
		50890: (e, t, n) => {
			...
			const a = [1, 2, 3, 4];
			function l(e) {
				const { id: t, value: n, items: l = a, disabled: c, onChange: d } = e;
				...
				function p(e, t) {
					...
					return o.createElement(
						...
						o.createElement(
							"div",
							{
								className: i(s.bar, { [s.isActive]: e === n && !t }),
								style: r,
							},
							" ",
						),
			...
			function d(e) {
				const { property: t } = e;
				const [n, i] = (0, c.useDefinitionProperty)({ property: t });
				return o.createElement(l, { ...e, value: n, onChange: i });
			}
		},
		66849: (e, t, n) => {
			n.d(t, {
				ControlCustomHeightContext: () => r,
				ControlCustomWidthContext: () => i,
			});
			const o = n(50959);
		...
		15650: (e, t, n) => {
			...
			function l(e) {
				...
				const [u] = (0, s.useDefinitionProperty)({
					property: i,
					defaultValue: !1,
				});
				const [p] = (0, s.useDefinitionProperty)({
					property: r,
					defaultValue: !0,
				});
				return p
					? o.createElement(a.CommonSection, {
							id: t,
							offset: d,
							checked: n,
							title: l,
			...
			function h(e) {
				const { property: t } = e;
				const [n, i] = (0, s.useDefinitionProperty)({ property: t });
			...
			function D(e) {
				...
				const [i, r] = (0, o.useState)(performance.now());
				const [a, l] = (0, s.useDefinitionProperty)({
					property: t,
			...
			function S(e) {
				const { sharedBuffer: t, min: n, max: i, step: r, ...s } = e;
				const [a, l, c, d] = t;
				...
				return o.createElement(P, {
					...
					onBlur: (e) => {
						...
						if (
							...
							null === e || h.flushed || (l(e), c(), (h.flushed = !0));
						}
					},
					value: a,
					roundByStep: !1,
			...
			class P extends o.PureComponent {
				constructor(e) {
					super(e),
						...
						(this._handleInputReference = (e) => {
							(this._input = e), this.props.inputReference?.(e);
						}),
						(this._onFocus = (e) => {
							this._saveSelection((0, g.ensureNotNull)(this._input)),
						...
						(this._onBlur = (e) => {
							(this._selection = null),
								this.setState({
									displayValue: V(this.props, this.props.value, M(this.props)),
									focused: !1,
								}),
								this.props.onBlur?.(e);
						}),
						(this._onValueChange = (e) => {
							...
							const i = B(o);
							const r = this._checkValueBoundaries(i);
							let s;
							let a;
							this.setState({ displayValue: o }),
								o !== n &&
								((s = this.state.displayValue),
								(a = (a = o).replace(/,/g, ".")),
								(s = s.replace(/,/g, ".")).includes(".") || !a.includes("."))
						...
						(this._onValueByStepChange = (e) => {
							...
							const o = B(this.state.displayValue);
							let i;
							if (Number.isNaN(o)) {
								...
								const a = r.mod(s);
								let l = r.plus(e * n);
								!a.eq(0) && t && (l = l.plus((e > 0 ? 0 : 1) * n).minus(a)),
									(i = l.toNumber());
							}
							this._checkValueBoundaries(i).value &&
								(this.setState({
									displayValue: V(this.props, i, M(this.props)),
								}),
								this.props.onValueChange(i, "step"));
						}),
						(this.state = {
							value: R(this.props.value),
							displayValue: V(this.props, this.props.value, M(this.props)),
							focused: !1,
				...
				getClampedValue() {
					...
					const n = B(this.state.displayValue);
					return Number.isNaN(n) ? null : (0, E.clamp)(n, e, t);
				}
					...
					if (t.value !== o || t.valueHash !== n) {
						return {
							...
							displayValue: V(
								e,
								o,
								t.focused && t.valueHash === n ? void 0 : M(e),
							),
						};
					}
					return null;
			...
			function V(e, t, n) {
				return v((t = R(t)))
					? "—"
					: (null !== t && void 0 !== n && (n = Math.max(k(t), n)),
					  ((e, t) => {
							if (null === e) return "";
			...
			function M(e) {
				let t = 0;
				return (
					e.inheritPrecisionFromStep && e.step <= 1 && (t = k(e.step)),
			...
			function k(e) {
				...
				return (0, E.clamp)(
					w.NumericFormatter.formatNoE(e).length - t.length - 1,
					0,
					15,
				);
			}
			...
			function L(e) {
				...
				const [a, l] = (0, s.useDefinitionProperty)({ property: t });
				const [c, d] = (0, s.useDefinitionProperty)(
					n ? { property: n } : { defaultValue: void 0 },
				);
				return o.createElement(F.ColorSelect, {
					...e,
					color: (() => {
						if (!a) return null;
					...
					onColorChange: (e) => {
						const t =
							a && "mixed" !== a
								? (0, W.alphaToTransparency)((0, I.parseRgba)(a)[3])
								: 0;
			...
			const $ = n(7625);
			const J = [
				{ type: z.LineEnd.Normal, icon: O, label: A.t(null, void 0, n(55362)) },
				{ type: z.LineEnd.Arrow, icon: U, label: A.t(null, void 0, n(96237)) },
			];
			...
			function X(e) {
				const { property: t } = e;
				const [n, i] = (0, s.useDefinitionProperty)({ property: t });
				return o.createElement(Y, { ...e, lineEnd: n, lineEndChange: i });
			}
			const q = n(78260);
			const K = n(47543);
			function j(e) {
				...
				return o.createElement(
					q.CellWrap,
					{ className: c(K.wrap, n, K[`breakpoint${i}`]) },
					o.Children.map(t, (e) =>
						o.isValidElement(e)
							? o.createElement(
									"span",
			...
			function te(e) {
				...
				const [T] = (0, s.useDefinitionProperty)({
					property: i,
					defaultValue: !1,
				});
				const [N] = (0, s.useDefinitionProperty)({
					property: r,
					defaultValue: !0,
				});
				const V = (0, Q.useWatchedValueReadonly)({
					watchedValue: y,
					defaultValue: void 0,
				});
				const M = (0, Q.useWatchedValueReadonly)({
					watchedValue: b,
					defaultValue: void 0,
				});
				const k = (0, Q.useWatchedValueReadonly)({
					watchedValue: _,
					defaultValue: void 0,
				});
				const B = (0, Q.useWatchedValueReadonly)({
					watchedValue: E,
					defaultValue: void 0,
				});
				const R = e.disabled || !P;
				return N
					? o.createElement(
							o.Fragment,
							null,
			...
			function re(e) {
				...
				const [r, a] = (0, s.useDefinitionProperty)({ property: t });
				const l = (0, ie.useForceUpdate)();
				return (
					(0, o.useEffect)(() => {
						const e = () => l();
						return (
			...
			const se = n(3115);
			const ae = [
				{ title: A.t(null, void 0, n(35637)), value: ne.ColorType.Solid },
				{ title: A.t(null, void 0, n(16079)), value: ne.ColorType.Gradient },
			];
			function le(e) {
				const { id: t, disabled: n, noAlpha: i, properties: r } = e;
				const { color: a, gradientColor1: l, gradientColor2: c, type: d } = r;
				const [p] = (0, s.useDefinitionProperty)({
					property: d,
				...
				return o.createElement(
					...
					p === ne.ColorType.Solid
						? o.createElement(L, { color: a, disabled: n, noAlpha: i })
						: o.createElement(
								o.Fragment,
								null,
								o.createElement(L, {
								...
								o.createElement(L, { color: c, disabled: n, noAlpha: i }),
						  ),
				);
			}
			function ce(e) {
				...
				const { color: d, checked: u, disabled: p, visible: h } = n;
				const [m] = (0, s.useDefinitionProperty)({
					property: u,
					defaultValue: !0,
				});
				const [f] = (0, s.useDefinitionProperty)({
					property: p,
					defaultValue: !1,
				});
				const [g] = (0, s.useDefinitionProperty)({
					property: h,
					defaultValue: !0,
				});
				const v = e.disabled || !m;
				return g
					? o.createElement(
							a.CommonSection,
							{
							...
							o.createElement(
								...
								n.hasOwnProperty("type")
									...
									: o.createElement(L, { color: d, disabled: v, noAlpha: r }),
							),
					  )
					: null;
			}
			...
			function me(e) {
				const { property: t, ...n } = e;
				const [i, r] = (0, s.useDefinitionProperty)({ property: t });
			...
			function fe(e) {
				...
				const [h] = (0, s.useDefinitionProperty)({
					property: r,
					defaultValue: !1,
				});
				const [m] = (0, s.useDefinitionProperty)({
				...
				return m
					? o.createElement(
							...
							o.createElement(
								q.CellWrap,
								null,
								o.createElement(me, { property: n, disabled: f }),
							),
					  )
					: null;
			}
			...
			function ve(e) {
				...
				const [v] = (0, s.useDefinitionProperty)({
					property: c,
					defaultValue: !0,
				});
				const y = e.disabled || !f || g;
				return v
					? o.createElement(
							a.CommonSection,
							{
				...
				function b(e, t) {
					return o.createElement(
						...
						o.createElement(L, { color: e, disabled: y, noAlpha: t }),
					);
				}
			}
			const ye = n(66849);
			...
			function _e(e) {
				...
				const [w] = (0, s.useDefinitionProperty)({
					property: n,
					defaultValue: !0,
				});
				const [C] = (0, s.useDefinitionProperty)({
					property: l,
					defaultValue: !1,
				});
				const [S] = (0, s.useDefinitionProperty)({
					property: d,
					defaultValue: !0,
				});
				const x = (0, Q.useWatchedValueReadonly)({
					watchedValue: p,
					defaultValue: void 0,
				});
				const P = (0, Q.useWatchedValueReadonly)({
					watchedValue: h,
					defaultValue: void 0,
				});
				const T = (0, Q.useWatchedValueReadonly)({
					watchedValue: m,
					defaultValue: void 0,
				});
				const N = (0, Q.useWatchedValueReadonly)({
					watchedValue: v,
					defaultValue: void 0,
				});
				const V = (0, o.useContext)(ye.ControlCustomWidthContext);
				const M = e.disabled || !w;
				return S
					? o.createElement(
							a.CommonSection,
							{
							...
							o.createElement(
								...
								N && o.createElement("span", { className: be.unit }, N),
							),
					  )
					: null;
			}
			...
			function Ce(e) {
				const { property: t } = e;
				const [n, i] = (0, s.useDefinitionProperty)({ property: t });
				return o.createElement(we.FontSizeSelect, {
					...e,
					fontSize: n,
					fontSizeChange: i,
			...
			function xe(e) {
				...
				return o.createElement(
					...
					o.createElement(De.Icon, { className: Se.icon, icon: i }),
				);
			}
			function Pe(e) {
				const { icon: t, className: n, property: i, disabled: r } = e;
				const [a, l] = (0, s.useDefinitionProperty)({ property: i });
			...
			function Me(e) {
				const { property: t, ...n } = e;
				const [i, r] = (0, s.useDefinitionProperty)({ property: t });
				const a = (0, o.useCallback)((e) => r(e.target.value), [r]);
				return o.createElement(Ve.Textarea, { ...n, value: i, onChange: a });
			}
			const ke = n(8295);
			const Be = n(29285);
			const Re = n(42793);
			...
			function We(e) {
				...
				const I = (0, o.useContext)(ye.ControlCustomHeightContext);
				const [F] = (0, s.useDefinitionProperty)({
					property: r,
					defaultValue: !0,
				});
				...
				const [A, z] = (0, s.useDefinitionProperty)({
					property: m,
					defaultValue: void 0,
				});
				const [G, H] = (0, s.useDefinitionProperty)({
					property: f,
					defaultValue: "horizontal",
				});
				const [O, U] = (0, s.useDefinitionProperty)({
					property: h,
					defaultValue: void 0,
				});
				const [$] = (0, s.useDefinitionProperty)({
					property: g,
					defaultValue: !1,
				});
				const [J] = (0, s.useDefinitionProperty)({
					property: y,
					defaultValue: !1,
				});
				const Y = e.disabled || !F;
				return o.createElement(
					o.Fragment,
					null,
					(() => {
						if (w)
							return o.createElement(
								...
								o.createElement(j, { breakPoint: "Small" }, Z(), Q()),
							);
						return o.createElement(
							Ne.PropertyTable.Row,
							null,
							o.createElement(
								Ne.PropertyTable.Cell,
								{
									placement: "first",
									colSpan: 2,
									offset: R,
					...
					(h || m) &&
						o.createElement(
							...
							o.createElement(
								...
								o.createElement(q.CellWrap, null, S),
							),
							o.createElement(
								Ne.PropertyTable.Cell,
								{
					...
					void 0 !== f &&
						...
						o.createElement(
							...
							o.createElement(
								...
								o.createElement(q.CellWrap, null, T),
							),
							o.createElement(
								Ne.PropertyTable.Cell,
								{
					...
					return o.createElement(
						...
						n &&
							o.createElement(
								...
								o.createElement(L, { color: n, disabled: Y }),
							),
						i &&
							D &&
							o.createElement(Ce, {
			...
			function ze(e) {
				...
				const [l, c] = (0, o.useState)(performance.now());
				const [d, u] = (0, s.useDefinitionProperty)({
					property: t,
					handler: () => c(performance.now()),
				});
				const [p, h, m, f] = y(d, u, l);
				const g = (0, o.useMemo)(() => {
					const e = new RegExp(
						`^[${n.split("").join("\\")}-]?(${
							"float" === i ? "(\\d+\\.\\d*)|" : ""
					...
					return (t) => (0, Ae.isString)(t) && e.test(t);
				}, [n, i]);
				return o.createElement(Le.FormInput, {
					...a,
					type: "text",
					value: p,
					onChange: (e) => {
			...
			function He(e) {
				...
				return o.createElement(
					...
					o.createElement(
						...
						o.createElement("span", { className: Ge.coordinates }, s),
					),
					(t || n) &&
						o.createElement(
							Ne.PropertyTable.Cell,
							...
							o.createElement(
								j,
								{ breakPoint: "Medium" },
								"coordinates" === l.propType
									? o.createElement(Oe, { definition: l, disabled: d })
									: o.createElement(Ue, { definition: l, disabled: d }),
							),
							a && !1,
						),
				);
			...
			function Oe(e) {
				...
				const h = (0, Q.useWatchedValueReadonly)({
					watchedValue: i,
					defaultValue: void 0,
				});
				const m = (0, Q.useWatchedValueReadonly)({
				...
				const f = (0, Q.useWatchedValueReadonly)({
					watchedValue: s,
					defaultValue: void 0,
				});
				const g = (0, Q.useWatchedValueReadonly)({
					watchedValue: a,
					defaultValue: void 0,
				});
				const v = (0, Q.useWatchedValueReadonly)({
				...
				const y = (0, Q.useWatchedValueReadonly)({
					watchedValue: c,
					defaultValue: void 0,
				});
				return o.createElement(
			...
			function Je(e) {
				const {
					definition: {
						id: t,
						properties: { checked: n, option: i, disabled: r, visible: l },
						title: c,
						solutionId: p,
						options: h,
					},
				...
				const y = (0, o.useContext)(ye.ControlCustomWidthContext);
				const b = e.disabled || !f;
				return v
					? o.createElement(
							a.CommonSection,
							{
			...
			class Ke extends o.PureComponent {
						...
						(this._handlePosition = (e) => {
							null !== this._rafPosition ||
								...
								(this._rafPosition = requestAnimationFrame(() => {
									...
									const s = 1 === this._detectPointerMode(e);
									const a = s ? (0, E.clamp)(r, o, n) : t;
									const l = s ? n : (0, E.clamp)(r, t, i);
									a <= l && this._handleChange(a, l),
										(this._rafPosition = null);
								}));
						}),
				...
				render() {
					...
					const { pointerDragMode: a } = this.state;
					const l = 0 !== a;
					const d = s - r;
					const u = 0 === d ? r : (n - r) / d;
					const p = 0 === d ? s : (i - r) / d;
					const h = (0, Xe.isRtl)() ? "right" : "left";
					return o.createElement(
						"div",
				...
				_getNewPosition(e) {
					const { min: t, max: n } = this.props;
					const o = n - t;
					const i = (0, g.ensureNotNull)(this._container);
					const r = (0, g.ensureNotNull)(this._pointer);
					const s = i.getBoundingClientRect();
					const a = r.offsetWidth;
					let l = e.clientX - a / 2 - s.left;
					return (
						(0, Xe.isRtl)() && (l = s.width - l - a),
						(0, E.clamp)(l / (s.width - a), 0, 1) * o + t
					);
				}
				_detectPointerMode(e) {
					const { from: t, to: n } = this.props;
					const { pointerDragMode: o } = this.state;
					if (0 !== o) return o;
					const i = this._getNewPosition(e);
					const r = Math.abs(t - i);
					const s = Math.abs(n - i);
					const a = r === s ? (i < t ? 1 : 2) : r < s ? 1 : 2;
					return this.setState({ pointerDragMode: a }), a;
				}
				_handleChange(e, t) {
			...
			function Qe(e) {
				const {
					definition: {
						id: t,
						properties: { checked: n, disabled: i, from: r, to: l },
						title: c,
						solutionId: u,
						max: p,
						min: h,
				...
				const [b] = (0, s.useDefinitionProperty)({
					property: i,
					defaultValue: !1,
				});
				const _ = (0, Q.useWatchedValueReadonly)({
					watchedValue: h,
					defaultValue: void 0,
				});
				const E = (0, Q.useWatchedValueReadonly)({
					watchedValue: p,
					defaultValue: void 0,
				});
				const [w, C] = (0, s.useDefinitionProperty)({ property: r });
				const [D, x] = (0, s.useDefinitionProperty)({ property: l });
				const P = v(w) || v(D);
				const T = y(P ? "mixed" : w, (e) => {
					if ((C(e), v(B))) {
						const e = E || 100;
						R(e), x(e);
					}
			...
			function rt(e) {
				...
				const [y] = (0, s.useDefinitionProperty)({
					property: n,
					defaultValue: !1,
				});
				const b = y || !v;
			...
			function at(e) {
				const {
					definition: {
						id: t,
						properties: { option1: n, option2: i, checked: r, disabled: l },
						title: c,
						solutionId: d,
						optionsItems1: p,
						optionsItems2: h,
			...
			function ct(e) {
				...
				const b = (0, o.useContext)(ye.ControlCustomWidthContext);
				return o.createElement(
					a.CommonSection,
				...
				function _(e, t) {
					return o.createElement(
						...
						o.createElement(L, { color: e, noAlpha: t }),
					);
				}
			}
			const dt = n(39828);
			...
			const Pt = n(64104);
			const Tt = () => null;
			const Nt = (0, Et.mergeThemes)(_t.DEFAULT_MENU_THEME, {
				menuBox: Pt.menuBox,
			});
			function Vt(e) {
				const { value: t, disabled: n, onSelect: i } = e;
				const r = (0, o.useRef)(null);
				const { current: s } = (0, o.useRef)(
					ht.getJSON("RecentlyUsedEmojis", [t]),
				);
				const [a, l] = (0, o.useState)(s);
				const [c, d] = (0, o.useState)(!1);
				const u = (0, o.useCallback)(() => d(!1), []);
				wt(u);
				const p = (0, o.useCallback)(
					(e) => {
						const t = Array.from(new Set([e, ...a])).slice(0, 18);
				...
				const h =
					((m = a),
					(0, o.useMemo)(
						() => ((gt.emojiGroups[0].emojis = m), [...gt.emojiGroups]),
						[m],
					));
				let m;
				return o.createElement(
											...
											vt.PopupMenu,
											{
												...
												position: (0, Ct.getPopupPositioner)(r.current, {
													horizontalDropDirection:
														Ct.HorizontalDropDirection.FromLeftToRight,
			...
			function kt(e) {
				...
				const { checked: c, emoji: d, backgroundColor: u } = i;
				const [p] = (0, s.useDefinitionProperty)({
					property: c,
					defaultValue: !1,
				});
				const [h, m] = (0, s.useDefinitionProperty)({
					property: d,
					defaultValue: "🙂",
				});
				const [f, g] = (0, s.useDefinitionProperty)({
					property: u,
				...
				return o.createElement(
					...
					o.createElement(Vt, { value: h, disabled: y, onSelect: m }),
					o.createElement(F.ColorSelect, {
						...
						onColorChange: (e) => {
							const t =
								f && "mixed" !== f
									? (0, W.alphaToTransparency)((0, I.parseRgba)(f)[3])
									: 0;
			...
			function Bt(e) {
				...
				const [d] = (0, s.useDefinitionProperty)({
					property: n,
					defaultValue: !1,
				});
				const [u] = (0, s.useDefinitionProperty)({
			...
			function Rt(e) {
				const { definition: t, offset: n, disabled: s } = e;
				if (
					(((e) => {
						(0, o.useEffect)(() => {
							if (void 0 === e) return;
					...
					return o.createElement(It, { definition: t, offset: n, disabled: s });
				switch (t.propType) {
					case "line":
						return o.createElement(te, { ...e, definition: t });
					case "checkable":
						return o.createElement(l, { ...e, definition: t });
					case "color":
					...
					case "number":
						return o.createElement(_e, { ...e, definition: t });
					case "symbol":
					...
					case "set":
						return o.createElement(Bt, { ...e, definition: t });
					case "options":
					...
					case "twoOptions":
						return o.createElement(at, { ...e, definition: t });
					case "leveledLine":
			...
			function It(e) {
				...
				return (0, Q.useWatchedValueReadonly)({
					...
					? o.createElement(
							...
							null,
							t.title &&
								o.createElement(et.GroupTitleSection, {
									title: t.title,
									name: t.id,
								}),
							n &&
								((e) => {
									...
									Array.isArray(n)
										...
										: o.createElement(Rt, { key: n.id, ...e, definition: n }),
								),
							"general" === t.groupType &&
								o.createElement(Ne.PropertyTable.GroupSeparator, { size: 1 }),
					  )
					: null;
			}
		},
		...
		63016: (e, t, n) => {
			...
			class d extends o.PureComponent {
				...
				render() {
					...
					const h = (0, l.filterDataProps)(this.props);
					const m = this.props.style
			...
			class y {
				...
				_moveDialog(e, t) {
					...
					const { boundByScreen: o } = this._options;
					const i = m(
						e,
						n.width,
						o ? 0 : -1 / 0,
			...
			class _ {
				...
				centerAndFit() {
					...
					const n = this._calcAvailableHeight();
					const o = this._calcDialogHeight();
					if (n === o)
				...
				getDialogsTopLeftCoordinates() {
					...
					const n = this._calcDialogHeight();
					const o = t / 2 - this._dialog.clientWidth / 2;
					const i = e / 2 - n / 2;
				...
				recalculateBounds() {
					...
					if (this._isFullscreen) {
						...
						const i = t - 2 * o;
						const r = m(e.left, e.width, 0, n);
						const s = m(e.top, e.height, o, t);
						(this._dialog.style.top = "0px"),
							(this._dialog.style.left = "0px"),
							(this._dialog.style.transform = `translate(${Math.round(
								r,
			...
			class S extends o.PureComponent {
								...
								o.createElement(
									...
									o.createElement(
										d,
										{
											...
											className: i(D.dialog, this.props.className),
										},
										!1,
										this.props.children,
									),
				...
				componentDidMount() {
					...
					const o = (0, r.ensureNotNull)(this._dialog);
					if (e) {
					...
					if (this.props.resizeHandler) this._resize = this.props.resizeHandler;
						...
						const e = new _(o, { guard: i, calculateDialogPosition: s });
				...
				recalculateBounds() {
					this._resize?.recalculateBounds();
				}
				_moveToTop() {
				...
				_applyAppearanceAnimation(e) {
					if (this._resize && this._dialog) {
						const { x: t, y: n } = e;
						const { x: o, y: i } = this._resize.getDialogsTopLeftCoordinates();
		...
		95276: (e, t, n) => {
			...
			const d = o.forwardRef((e, t) => {
				...
				const E = (0, o.useRef)({ "aria-labelledby": n });
				const {
					listboxId: w,
					isOpened: C,
					isFocused: D,
				...
				const W = (0, r.useKeyboardToggle)(M);
				const L = (0, r.useKeyboardClose)(C, V);
				const A = (0, r.useKeyboardEventHandler)([W, L]);
				return o.createElement(
					s.ControlDisclosureView,
					{
						..._,
						...k,
						...F,
						...
						onListboxKeyDown: (e) => {
							if (27 === (0, l.hashFromEvent)(e))
								return e.preventDefault(), void V();
							null == b || b(e);
						},
					},
					m,
		...
		27317: (e, t, n) => {
			...
			class v extends o.PureComponent {
				constructor(e) {
					super(e),
						...
						(this._manager = new u.OverlapManager()),
						(this._hotkeys = null),
						(this._scroll = 0),
						...
						(this._handleMeasure = ({
							...
							const v = (0, s.ensureNotNull)(this._containerRef);
							let y = v.getBoundingClientRect();
							const b = document.documentElement.clientHeight;
							const _ = document.documentElement.clientWidth;
							const E =
							...
							const { width: D, height: S } = y;
							const x = "function" === typeof g ? g(D, S, _, b) : g;
							const P =
								null !==
									(i =
										null === (o = null == x ? void 0 : x.indentFromWindow) ||
										void 0 === o
											? void 0
											: o.left) && void 0 !== i
									? i
							...
							const T =
								_ -
								(null !== (r = x.overrideWidth) && void 0 !== r ? r : D) -
								(null !==
									(c =
										null === (l = null == x ? void 0 : x.indentFromWindow) ||
										void 0 === l
											? void 0
											: l.right) && void 0 !== c
									? c
									: 0);
							const N = (0, a.clamp)(x.x, P, Math.max(P, T));
							const V =
								(null !==
									(u =
										null === (d = null == x ? void 0 : x.indentFromWindow) ||
										void 0 === d
											? void 0
											: d.top) && void 0 !== u
									? u
							...
							const M =
								b -
								(null !== (p = x.overrideHeight) && void 0 !== p ? p : S) -
								(null !==
									(m =
										null === (h = null == x ? void 0 : x.indentFromWindow) ||
										void 0 === h
											? void 0
											: h.bottom) && void 0 !== m
									? m
									: 0);
							let k = (0, a.clamp)(x.y, V, Math.max(V, M));
							if (
								(x.forbidCorrectYCoord &&
									k < x.y &&
									((w -= x.y - k), (k = x.y)),
								t &&
									void 0 !== this.props.closeOnScrollOutsideOffset &&
									x.y <= this.props.closeOnScrollOutsideOffset)
							)
								return void this._handleGlobalClose(!0);
							const B =
								null !== (f = x.overrideHeight) && void 0 !== f
									? f
									: C
									  ? w
									  : void 0;
							this.setState(
								{
									...
									appearingMenuWidth: t
										...
										: x.overrideWidth,
									appearingPosition: { x: N, y: k },
									isMeasureValid: !0,
								},
								() => {
									this._restoreScrollPosition(), e?.();
								},
							);
						}),
						(this._restoreScrollPosition = () => {
							const e = document.activeElement;
							const t = (0, s.ensureNotNull)(this._containerRef);
				...
				componentDidMount() {
					...
					this._hotkeys ||
						...
						this._hotkeys.add({
							...
							hotkey: 27,
							handler: () => {
								this.props.onKeyboardClose?.(), this._handleGlobalClose();
							},
						})),
							...
							o.createElement(
								...
								o.createElement(
									...
									o.createElement(
										...
										o.createElement(y, { className: v.menuBox }, p),
									),
								),
							),
			...
			function y(e) {
				const t = (0, s.ensureNotNull)((0, o.useContext)(h.SubmenuContext));
		...
		29197: (e, t, n) => {
			...
			const o = n(50959);
			const i = n(59064);
			const r = o.createContext(i.globalCloseDelegate);
		},
		65718: (e, t, n) => {
		...
		12811: (e, t, n) => {
			...
			function c(e, t) {
				return (n, c, d, u) => {
					let p;
					let h;
					const m = (0, a.ensureNotNull)(e).getBoundingClientRect();
					const {
						...
						verticalMargin: y = l.verticalMargin,
						matchButtonAndListboxWidths: b = l.matchButtonAndListboxWidths,
					} = t;
					let _ =
						null !== (p = t.verticalAttachEdge) && void 0 !== p
							? p
					...
					_ === o.AutoStrict &&
						(u < m.y + m.height + y + c
							? ((_ = o.Top), (E = r.FromBottomToTop))
							: ((_ = o.Bottom), (E = r.FromTopToBottom)));
					const w = _ === o.Top ? -1 * y : y;
					const C = f === i.Right ? m.right : m.left;
					const D = _ === o.Top ? m.top : m.bottom;
					const S = {
		...
		3347: (e, t, n) => {
			...
			function i(e, t, n) {
				const o = new Map();
				const i = void 0 !== t ? t[0] : (e) => e;
				const r = void 0 !== t ? (void 0 !== t[1] ? t[1] : t[0]) : (e) => e;
				const s = {
					value: () => i(e.value()),
					setValue: (t) => {
						e.setValue(r(t));
			...
			function r(e, t, n, r, s, a, l) {
				const c = i(t.weakReference(), r, a);
				const d = void 0 !== r ? (void 0 !== r[1] ? r[1] : r[0]) : (e) => e;
				const u = null != s ? s : (o) => e.setProperty(t, d(o), n);
				return (
					(c.setValue = (e) => {
						let t;
						l &&
		...
		46141: (e, t, n) => {
			...
			n.d(t, {
				convertFromReadonlyWVToDefinitionProperty: () => A,
				convertFromWVToDefinitionProperty: () => L,
				convertToDefinitionProperty: () => F.convertToDefinitionProperty,
				...
				createOptionalTwoColorsPropertyDefinition: () => D,
				createOptionsPropertyDefinition: () => p,
				createPropertyDefinitionsGeneralGroup: () => R,
				createPropertyDefinitionsLeveledLinesGroup: () => I,
				createRangePropertyDefinition: () => P,
				createSelectionCoordinatesPropertyDefinition: () => x,
				createSessionPropertyDefinition: () => V,
				createStudyInputsPropertyDefinition: () => k,
				createSymbolPropertyDefinition: () => N,
				createTextPropertyDefinition: () => w,
				createTransparencyPropertyDefinition: () => T,
				createTwoColorsPropertyDefinition: () => C,
				createTwoOptionsPropertyDefinition: () => h,
				destroyDefinitions: () => K,
				getColorDefinitionProperty: () => Y,
				...
				makeProxyDefinitionProperty: () => F.makeProxyDefinitionProperty,
			});
			const s = n(43715);
			const a = n(79849);
			const l = [a.LINESTYLE_SOLID, a.LINESTYLE_DOTTED, a.LINESTYLE_DASHED];
			const c = [1, 2, 3, 4];
			function d(e, t) {
				const n = { propType: "leveledLine", properties: e, ...t };
				return (
					void 0 !== n.properties.style && (n.styleValues = l),
			...
			const y = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40].map((e) => ({
				title: String(e),
				value: e,
			}));
			const b = [1, 2, 3, 4];
			const _ = m.t(null, void 0, n(92960));
			const E = m.t(null, void 0, n(90581));
			function w(e, t) {
				const n = {
					propType: "text",
					properties: e,
			...
			function W(e, t, n) {
				...
				return n && (s.destroy = () => n()), s;
			}
			function L(e, t, n, o) {
				const i = W(t, o);
				const r = void 0 !== o ? (void 0 !== o[1] ? o[1] : o[0]) : (e) => e;
			...
			function z(e, t) {
				const n = (0, F.makeProxyDefinitionProperty)(t.weakReference());
				return (n.setValue = (t) => e.setPriceScaleSelectionStrategy(t)), n;
			}
			function G(e, t, n, o) {
				const i = (0, F.makeProxyDefinitionProperty)(t.weakReference());
				return (
					(i.setValue = (t) => {
						const i = { lockScale: t };
			...
			function H(e, t, n, o) {
				const i = (0, F.makeProxyDefinitionProperty)(t.weakReference(), o);
				return (
					(i.setValue = (o) => {
			...
			function Y(e, t, n, o, i) {
				let r;
				if (null !== n) {
					const e = (0, $.combineProperty)(
						J,
						t.weakReference(),
						n.weakReference(),
					);
					r = (0, F.makeProxyDefinitionProperty)(e.ownership());
				} else
					r = (0, F.makeProxyDefinitionProperty)(t.weakReference(), [
						() => J(t.value(), 0),
						(e) => e,
					]);
				return (
			...
			function X(e, t, n, o, i, r) {
				...
				let a;
				let l;
				const c = (0, F.convertToDefinitionProperty)(e, t, i, s);
				r && (c.setValue = r);
				const d = new Map();
				(c.subscribe = (e, n) => {
					const o = (e) => {
							...
							if (void 0 !== r)
								if (void 0 !== s)
									if (n.has(r)) {
										...
										let l;
										i.has(t)
											? (l = (0, o.ensureDefined)(i.get(t)))
											: ((l = new Map()), i.set(t, l)),
											a(e, "inline", s, l, t.children);
									} else {
										const o = { id: s, groupType: "inline", children: [e] };
										const a = { id: r, groupType: "group", children: [o] };
										const l = new Map();
										l.set(s, o), i.set(a, l), n.set(r, a), t.push(a);
									}
								else a(e, "group", r, n, t);
							else {
								const n = (0, o.ensureDefined)(i.get(void 0));
								a(e, "inline", (0, o.ensureDefined)(s), n, t);
							}
						else t.push(e);
					}),
					t
