(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[2020],
	{
		59142: (o, e) => {
			...
			(i = [e]),
				(l = (o) => {
					function e(o) {
						if (Array.isArray(o)) {
							for (let e = 0, l = Array(o.length); e < o.length; e++)
								l[e] = o[e];
							return l;
						}
						return Array.from(o);
					...
					(o.disableBodyScroll = (o, i) => {
						if (n) {
							if (!o)
								return void console.error(
									"disableBodyScroll unsuccessful - targetElement must be provided when calling disableBodyScroll on IOS devices.",
								);
							if (o && !a.some((e) => e.targetElement === o)) {
								const L = { targetElement: o, options: i || {} };
								(a = [].concat(e(a), [L])),
									(o.ontouchstart = (o) => {
							...
							(m = i),
								setTimeout(() => {
									if (void 0 === r) {
										const o = !!m && !0 === m.reserveScrollBarGap;
										const e =
							...
							const h = { targetElement: o, options: i || {} };
							a = [].concat(e(a), [h]);
						}
						let m;
					}),
						(o.clearAllBodyScrollLocks = () => {
							n
								? (a.forEach((o) => {
						...
						(o.enableBodyScroll = (o) => {
							if (n) {
								...
								(o.ontouchstart = null),
									(o.ontouchmove = null),
									(a = a.filter((e) => e.targetElement !== o)),
									t &&
										0 === a.length &&
										(document.removeEventListener(
											"touchmove",
		...
		54819: (o, e, l) => {
			...
			const i = l(44352);
			const n = l(61814);
			const a = (l(42053), l(57673));
			const t = l(87872);
			const s = l(59656);
			const c = l(68335);
			const r = (0, c.humanReadableModifiers)(c.Modifiers.Shift, !1);
			const d = (0, c.humanReadableModifiers)(c.Modifiers.Alt, !1);
			const T = (0, c.humanReadableModifiers)(c.Modifiers.Mod, !1);
			const L = { keys: [r], text: i.t(null, void 0, l(40234)) };
			const h = { keys: [r], text: i.t(null, void 0, l(68125)) };
			const m = { keys: [r], text: i.t(null, void 0, l(81591)) };
			const v = {
		...
		71810: (o, e, l) => {
			...
			!((o) => {
				function e() {
					...
					const r = (0, n.getJSON)("chart.favoriteDrawings", []);
				...
				(o.favorites = []),
					...
					(o.favoriteIndex = (e) => o.favorites.indexOf(e)),
				...
				((o) => {
					...
					(o.favoriteAdded = new i.Delegate()),
						...
						(o.favorites = () => t.favorites.slice()),
						(o.isValidLineToolName = e),
						(o.favoritesCount = l),
						(o.favorite = (o) => (o < 0 || o >= l() ? "" : t.favorites[o])),
						(o.addFavorite = (l, i) =>
							!(n(l) || !e(l)) &&
							(t.favorites.push(l),
							t.saveFavorites(i),
