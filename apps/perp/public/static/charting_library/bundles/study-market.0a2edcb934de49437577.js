	...
	[6456],
	{
		...
		35057: (e, t, n) => {
			...
			class N extends r.PureComponent {
						...
						(this._handleKeyDown = (e) => {
							if (!e.defaultPrevented) {
								if (
									...
									const r = (0, i.ensureNotNull)(this._reference);
									if (null !== n) {
										if (
											(e.preventDefault(),
				...
				render() {
					...
					const V = "after" !== m ? v : void 0;
					const G = "after" === m ? v : void 0;
					const $ = "string" === typeof o ? o : O || "";
					const Y = (0, w.filterDataProps)(this.props);
					const X = (0, E.mergeRefs)([this._handleReference, W]);
					return r.createElement(
						p.MatchMedia,
									...
									r.createElement(
										u.PopupDialog,
										{
											...
											calculateDialogPosition:
												D && K ? this._calculatePositionWithOffsets : void 0,
											shadowed: U,
											...Y,
										},
										r.createElement(
		...
		22265: (e, t, n) => {
			...
			function u(e) {
				...
				const { isMobile: a, isTablet: l } = (0, s.getSidebarMode)(t);
				const u = o()(c.container, l && c.isTablet, a && c.isMobile, n);
			...
			function h(e) {
				...
				const { isMobile: v, isTablet: g } = (0, s.getSidebarMode)(t);
				const y = u
						? null == i
							? void 0
							: i.active
				...
				return r.createElement(
					...
					!g &&
						r.createElement(
							...
							v && r.createElement(a.Icon, { className: c.nested, icon: l }),
						),
				);
			}
		},
		...
		57979: (e, t, n) => {
			...
			function p(e) {
				...
				return {
					id: r,
					title: u || o.t(i, { context: "study" }, n(68716)),
					shortDescription: a,
					shortTitle: a,
			...
			function L(e) {
				...
				const { isFavorite: E, isLocked: w, public: k, editorsPick: B } = l;
				const L = void 0 !== E;
				const M = A(y, l);
				const z = (0, r.useCallback)((e) => e.stopPropagation(), []);
				const O =
						null !== (t = e.favoriteClickHandler) && void 0 !== t
							...
							: (null == i ? void 0 : i.toggleFavorite)
							  ...
							  : void 0;
				const F =
						(0, P.useWatchedValueReadonly)({ watchedValue: I.watchedTheme }) ===
						D.StdTheme.Dark
							? T.dark
							: T.light;
				const j = v()(
				...
				return r.createElement(
					...
					"mobile" !== s &&
						k &&
						r.createElement("span", { className: T.likes }, k.likesCount),
					!1,
				);
			}
			function A(e, t) {
			...
			function q(e) {
				...
				return r.createElement(
					...
					n && r.createElement(j.Icon, { icon: n, className: H.image }),
					i && r.createElement("h3", { className: H.title }, i),
					o && r.createElement("p", { className: H.description }, o),
					a &&
						s &&
						r.createElement(W.Button, { onClick: s, className: H.button }, a),
				);
			}
			function Z(e) {
			...
			const Y = new V.Delegate();
			const X = new V.Delegate();
			let J = [];
			function Q(e) {
				return -1 === te(e)
					? (((e) => {
			...
			function ne() {
				...
				J = [];
				const n = Boolean(
						void 0 === (0, G.getValue)("chart.favoriteLibraryIndicators"),
					);
				const r = (0, G.getJSON)("chart.favoriteLibraryIndicators", []);
				if (
					(J.push(...r), 0 === J.length && n && "undefined" !== typeof window)
				) {
					const n = JSON.parse(
						null !==
							(t =
			...
			function ie(e) {
				...
				const p = (0, r.useMemo)(() => (0, U.createRegExpList)(u, h), [u]);
				const f = (0, r.useMemo)(
						() =>
							u
								? (0, U.rankedSearch)({
							...
							),
							{
								...
								handleKeyDown: (e) => {
									const [t, r] = ((e, t) => {
										...
										const { height: i } = n;
										const o = n.top - r.top;
										const a = n.bottom - r.bottom + i < 0 ? 0 : i;
										const s = o - i > 0 ? 0 : i;
										const { scrollTop: l } = t.current;
										return [l - s, l + a];
									})(c, l);
									if (
										(40 === (0, B.hashFromEvent)(e) &&
											(e.preventDefault(), h(), m(r)),
										38 === (0, B.hashFromEvent)(e) &&
											(e.preventDefault(), p(), m(t)),
		...
		77975: (e, t, n) => {
			...
			const i = (e, t = !1) => {
				...
				const i = "defaultValue" in e ? e.defaultValue : e.watchedValue.value();
				const [o, a] = (0, r.useState)(n ? n.value() : i);
				return (
		...
		95257: (e, t) => {
			...
			(t.Children = {
				...
				(t.useCallback = (e, t) => B.current.useCallback(e, t)),
				(t.useContext = (e) => B.current.useContext(e)),
				(t.useDebugValue = () => {}),
				(t.useDeferredValue = (e) => B.current.useDeferredValue(e)),
				(t.useEffect = (e, t) => B.current.useEffect(e, t)),
				(t.useId = () => B.current.useId()),
				(t.useImperativeHandle = (e, t, n) =>
					B.current.useImperativeHandle(e, t, n)),
				(t.useInsertionEffect = (e, t) => B.current.useInsertionEffect(e, t)),
				(t.useLayoutEffect = (e, t) => B.current.useLayoutEffect(e, t)),
				(t.useMemo = (e, t) => B.current.useMemo(e, t)),
				(t.useReducer = (e, t, n) => B.current.useReducer(e, t, n)),
				(t.useRef = (e) => B.current.useRef(e)),
				(t.useState = (e) => B.current.useState(e)),
				(t.useSyncExternalStore = (e, t, n) =>
					B.current.useSyncExternalStore(e, t, n)),
				(t.useTransition = () => B.current.useTransition()),
				(t.version = "18.2.0");
		},
		50959: (e, t, n) => {
			e.exports = n(95257);
