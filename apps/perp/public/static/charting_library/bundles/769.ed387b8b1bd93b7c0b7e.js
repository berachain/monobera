	...
	[769],
	{
		...
		41590: (e, t, n) => {
			...
			function v(e) {
				...
				const p = (0, o.ensureNotNull)((0, r.useContext)(c.DrawerContext));
				const [f] = (0, r.useState)(() => (0, i.randomHash)());
				const w = (0, r.useRef)(null);
				const E = (0, r.useContext)(s.CloseDelegateContext);
				return (
					(0, r.useLayoutEffect)(
						() => (
							(0, o.ensureNotNull)(w.current).focus({ preventScroll: !0 }),
							E.subscribe(p, n),
							p.addDrawer(f),
							() => {
		...
		173: (e, t, n) => {
			n.d(t, { emojiGroups: () => A, removeUnavailableEmoji: () => M });
			const r = n(50959);
			const o = n(44352);
			const a = n(99616);
			const i = n(37603);
		...
		47291: (e, t, n) => {
			n.d(t, { EmojiListContent: () => h, EmojiListContentContext: () => v });
			const r = n(50959);
			const o = n(20037);
			const a = n(97754);
			const i = n.n(a);
			...
			function c(e) {
				...
				return r.createElement("div", { className: i()(l.wrapper, n) }, t);
			}
			const s = n(26601);
			const m = n(78036);
			const u = n(97662);
			...
			function h(e) {
				...
				const w = Math.min(h - 102, window.innerHeight - 102);
				return r.createElement(
					v.Provider,
					{
						value: (0, r.useMemo)(
			...
			const d = r.memo((e) => {
				...
				const {
					...
					onSelect: l,
					ItemComponent: u,
					RowComponent: h = s.EmojisRow,
				} = (0, m.useEnsuredContext)(v);
				return "title" === a.type
					? r.createElement(
							"div",
							{ style: t },
							r.createElement(c, { title: a.relatedTitle }),
					  )
					: r.createElement(
							"div",
							{ style: t },
		...
		38297: (e, t, n) => {
			...
			function w(e) {
				...
				const y = (0, r.useRef)(!1);
				const [j, S] = (0, r.useState)(0);
				const L = (0, r.useMemo)(
					() =>
						((e, t) => {
							if (0 === t) return [];
				...
				const T = (0, l.useResizeObserver)(
					(e) => {
						const [t] = e;
						const { width: n } = t.contentRect;
						const r = Math.floor((n - 12) / A);
						S(r);
					},
					[A],
				);
				(0, r.useEffect)(() => {
					...
					(0, r.useLayoutEffect)(() => {
						...
						const e = (0, i.ensureNotNull)(k.current);
						const t = () => {
							...
							if (
								0 === t.length ||
								(t[0].parentElement &&
									!C(t[0].parentElement, (0, i.ensureNotNull)(k.current)))
							) {
								const n = ((e) => {
									const t = g(e)
										.sort(u.navigationOrderComparator)
										.find((e) => C(e, (0, i.ensureNotNull)(k.current)));
									if (!t) return null;
								...
								if (null === n) return;
								if (((0, h.becomeMainElement)(n), t.length > 0))
									for (const e of t) (0, h.becomeSecondaryElement)(e);
							}
						};
						return (
				...
				const [_, B] = (0, r.useState)(
					(null === (t = L[0]) || void 0 === t ? void 0 : t.relatedTitle) || "",
				);
					...
					r.createElement(
						"div",
						{
							...
							onKeyDown: (e) => {
								...
								const o = ((a = r),
								Array.from(
									a.querySelectorAll("button:not([disabled], [aria-disabled])"),
								...
								const l = (t) => {
									...
									const n = g(r);
									const o = document.activeElement.parentElement;
									if (!o) return;
			...
			function C(e, t) {
				...
				const r = n + (0, i.ensureNotNull)(e.parentElement).clientHeight;
				const o = t.scrollTop;
			...
			function b(e) {
				document.activeElement &&
					(0, h.becomeSecondaryElement)(document.activeElement),
					(0, h.becomeMainElement)(e),
					e.focus();
			}
		},
		26601: (e, t, n) => {
			...
			const c = r.memo((e) => {
				...
				return r.createElement(
					"div",
					{ "data-role": "row", className: a()(l.wrapper, s) },
					t.map((e) =>
		...
		85034: (e, t, n) => {
			...
			function m(e) {
				...
				const [u, v] = (0, l.useRovingTabindexElement)(null);
				return c.PLATFORM_ACCESSIBILITY_ENABLED
					? r.createElement(
							"button",
							{
								ref: u,
			...
			function v(e) {
				...
				return r.createElement(
					i.Toolbar,
					{ orientation: "horizontal", className: a()(u.wrapper, l) },
		...
		83682: (e, t, n) => {
			...
			function c(e) {
				...
				const o = (0, i.getTwemojiUrl)(t, "png");
			...
			function h(e) {
				...
				const [h, d] = (0, m.useRovingTabindexElement)(null);
		...
		54079: (e, t, n) => {
			...
			const u = (0, r.forwardRef)((e, t) => {
				...
				const p = l.PLATFORM_ACCESSIBILITY_ENABLED
					...
					: {};
				const f = (0, s.useFunctionalRefObject)(t);
				return (
					(0, r.useLayoutEffect)(() => {
						...
						const t = () => {
							...
							if (0 === t.length) {
								...
								if (void 0 === t) return;
								(0, c.becomeMainElement)(t);
							}
							if (t.length > 1) {
								const [, ...e] = t;
								for (const t of e) (0, c.becomeSecondaryElement)(t);
							}
						};
						return (
							window.addEventListener("keyboard-navigation-activation", t),
					...
					r.createElement("div", {
						...
						onKeyDown: (0, a.createSafeMulticastEventHandler)((e) => {
							...
							const r = (0, l.queryFocusableElements)(n).sort(
								l.navigationOrderComparator,
							);
							...
							const a = () => {
								...
								(0, c.becomeSecondaryElement)(r[o]),
									(0, c.becomeMainElement)(r[e]),
									r[e].focus();
							};
							const s = () => {
								const e = (o + r.length + 1) % r.length;
