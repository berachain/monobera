			...
			class n {
				...
				includes(e) {
					return ((e, t) => {
						...
						const { name: o, desc: r, searchTerms: n } = e;
						return (
		...
		56217: (e, t, s) => {
			...
			class I {
				constructor(e) {
					...
					const s = new Set();
					const c = new Set();
					const l = this._chartWidget.model().model().dataSources().filter(_);
					const d = l.map((e) => {
					...
					Promise.all(d).then((e) => {
						...
						{
							const e = new Map();
							const t = i.map((t) => this._getResolveSymbolPromise(t, e));
				...
				_handleInitProcess(e, t, s, o) {
					...
					for (const n of e) {
						...
						if (!e) continue;
						const i = s(e, n);
						const a = this._checkedSymbols.get(i);
						const c = -1 !== r.findIndex((e) => e.symbol === i);
						if (void 0 === a || c)
				...
				_updateChecked(e) {
					...
					const o = null === (t = e.study) || void 0 === t ? void 0 : t.id();
					return o ? { ...e, checked: Boolean(s?.includes(o)) } : e;
				}
				_updateContentItemList(e, t) {
					const s = t ? e.map(this._updateChecked, this) : e;
					const o = s.filter((e) => e.checked);
					if (this._recentSymbolsEnabled) {
						const e = new Set();
						const t = s
							.reduce(
								(t, s) => (
									s.checked || e.has(s.symbol) || (t.push(s), e.add(s.symbol)),
									t
								),
								[],
							)
				...
				_getContentItemByStudyId(e) {
					...
					const s = t.findIndex((t) => t.study && t.study.id() === e);
					return t[s];
				}
				_loadRecent() {
