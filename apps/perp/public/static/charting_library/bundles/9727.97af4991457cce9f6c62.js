(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[9727],
	{
		...
		90744: (e, t, n) => {
			...
			const m = n.n(d);
			const p = (e, t) => {
				const n = (0, r.useContext)(l.CustomBehaviourContext);
				const a = (0, r.useContext)(i.ControlGroupContext);
				const { isInButtonGroup: u, isGroupPrimary: d } = (0, r.useContext)(c);
				const {
					className: p,
					isSelected: h,
					children: g,
				...
				return o(
					...
					L && m().link,
					h && m().selected,
					(0, s.isIconOnly)(g, S) && m()["no-content"],
					v && m()["with-start-icon"],
					(f || y) && m()["with-end-icon"],
					t && m()["with-grouped"],
					b && m()[`force-direction-${b}`],
					m()[`variant-${d ? "primary" : w}`],
					m()[`color-${d ? "gray" : x}`],
					m()[`size-${k}`],
					R,
					!C && m()["disable-active-state-styles"],
					a.isGrouped && m().grouped,
					N && m().wrap,
					u && m()["disable-active-on-touch"],
					I && m().pills,
				);
			};
			function h(e) {
				...
				return r.createElement(
					r.Fragment,
					null,
					t && r.createElement(a.Icon, { className: m().icon, icon: t }),
					!(0, s.isIconOnly)(p, i) &&
						r.createElement(
							"span",
							...
							d || c
								? r.createElement(
										...
										r.createElement(
											...
											{
												className: o(
													!d && c && m()["ellipsis-container"],
													d && m()["text-wrap-container"],
													d && c && m()["text-wrap-with-ellipsis"],
												),
											},
											p,
										),
			...
			function g(e) {
				...
				const L = x ? (null != w ? w : 2) : 1;
				const N =
					L > 0 ? { ...k, "--ui-lib-light-button-content-max-lines": L } : k;
				return r.createElement(
					"button",
					{
						...E,
		...
		64388: (e, t, n) => {
			...
			function i(e) {
				...
				return r.createElement(
					...
					t && r.createElement("span", { className: l["visually-hidden"] }, t),
				);
			}
			...
			const d = n(53017);
			(0, r.forwardRef)((e, t) => {
				const { icon: n, renderComponent: o, "aria-label": a, ...l } = e;
				const c = null != o ? o : u.CustomComponentDefaultLink;
				return r.createElement(
					c,
					{
						...l,
						className: s({ ...e, children: a, isLink: !0 }),
		...
		36279: (e, t, n) => {
			let r;
			n.d(t, { LogoSize: () => r, getLogoUrlResolver: () => l }),
				((e) => {
		...
		35057: (e, t, n) => {
			...
			const v = n(76422);
			const f = n(9745);
			const y = r.createContext({ setHideClose: () => {} });
			const b = n(7720);
			const S = n(69827);
			function x(e) {
				const {
			...
			class N extends r.PureComponent {
				constructor() {
					super(...arguments),
						...
						(this._handleCloseBtnClick = () => {
							this.props.onKeyboardClose?.(), this._handleClose();
						}),
						(this._handleClose = () => {
							this.props.onClose();
						}),
						...
						(this._handleKeyDown = (e) => {
							if (!e.defaultPrevented) {
								if (
									(this.props.onKeyDown?.(e), 27 === (0, s.hashFromEvent)(e))
								) {
									if (e.defaultPrevented) return;
									if (this.props.forceCloseOnEsc?.())
										return (
											this.props.onKeyboardClose?.(), void this._handleClose()
										);
				...
				render() {
					...
					const j = "after" !== g ? v : void 0;
					const H = "after" === g ? v : void 0;
					const G = "string" === typeof a ? a : F || "";
					const $ = (0, k.filterDataProps)(this.props);
					const Y = (0, w.mergeRefs)([this._handleReference, U]);
					return r.createElement(
						p.MatchMedia,
									...
									r.createElement(
										u.PopupDialog,
										{
											...
											calculateDialogPosition:
												_ && q ? this._calculatePositionWithOffsets : void 0,
											shadowed: K,
											...$,
										},
										r.createElement(
											...
											r.createElement(h.PopupContext.Consumer, null, (e) =>
												this._renderChildren(e, m || _),
											),
										),
									),
							),
			...
			function u(e) {
				...
				return r.createElement(
					...
					r.createElement(
						...
						o || r.createElement(d, { ...g }),
					),
					t,
					r.createElement(s.Icon, { className: a()(c.icon, h), icon: i }),
					u &&
						r.createElement(
							"div",
		...
		40987: (e, t, n) => {
			n.d(t, { SymbolSearchDialogContentItem: () => z });
			const r = n(50959);
			const o = n(97754);
			const a = n.n(o);
			const l = (n(44352), n(50151));
			const s = n(9745);
			const i = n(14483);
			const c = n(24637);
			const u = n(19785);
			...
			const k = n(43010);
			const C = n(57240);
			const E = "tv-circle-logo--visually-hidden";
			function L(e) {
				const {
					className: t,
					placeholderLetter: n,
				...
				return (
					(0, k.useIsomorphicLayoutEffect)(() => {
						...
						const t = (p.current =
							...
							Promise.all(
								n.map((e) =>
									(0, w.getImage)(`symbol_logo_${e}`, e, I).then((e) =>
										e.cloneNode(),
									),
								),
							)));
					...
					r.createElement(
						...
						r.createElement(
							...
							r.createElement(S.CircleLogo, { size: s, placeholderLetter: n }),
						),
					)
				);
			}
			...
			const D = y.LogoSize.Medium;
			const B = n(33172);
			function M(e) {
				const { country: t, providerId: n, sourceId: o, className: s } = e;
				const i = (0, p.useWatchedValueReadonly)({
				...
				const [c, u] = (0, r.useState)(
					(({ country: e, providerId: t, sourceId: n }) => {
						...
						return (o) => {
							const a = (e) => r.getProviderLogoUrl(e, D);
							const s = [
								{ value: n, resolve: a },
								{
									value: e,
									resolve: (e) => r.getCountryFlagUrl(e.toUpperCase(), D),
								},
								{ value: t, resolve: a },
							].find(({ value: e }) => void 0 !== e && e.length > 0);
							return void 0 !== s
								? s.resolve((0, l.ensureDefined)(s.value))
								: T(o);
						};
			...
			function z(e) {
				...
				const { isSmallWidth: le, isMobile: se } = (0, l.ensureNotNull)(
				...
				const ue =
					...
					m.StdTheme.Dark
						...
						: A.light;
				const de = F;
				const me = i.enabled("show_symbol_logos");
				const pe = i.enabled("show_exchange_logos");
				const he = me || !1;
				const ge =
					null !== (t = null == W ? void 0 : W.description) && void 0 !== t
						? t
						: U;
				const ve =
					null !== (n = null == W ? void 0 : W.name) && void 0 !== n ? n : U;
				return r.createElement(
					"div",
					{
						className: a()(
					...
					r.createElement(
						"div",
						{ ref: K, className: a()(A.itemInfoCell, A.cell, N && A.offset) },
						r.createElement(
							"div",
							...
							f &&
								r.createElement(
									...
									"string" === typeof f && S
										...
										: f,
									E && r.createElement("span", { className: A.dataMode }, "E"),
								),
							!f &&
								o &&
								r.createElement(
							...
							pe &&
								r.createElement(
									...
									r.createElement(M, {
										key: pe
											? `${Y}_exchange`
											: `${Q}_${P}_${null == W ? void 0 : W.id}_${V}_${Z}`,
										className: A.icon,
										country: Q,
										providerId: P,
		...
		58442: (e, t, n) => {
			n.d(t, { QualifiedSources: () => r, qualifyProName: () => l });
			let r;
			const o = n(50151);
			const a = n(14483);
			n(81319);
			...
			!((e) => {
				...
				(e.fromQuotesSnapshot = (e) =>
					...
					(e.fromSymbolMessage = (e, t) =>
						"symbol_resolved" === t.method ? n(t.params[1]) : e);
			})(r || (r = {}));
		},
		20882: (e, t, n) => {
			n.d(t, {
			...
			function l(e) {
				...
				return new Map(
					[...t.entries()].sort(([e], [t]) => r.indexOf(e) - r.indexOf(t)),
				);
			}
			function s(e, t) {
		...
		32456: (e, t, n) => {
			n.d(t, { SymbolSearchItemsDialog: () => We });
			const r = n(50959);
			const o = n(97754);
			const a = n.n(o);
			const l = n(44352);
			...
			function y(e) {
				...
				return r.createElement(
					...
					r.createElement("div", { className: f.childrenWrapper }, t),
				);
			}
			const b = n(50151);
			const S = n(78036);
			...
			function L(e) {
				...
				const {
					...
					isMobile: c,
				} = (0, S.useEnsuredContext)(h.SymbolSearchItemsDialogContext);
				const u = l.currentSelectedSearchSource;
				const d = (0, b.ensureNotNull)(u).value();
				const m = s(t);
				const g = t.value() === d;
				const v = (0, r.useMemo)(() => (0, w.createRegExpList)(o), [o]);
				const f = t.description();
				const y = f && !m;
				const L = k.isSeparateSymbolSearchTabs && m && i ? i : t.name();
				const N = a()(
					E.container,
				...
				return r.createElement(
					"div",
					{ className: a()(!c && E.wrap, m && E.libAllSelected), onClick: n },
					r.createElement(
						"div",
						{ className: N },
						r.createElement(
			...
			const D = n(67562);
			const B = n(70699);
			const M = { emptyTextClassName: B.emptyText };
			function O(e) {
				...
				const d =
					(0, N.useWatchedValueReadonly)({ watchedValue: I.watchedTheme }) ===
					R.StdTheme.Dark
						? T
						: D;
				const [m, f] = (0, r.useState)("");
				const b = (0, r.useMemo)(
					() => [{ group: null, sources: (0, v.filterSearchSources)(t, m) }],
					[t, m],
				);
				...
				(0, r.useLayoutEffect)(() => {
					let e;
					u &&
						(null === (e = null == x ? void 0 : x.current) ||
							void 0 === e ||
							e.focus());
				}, []);
				const k = c
					...
					: r.createElement(
							...
							r.createElement(p.Icon, { icon: d, className: B.emptyIcon }),
							r.createElement(
								"div",
				...
				const C = !(b.length && b.every((e) => 0 === e.sources.length));
				return r.createElement(
					_.SymbolSearchDialogBodyContext.Provider,
					{ value: M },
					r.createElement(g.DialogSearch, {
						placeholder: l.t(null, void 0, n(52298)),
						onChange: (e) => {
							f(e.target.value), w?.current && (w.current.scrollTop = 0);
						},
						reference: x,
					}),
					C
			...
			function X(e) {
				...
				const {
					...
					(0, r.useContext)(h.SymbolSearchItemsDialogContext),
				);
				const c = (0, Z.tokenize)(
					null === (t = a.current) || void 0 === t ? void 0 : t.value,
				);
				const d = (0, s.validate)(c);
				let m = [
					...
					{ icon: H, insert: "*", type: "binaryOp", name: "multiplication" },
				];
				return (
						...
						(m = m.concat([
							{
								...
								callback: () => {
									!a.current ||
										d.errors.length ||
										d.warnings.length ||
										((a.current.value = (0, s.stringifyTokens)((0, s.flip)(c))),
										l());
								},
							},
						])),
									...
									((e) => {
										...
										if (!J(e, d)) {
											if (e.insert && a.current) {
												...
												const [r, , c] = (0, s.getCurrentTokenParamsFromInput)(
													a.current,
													i,
												);
												n.current &&
													((n.current.selectedIndexValue = -1),
													(n.current.searchSpreadsValue = (0, s.isSpread)(c)),
			...
			function re(e) {
				...
				return r.createElement(
					"span",
					{
						...(0, ee.filterAriaProps)(p),
						...(0, ee.filterDataProps)(p),
						id: t,
						title: n,
						tabIndex: o,
						role: l,
					...
					r.createElement("span", { className: a()(te.content, s) }, i),
				);
			}
			const oe = n(88389);
			function ae(e) {
				...
				return r.createElement(
					"div",
					{ className: o(t, oe.bubbles, p && oe.multiLine), ref: v },
					l.map((e, t) =>
						r.createElement(
							g,
							{
			...
			const de = n(52019);
			const me = n(14444);
			const pe = (0, k.getDefaultSearchSource)();
			function he(e) {
				const {
					mode: t,
					setMode: o,
				...
				const v = g.currentSelectedSearchSource;
				const f = (0, b.ensureNotNull)(v);
				const y = "symbolSearch" === t;
				const x = u(f);
				const w = k.isSeparateSymbolSearchTabs && x && d ? d : f.name();
				const E = (0, r.useCallback)(() => {
					k.isSeparateSymbolSearchTabs && !x && pe
						? c(pe)
						: (s.current &&
								(i.current = m
									? s.current.value.toUpperCase()
									: s.current.value),
						  o("exchange"));
				}, [x, s, m, o, c]);
				return k.isSeparateSymbolSearchTabs
					? y
						? r.createElement(
								ce.LightButton,
								{
					...
					: y
					  ? r.createElement(
								...
								x && r.createElement(p.Icon, { className: me.icon, icon: C }),
								null,
								r.createElement("div", { className: a()(me.title) }, w),
								r.createElement(ue.ToolWidgetCaret, {
									className: me.caret,
									dropped: !1,
								}),
						  )
			...
			function ve(e) {
				...
				return k.isSeparateSymbolSearchTabs
					? r.createElement(
							...
							t && r.createElement("div", { className: ge.brokerWrap }, t),
							d.canChangeExchange &&
								r.createElement(
									"div",
							...
							m?.map((e) => {
								...
								const a = n.find((e) => e.value === FILTER_DEFAULT_VALUE);
								if (!a)
									throw new Error(
								...
								const l =
									n.find((e) => {
										...
										return (
											e.value ===
											(null === (n = s[d.currentSymbolType]) || void 0 === n
												? void 0
												: n[t])
										);
									}) || a;
					...
					: r.createElement(
							...
							r.createElement(
								...
								r.createElement(
									"div",
									{ className: ge.text },
									o ? l.t(null, void 0, n(48490)) : l.t(null, void 0, n(89053)),
								),
							),
							r.createElement(
								"div",
			...
			function be(e) {
				...
				const [f, y] = (0, r.useState)(null);
				const x = (0, ie.useResizeObserver)(([e]) => {
				...
				const C = (0, r.useCallback)((e) => (0, b.ensure)(i[e].key), [i]);
				const E = "watchlist" === p && null !== f;
				return r.createElement(
					"div",
					{
						className: a()(
							...
							E && ye.watchlist,
							u && ye.noFeed,
							u && k.isSeparateSymbolSearchTabs && ye.newStyles,
							o,
						),
						onTouchMove: t,
						ref: x,
					...
					r.createElement(
						"div",
						{ ref: l, className: a()(ye.scrollContainer, u && ye.noFeed) },
						E
							? r.createElement(se.VariableSizeList, {
									key: s,
									ref: n,
							...
							: r.createElement(
									...
									r.createElement(
										"div",
										{
											className: a()(
												ye.listContainer,
												g && ye.multiLineItemsContainer,
											),
										},
										!k.isSeparateSymbolSearchTabs && r.createElement(ve, null),
										...i,
										!1,
									),
							  ),
			...
			const Se = n(40987);
			const xe = n(85544);
			const we = u.enabled("hide_image_invalid_symbol");
			function ke(e) {
				const {
					otherSymbolsCount: t,
				...
				const N = s
					...
					: null;
				const I =
					"symbolSearch" === v && ["good", "loadingWithPaginated"].includes(L);
				const R = null != w ? w : Se.SymbolSearchDialogContentItem;
				const _ = (0, r.useMemo)(
					() =>
						x.map((e) => r.createElement(R, { ...e, searchToken: E.token })),
					[x],
				);
				return r.createElement(
					r.Fragment,
						...
						r.createElement(
							...
							b.length > 0 &&
								r.createElement(
									...
									!f &&
										r.createElement("div", { className: xe.brokerButton }, N),
								),
							!k.isSeparateSymbolSearchTabs &&
								f &&
								b.length > 0 &&
								s &&
								r.createElement("div", { className: xe.brokerButtonWrap }, N),
							k.isSeparateSymbolSearchTabs &&
								r.createElement(ve, { brokerButton: f ? N : void 0 }),
						),
					r.createElement(be, {
						listRef: d,
						listWrapRef: m,
					...
					"loading" === L &&
						r.createElement(
							...
							r.createElement(le.Spinner, null),
						),
					"symbolSearch" === v &&
						r.createElement(
							r.Fragment,
							null,
							!1,
							"empty" === L && r.createElement(C, null),
						),
				);
			}
			function Ce(e) {
				...
				return r.createElement(
					...
					!we && r.createElement(p.Icon, { icon: t, className: xe.emptyIcon }),
					r.createElement(
						"div",
			...
			const Ee = (0, k.getDefaultSearchSource)();
			const Le = 52;
			function Ne(e) {
				const {
					mode: t,
				...
				const H = (0, r.useRef)(t);
				H.current = t;
				const G = (0, r.useRef)(new AbortController());
				const [$, Y] = (0, r.useState)(0);
				const J = (0, r.useRef)(0);
				const [ee, te] = (0, r.useState)(y.token);
				...
				(0, r.useEffect)(
					...
					(0, r.useEffect)(() => {
						...
						if (e)
							return (
								e.addEventListener("input", Se),
								e.addEventListener("focus", Ie),
								e.addEventListener("select", be),
								e.addEventListener("click", be),
								e.addEventListener("keyup", Re),
								B && M && e.addEventListener("keydown", M),
								() => {
									e &&
										(e.removeEventListener("input", Se),
										e.removeEventListener("focus", Ie),
										e.removeEventListener("select", be),
										e.removeEventListener("click", be),
										e.removeEventListener("keyup", Re),
										B && M && e.removeEventListener("keydown", M));
								}
							);
					}, [M]),
					(0, r.useEffect)(() => {
					...
					(0, r.useEffect)(() => {
						...
						if (!u.enabled("show_spread_operators"))
							return (x.current.value = E.symbol), void L();
						const t = F(E) ? E.exchange : E.parent.exchange;
						let n;
						n =
							"contracts" in E &&
							(null === (e = E.contracts) || void 0 === e ? void 0 : e.length)
								? E.contracts[0]
								: E;
						const r = {
							name: n.symbol,
						...
						const [o, a] = (0, s.getNextSymbolInputValueAndPosition)(
							x.current,
							r,
							D,
						);
				...
				const he = null != I ? I : "div";
				const ge = Boolean(I) && "symbolSearch" !== t;
				const ve = null != T ? T : g.DialogSearch;
				const fe = (0, r.useMemo)(
					() => ({
						listRef: re,
						resetRecommends: Ne,
						updateRecommends: Ce,
				...
				return r.createElement(
					...
					!(B && "symbolSearch" === t) &&
						r.createElement(
							...
							C && r.createElement(X, { state: oe, update: we }),
						),
					ge
						? r.createElement(he, null)
						: r.createElement(ke, {
								...
								onResetFilters: () => {
									...
									k.isSeparateSymbolSearchTabs
										? "resetFilter" === q
											? f((0, k.getAllSymbolTypesValue)())
											: Ee && m(Ee)
										: (f((0, k.getAllSymbolTypesValue)()), Ee && m(Ee));
									me(!1),
										c || null === (e = x.current) || void 0 === e || e.focus();
								},
								brokerTitle: ce,
								brokerLogoInfo: ue,
								isBrokerActive: de,
				...
				function ye() {
					if (!x.current) return;
					const [e, t, n] = (0, s.getCurrentTokenParamsFromInput)(x.current, D);
					(J.current = t),
						(oe.current = {
							selectedIndexValue: -1,
				...
				function be() {
					if (!x.current) return;
					const [, e] = (0, s.getCurrentTokenParamsFromInput)(x.current, D);
					e !== J.current && ye();
				}
				function Se() {
				...
				async function Ce(e, t, n, r) {
					...
					try {
								  ...
								  (le.current = setTimeout(() => {
										b({
											...
											canChangeExchange: Boolean(
												d && K.length > 1 && !(0, k.exchangeSelectDisabled)(t),
											),
						...
						const p =
							(0, s.getExchange)(e) || null === (l = n || d) || void 0 === l
								? void 0
								: l.getRequestCountryValue();
						const [h, g] = await Promise.all([
							Le(G.current.signal, e, t, n, m, p, r),
						...
						const f = new Set(v.map((e) => `${e.exchange}_${e.symbol}`));
						const S = h.symbols.filter(
							(e) => !f.has(`${e.exchange}_${e.symbol}`),
						);
						let x = ((e, t = window.ChartApiInstance.symbolsGrouping()) => {
							let n;
							const r = {};
							const o = [];
							for (let a = 0; a < e.length; ++a) {
								...
								if (i) {
									...
									r.hasOwnProperty(e)
										...
										null === (n = o[t].contracts) || void 0 === n || n.push(l);
								} else o.push(l);
							}
							return o;
						})([...v, ...S]);
						...
						_e(),
							b((n) => ({
								...
								currentSelectedSearchSource: d,
								currentTabAvailableSearchSources: K,
								symbolStartIndex: n.symbolStartIndex + h.symbols.length,
							})),
							j("good");
					} catch (e) {
				...
				async function Le(e, t, n, r, o, a, l) {
					let i;
					const c = {
						serverHighlight: !1,
					...
					const d = (0, P.getSearchRequestDelay)();
					return void 0 !== d && (await (0, z.delay)(e, d)), O ? O(c) : Q(c);
				}
				function Ne() {
					Te(),
						j("empty"),
				...
				function Ie() {
					"watchlist" === H.current &&
						(o("symbolSearch"),
						(0, U.trackEvent)("Watchlist", "Mobile SS", "Go to SS page"));
				}
				function Re(e) {
			...
			function De(e) {
				const [t, n] = (0, r.useState)(() => {
					...
					const r = Te.getValue("symboledit.exchangefilter", "");
			...
			const ze = n(76460);
			const Fe = n(62393);
			const Qe = (0, k.getAvailableSearchSources)();
			const Pe = (0, k.getDefaultSearchSource)();
			const Ue = u.enabled("uppercase_instrument_names");
			function We(e) {
				let t;
				const {
					onClose: o,
					...
					onSearchComplete: y,
					dialogTitle: b = l.t(null, void 0, n(75905)),
					placeholder: S,
					fullscreen: x,
					initialScreen: w,
					wrapper: C,
				...
				const V = (0, r.useMemo)(
					() =>
						A
							...
							: e.symbolTypes
							  ? e.symbolTypes
							  : (0, k.getAvailableSymbolTypes)(),
					[],
				);
				const Z = void 0 !== e.input;
				const K = A ? [] : Qe;
				const [q, j] = (0, r.useState)(a);
				const H = (0, r.useRef)(m);
				const [G, $] = De({ searchSources: K, defaultSearchSource: Pe });
				const [Y, X] = [];
				const [J, ee] = Be({ types: V });
				const [te, ne] = [{}, () => {}];
				const [re, oe] = (0, r.useState)(!1);
				const [ae, le] = (0, r.useState)(-1);
				const [se, ie] = (0, r.useState)("noop");
				const ce = k.isSeparateSymbolSearchTabs
					? TAB_SELECT_FILTER_MAP
					: void 0;
				const ue = k.isSeparateSymbolSearchTabs
					? (null == Y ? void 0 : Y[J]) || Pe
					: G;
				const de = (0, r.useMemo)(() => {
					...
					return K.filter((e) => {
						...
						const n = e.group();
						return (
							n === ExchangeGroup.AllExchanges || (n && t.value.includes(n))
						);
					});
				}, [K, J]);
				const [me, pe] = (0, r.useState)(() => ({
					canChangeExchange: Boolean(
						G && Qe.length > 1 && !(0, k.exchangeSelectDisabled)(J),
					),
				...
				const he = (0, r.useCallback)(
					(e) => {
						trackEvent("New SS", J, "Change sources"),
							null == X || X(J, e),
							pe((t) => ({ ...t, currentSelectedSearchSource: e }));
					},
					[J, pe],
				);
				const ge = (0, r.useRef)(
					null !== (t = e.input) && void 0 !== t ? t : null,
				);
				const [ve, fe] = (0, r.useState)(!1);
				const ye = (0, Me.useForceUpdate)();
				const [be, Se] = (0, r.useState)(new Set());
				const {
					broker: xe = null,
					brokerId: we,
				...
				(0, r.useLayoutEffect)(() => {
					let e;
					!(null == ge ? void 0 : ge.current) ||
						(!Z &&
							Boolean(
								null === (e = ge.current) || void 0 === e ? void 0 : e.value,
							)) ||
						(Z || "compare" === q || (ge.current.value = H.current),
						!_ || (Z && "symbolSearch" !== q) || ge.current.focus());
				}, [q]),
					(0, r.useEffect)(() => {
						(null == ge ? void 0 : ge.current) && f && _ && ge.current.select();
					}, []);
				const Ee = (0, r.useMemo)(
					() =>
				...
				const Te = i.includes(J);
				const We = (0, r.useMemo)(
					() =>
						Ee.map((e, t) => {
							let n;
							let r;
							...
							if (F(e)) {
								const o = Ke(e);
								const a = e.contracts ? be.has(o) : void 0;
								const l = t === ae;
								return {
									key: t,
									id: o,
									...
									isEod:
										(null === (r = e.params) || void 0 === r
											? void 0
											: r.includes("eod")) && "economic" !== e.type,
									isYield: (0, Ae.isYield)(e),
									isExpanded: a,
									onExpandClick: e.contracts ? ot.bind(null, o) : void 0,
									fullSymbolName: e.contracts
										? _e.QualifiedSources.fromSymbolSearchResult(
												e,
												e.contracts[0],
										  )
										: _e.QualifiedSources.fromSymbolSearchResult(e),
									itemRef: l ? Le : void 0,
									isSelected: t === ae,
									hideMarkedListFlag: g,
									item: e,
							...
							}
							{
								...
								return {
									...
									exchangeTooltip: "",
									marketType: (0, Re.marketType)(n.type, e.typespecs, !1),
									hideMarketType: Te,
									fullSymbolName: _e.QualifiedSources.fromSymbolSearchResult(
										e.parent,
										e,
									),
									itemRef: l ? Le : void 0,
				...
				const He = (0, r.useMemo)(
					() =>
						((e, t, n) => {
							const r = null == t ? void 0 : t[e];
							const o = new Map(
								null == r ? void 0 : r.map((e) => [e.id, e.urlParam]),
							);
							const a = n[e];
							let l;
							if (a) {
				...
				(0, r.useEffect)(() => {
					...
					let t;
					if (!U) return;
					const n = ["resetFilter", "resetTabFilter", "empty"].includes(se)
						? []
						: Ge;
					const r = { ...He, result_list: n };
					r.search_type ||
						(r.search_type = "bitcoin,crypto" === J ? "crypto" : J);
					const o = TAB_FILTER_MAP[J];
					J &&
						("country" === o.id
							? (r.country =
									null !==
										(e = null == ue ? void 0 : ue.getRequestCountryValue()) &&
									void 0 !== e
										? e
										: null)
							: (r.exchange =
									null !==
										(t = null == ue ? void 0 : ue.getRequestExchangeValue()) &&
									void 0 !== t
										? t
										: null)),
						U(r);
				...
				const Xe = (e, t) => {
					...
					return {
						...
						allSearchSourcesTitle: k.isSeparateSymbolSearchTabs
							? null === (n = TAB_FILTER_MAP[me.currentSymbolType]) ||
							  void 0 === n
								? void 0
				...
				const tt = et
					? {
							...
							additionalHeaderElement: r.createElement(Ie.BackButton, {
								...
								size: "medium",
								"aria-label": l.t(null, { context: "input" }, n(16936)),
								preservePaddings: !0,
							}),
					...
					: {
							...
							render: () => r.createElement(Ne, null),
							additionalElementPos: "after",
					  };
				const nt = null != C ? C : "div";
				return r.createElement(
					nt,
					null,
					r.createElement(
						...
						({ TabletSmall: e, TabletNormal: t }) =>
							r.createElement(
								h.SymbolSearchItemsDialogContext.Provider,
								{ value: Xe(e, t) },
								r.createElement($e, {
									...tt,
									shouldReturnFocus: P,
				...
				function at(e, t, n) {
					...
					if (u.enabled("show_spread_operators")) {
						...
						if (re) return st(e), void ye();
						if (ge.current?.value.includes(",")) return void st(e);
					}
					ut(
						[
							{
				...
				function st(e) {
					...
					const [t, n] = (0, s.getNextSymbolInputValueAndPosition)(
						ge.current,
						e,
						Ue,
					);
					(ge.current.value = t),
						ge.current.setSelectionRange(n, n),
						ge.current.focus();
				}
				function it(e) {
					switch ((0, W.hashFromEvent)(e)) {
						...
						case 37: {
							if (-1 === ae) return;
							const t = We[ae];
							const { id: n, isOffset: r, onExpandClick: o } = t;
							if (
								(!r &&
									n &&
									be.has(n) &&
									Boolean(o) &&
									!D &&
									(e.preventDefault(), ot(n)),
								o)
							)
								return void (null == D || D(e, !0));
							break;
						}
						case 39: {
							if (-1 === ae) return;
				...
				function ct(e) {
					if (!ge.current) return;
					let t = ge.current.value;
					if (u.enabled("show_spread_operators") && re && t) {
						const n = We[ae];
						if (
							(n &&
								void 0 !== n.isExpanded &&
								(n.onClick(), (t = ge.current.value)),
							t.includes(","))
						) {
							return ut(qe(t).map(Ve)), void (e && o());
						}
						return (
							ut([{ symbol: Ue ? t.toUpperCase() : t, resolved: !1 }]),
							void (e && o())
						);
					}
												...
												: ((t = !0),
												  (async (e) => {
														...
														if (0 !== r.symbols.length) {
															const e = r.symbols[0];
															const { contracts: t } = e;
															const n = t && t.length > 0 ? t[0] : void 0;
															const o = e.prefix || e.exchange;
															const a = n ? n.symbol : e.symbol;
															if (o && a)
																return {
																	symbol:
																		_e.QualifiedSources.fromSymbolSearchResult(
				...
				async function ut(e, t) {
					const n = !t || (0, ze.isKeyboardClick)(t);
					y(e, { symbolType: J, isKeyboardEvent: n });
				}
			}
			function Ve(e) {
				return { symbol: Ue ? e.toUpperCase() : e, resolved: !1 };
			}
			function Ze(e, t) {
			...
			function je(e) {
				const { isMobile: t, isTablet: n } = (0, S.useEnsuredContext)(
					h.SymbolSearchItemsDialogContext,
				);
		...
		15983: (e, t, n) => {
				...
				for (let o = 0; o < e.length; o++) {
					...
					switch (a.type) {
						...
						case "closeBrace": {
							...
							const l = e[o + 1];
							const s = a && ("plus" === a.type || "multiply" === a.type);
			...
			function g(e, t, n) {
				const r = e.value;
				const [l, s] = v(e, n);
				const i = (0, a.getSymbolFullName)(t);
				const c = o.symbolTokenEscapeRe.test(i) ? `'${i}'` : i;
				return [
					r.substring(0, s) + c + r.substring(s + l.length),
					s + c.length,
				];
			}
			function v(e, t) {
				const { value: n, selectionStart: r } = e;
				const a = (0, o.tokenize)(t ? n.toUpperCase() : n);
				const l = ((e, t) => {
			...
			class a {
				...
				includes(e) {
					return ((e, t) => {
						...
						const { name: r, desc: o, searchTerms: a } = e;
						return (
		...
		44254: (e, t, n) => {
			n.d(t, { symbolTokenEscapeRe: () => l, tokenize: () => c });
			const r = n(14483);
			const o = n(18429);
		...
		93251: (e, t, n) => {
			...
			function a(e, t = r.LogoSize.Medium) {
				const n = e.logoid;
				const a = e["base-currency-logoid"];
				const l = e["currency-logoid"];
				const s = n && o.getSymbolLogoUrl(n, t);
				if (s) return [s];
				const i = a && o.getSymbolLogoUrl(a, t);
				const c = l && o.getSymbolLogoUrl(l, t);
			...
			function l(e) {
				return 2 !== e.length
					? e
					: ((e) => e.some((e) => s(e)))(e) &&
						  !((e) => e.some((e) => e.includes("country") && !s(e)))(e)
					  ? e.filter((e) => !s(e))
					  : e;
			}
			function s(e) {
					...
					.map((e) => {
						...
						return (
							n.forEach((e) => {
								...
								if ((0, r.isString)(t) && h.test(t))
									return (
										(m = 3),
										void (d =
											null === (l = t.match(h)) || void 0 === l
												? void 0
												: l.index)
									);
		...
		77975: (e, t, n) => {
			...
			const o = (e, t = !1) => {
				...
				const o = "defaultValue" in e ? e.defaultValue : e.watchedValue.value();
				const [a, l] = (0, r.useState)(n ? n.value() : o);
				return (
		...
		31409: (e, t, n) => {
			...
			const i = r.forwardRef((e, t) => {
				...
				const E = o(b, y.button, (f || k) && "apply-common-tooltip", {
					[y.isActive]: c,
					[y.isOpened]: u,
					[y.isInteractive]: (S || Boolean(h)) && !d && !x,
				...
				const L =
					s &&
					("string" === typeof s
						? r.createElement(a.Icon, { className: y.icon, icon: s })
						: r.cloneElement(s, {
				...
				return "button" === n
					...
					: r.createElement(
							...
							i && r.createElement(a.Icon, { icon: i, className: l.endIcon }),
					  );
			});
		},
		24658: (e, t, n) => {
			...
			const r = n(44352);
			const o = new Map([
				["cfd", r.t(null, void 0, n(87592))],
				["dr", r.t(null, void 0, n(67245))],
				["index", r.t(null, void 0, n(12754))],
				["forex", r.t(null, void 0, n(39512))],
				["right", r.t(null, { context: "symbol_type" }, n(9898))],
				["bond", r.t(null, void 0, n(79852))],
				["bitcoin", r.t(null, void 0, n(8448))],
				["crypto", r.t(null, void 0, n(8448))],
				["economic", r.t(null, void 0, n(88720))],
				["indices", r.t(null, void 0, n(60804))],
				["futures", r.t(null, void 0, n(81859))],
				["stock", r.t(null, void 0, n(36931))],
				["commodity", r.t(null, void 0, n(12629))],
			]);
			n(42053);
			const a = new Map();
			const l = new Set([
			...
			function s(e, t = [], n = !0) {
				const r = t.filter((e) => l.has(e));
				const s = `${e}_${r.sort().join("_")}`;
				const i = a.get(s);
				if (void 0 !== i) return i;
				const c = n ? ((e) => o.get(e) || e)(e) : e;
				const u = t.length ? [c, ...r].join(" ") : c;
				return a.set(s, u), u;
			}
		},
		2948: (e) => {
