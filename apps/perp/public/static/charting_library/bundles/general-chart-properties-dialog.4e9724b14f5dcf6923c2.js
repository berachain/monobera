	...
	[7078],
	{
		...
		22265: (e, t, a) => {
			...
			function m(e) {
				...
				const { isMobile: s, isTablet: o } = (0, r.getSidebarMode)(t);
				const m = l()(c.container, o && c.isTablet, s && c.isMobile, a);
			...
			function h(e) {
				...
				const { isMobile: _, isTablet: b } = (0, r.getSidebarMode)(t);
				const v = m
					? null == n
						? void 0
						: n.active
				...
				return i.createElement(
					...
					!b &&
						i.createElement(
							...
							_ && i.createElement(s.Icon, { className: c.nested, icon: o }),
						),
				);
			}
		},
		...
		56080: (e, t, a) => {
			...
			const B = i.t(null, void 0, a(73169));
			const w = (0, S.appendEllipsis)(i.t(null, void 0, a(9908)));
			const P = i.t(null, void 0, a(75819));
			const j = _.enabled("chart_template_storage");
			...
			const X = a(54829);
			function Z(e) {
				const [t, a] = (0, F.useRovingTabindexElement)(null);
			...
			function J(e) {
				if (!G.PLATFORM_ACCESSIBILITY_ENABLED)
					return n.createElement(q.DialogSidebarContainer, { ...e });
				const { mode: t, className: a, ...i } = e;
				const { isMobile: l, isTablet: s } = (0, K.getSidebarMode)(t);
				const r = Y()(X.container, s && X.isTablet, l && X.isMobile, a);
			...
			const ie = a(62845);
			const ne = "properties_dialog.last_page_id";
			class le extends n.PureComponent {
				constructor(e) {
					...
					super(e),
						...
						(this._renderFooterLeft = () => {
							const { model: e, chartWidgetCollection: t } = this.props;
							const { isApplyToAllVisible: a } = this.state;
						...
						(this._handleForceFocus = (e) => {
							(0, G.updateTabIndexes)(),
								setTimeout(() => {
									const [t] = (0, G.queryTabbableElements)(e);
									t?.focus();
								});
						});
					const { pages: a, activePageId: i } = e;
					const l = a.filter((e) => e.visible.value());
					let s =
						null !== (t = l.find((e) => e.id === i)) && void 0 !== t ? t : null;
					if (!s) {
						const e = h().getValue(ne);
				...
				componentDidMount() {
					...
					e.layout.subscribe(this._syncApplyToAllVisibility),
						a?.definitions.subscribe(this._onChangeActivePageDefinitions),
						t.forEach((e) => e.visible.subscribe(this._onTabVisibilityChanged));
				}
				componentWillUnmount() {
					const { chartWidgetCollection: e, pages: t } = this.props;
					const { activePage: a } = this.state;
					a?.definitions.unsubscribe(this._onChangeActivePageDefinitions),
						...
						(r) =>
							n.createElement(o.AdaptiveConfirmDialog, {
								...
								additionalHeaderElement:
									null !== s && r
										? n.createElement(ae, { onClick: this._handleBackClick })
										: void 0,
								onSubmit: this._handleSubmit,
								onForceFocus: G.PLATFORM_ACCESSIBILITY_ENABLED
				...
				_renderTabContent(e) {
					...
					const a = this._getCurrentPage(e);
					if (a) {
						const e = t.find((e) => e.id === a.id);
						const i = e ? e.definitions.value() : [];
						return n.createElement(
							Q.TouchScrollContainer,
							{ className: ie.tabContent, onScroll: this._handleScroll },
							n.createElement(
			...
			const re = a(85067);
			const oe = a(37591);
			const ce = i.t(null, void 0, a(74207));
					...
					l.render(
						...
						se.emit("edit_object_dialog", {
							...
							scriptTitle: this._model
								.mainSeries()
								.title(oe.TitleDisplayTarget.StatusLine),
						});
				}
				_ensureCheckpoint(e) {
		...
		81261: (e, t, a) => {
			...
			function o(e) {
				...
				const r = h(e.currentTarget).sort(i.navigationOrderComparator);
				...
				if (-1 === c) return;
				const p = u(o);
				const g = p.indexOf(document.activeElement);
				const _ = -1 !== g;
				const b = (e) => {
					a && (0, n.becomeSecondaryElement)(a),
				...
				switch (t) {
					case 37:
						if (!p.length) return;
						e.preventDefault(),
							b(0 === g ? r[c] : _ ? m(p, g, -1) : p[p.length - 1]);
						break;
					case 39:
						if (!p.length) return;
						e.preventDefault(),
							g === p.length - 1 ? b(r[c]) : b(_ ? m(p, g, 1) : p[0]);
						break;
					case 38: {
						e.preventDefault();
						const t = m(r, c, -1);
		...
		81351: (e, t, a) => {
			...
			function d(e) {
				...
				const [n, d] = (0, r.useRovingTabindexElement)(null);
				return i.createElement(c.PopupMenuItem, {
					...a,
					className: l()(
						o.PLATFORM_ACCESSIBILITY_ENABLED && m.accessible,
						e.isActive && m.active,
						t,
					),
					reference: n,
		...
		74628: (e, t, a) => {
			...
			function m(e) {
				...
				const [m, d] = (0, s.useRovingTabindexElement)(null);
