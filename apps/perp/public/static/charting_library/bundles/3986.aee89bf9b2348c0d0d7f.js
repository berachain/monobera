(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[3986],
	{
		32766: (e, i, t) => {
			...
			const I = new o.TranslatedString(
				"change high-low borders visibility",
				n.t(null, void 0, t(79236)),
			);
			const O = new o.TranslatedString(
			...
			const N = new o.TranslatedString(
			...
			const R = new o.TranslatedString(
			...
			const K = n.t(null, void 0, t(63243));
			const Q = n.t(null, void 0, t(86953));
			const X = n.t(null, void 0, t(5536));
			const Y = n.t(null, void 0, t(87151));
			const Z = n.t(null, void 0, t(55314));
			const ee = n.t(null, void 0, t(83760));
			const ie = n.t(null, void 0, t(72269));
			const te = n.t(null, void 0, t(26458));
			const ne = n.t(null, void 0, t(24248));
			const oe = n.t(null, void 0, t(1277));
			const re = n.t(null, void 0, t(57417));
			const le = n.t(null, void 0, t(50430));
			const se = n.t(null, void 0, t(86846));
			const ae = n.t(null, void 0, t(58747));
			const ce = n.t(null, void 0, t(11157));
			const de =
			...
			const ue = n.t(null, void 0, t(83760));
			const he = n.t(null, void 0, t(72269));
			const pe = n.t(null, void 0, t(94420));
			const ye = n.t(null, void 0, t(83678));
			const ge = n.t(null, void 0, t(15857));
			const ve = n.t(null, void 0, t(75310));
		...
		73986: (e, i, t) => {
					...
					l.forEach((l) => {
						...
						const b = ((e, i) =>
							"style" === e.id
								...
								: "boxSize" === e.id
								  ? "Box size"
								  : i.childs().name.value())(l, y[S]);
						const P = ((e) => o.t(e, { context: "input" }, t(88601)))(b);
						const T = new r.TranslatedString(b, P);
						if ("options" in l) {
			...
			const P = l.enabled("show_average_close_price_line_and_label");
			const T = l.enabled("pre_post_market_sessions");
			...
			const O = new r.TranslatedString(
			...
			const F = (o.t(null, void 0, t(9994)), o.t(null, void 0, t(25866)));
			const N =
				(o.t(null, void 0, t(10989)),
				o.t(null, void 0, t(99983)),
				o.t(null, void 0, t(62521)));
			const E = o.t(null, void 0, t(15107));
			const H =
				(o.t(null, void 0, t(8094)),
				o.t(null, void 0, t(47586)),
				o.t(null, void 0, t(6350)),
				o.t(null, void 0, t(73947)));
			const R = o.t(null, void 0, t(87492));
			const j = o.t(null, void 0, t(39280));
			const U = o.t(null, void 0, t(30777));
			const G = o.t(null, void 0, t(8136));
			const z = o.t(null, void 0, t(31691));
			const J = o.t(null, void 0, t(10591));
			const q = o.t(null, void 0, t(94884));
			const K = o.t(null, void 0, t(22353));
			const Q = o.t(null, void 0, t(4329));
			const X = o.t(null, void 0, t(39292));
			const Y = o.t(null, void 0, t(70816));
			const Z = [
			...
			function ie() {
				...
				const i = ((e = 15) => {
					const i = [];
					for (let t = 0; t <= e; t++)
						i.push({ priceScale: 10 ** t, minMove: 1, frac: !1 });
					return i;
				})();
			...
			class te {
				...
				_createSeriesDefinitions() {
					...
					const i = this._series.getInputsProperties();
					const r = this._series.getInputsInfoProperties();
					const l = e.style.value();
					const u = this._series.getStyleShortName();
					return new Promise((e) => {
						...
						null !== t
							? this._model
									...
									.then((t) => {
										...
										const l = y(this._undoModel, t.id, t.inputs, i, r, o, u);
						...
						const h = (0, s.createOptionsPropertyDefinition)(
							{
								option: (0, s.convertToDefinitionProperty)(
									this._undoModel,
				...
				_seriesDataDefinitions(e) {
					...
					if (T) {
						...
						const n = (0, S.combineWithFilteredUpdate)(
							(e, i) =>
								!i &&
						...
						const o = (0, s.createOptionsPropertyDefinition)(
							{
								option: (0, s.convertToDefinitionProperty)(
									this._undoModel,
									t,
				...
				_seriesPriceLinesDefinitions(e) {
					const i = [];
					const t = this._series.properties().childs();
