(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[607],
	{
		41109: (e, t, i) => {
			...
			const c = new a.TranslatedString(
			...
			const v = new a.TranslatedString(
			...
			const w = new a.TranslatedString(
				"change {title} extend lines",
				n.t(null, void 0, i(96902)),
			);
			const k = new a.TranslatedString(
				"change {title} show pearson's r",
				n.t(null, void 0, i(38317)),
			);
			const S = n.t(null, void 0, i(55719));
			const P = n.t(null, void 0, i(98802));
			const z = n.t(null, void 0, i(41361));
			const I = n.t(null, void 0, i(14105));
			const D = n.t(null, void 0, i(13611));
			class T extends r.StudyLineDataSourceDefinitionsViewModel {
				_stylePropertyDefinitions() {
					...
					const n = new a.TranslatedString(t, this._source.translatedType());
					const r = e.baseLine.childs();
		...
		89204: (e, t, i) => {
			...
			const k = n.t(null, void 0, i(66304));
			const S = n.t(null, void 0, i(21852));
			const P = [
				"1",
				"3",
				"5",
			...
			const T = new a.TranslatedString(
			...
			const N = n.t(null, void 0, i(16812));
			const M = n.t(null, void 0, i(63528));
			const j = n.t(null, void 0, i(61582));
			const Y = n.t(null, void 0, i(36018));
			const x = n.t(null, void 0, i(1277));
			const W = n.t(null, void 0, i(42097));
			const A = n.t(null, void 0, i(34911));
			const U = n.t(null, void 0, i(17712));
			const E = n.t(null, void 0, i(31994));
			const C = n.t(null, void 0, i(38397));
			const B = n.t(null, void 0, i(79511));
			const H = n.t(null, void 0, i(32733));
			const R = n.t(null, void 0, i(91492));
			const V = n.t(null, void 0, i(36993));
			const X = [
				{ title: N, value: 0 },
				{ title: M, value: 1 },
				{ title: j, value: 9 },
			...
			class O extends class {
				...
				_inputsPropertyDefinitions() {
					...
					const t = this._source.properties().childs().inputs.childs();
					return (
						...
						((e, t, l, o, d) => {
							...
							for (const b of t) {
								if (!p(b, o)) continue;
								const t = y(b);
								const _ = `StudyInput${b.id}`;
								const m = g(t);
								const v = new a.TranslatedString(t, m);
								let f = null;
								if ("resolution" === b.type)
									...
									for (const e of b.options) {
										const a = b.optionsTitles?.[e] || e;
										const l = n.t(a, { context: "input" }, i(88601));
									...
									const t = l[b.id];
									const i = (0, r.ensure)(d.getSymbolInfoBySymbol);
									const n = (0, r.ensure)(d.onSymbolsInfosChanged);
				...
				_getInputSourceItems() {
					...
					const t = (0, r.ensureNotNull)(this._sourceInput);
					if (this._source?.isChildStudy()) {
						const i = this._source.inputs()[t.id];
						const n = (0, r.ensureNotNull)(
							this._source.parentSourceForInput(i.v),
						);
						const a = n.title(f.TitleDisplayTarget.StatusLine);
						const l = _.StudyMetaInfo.getChildSourceInputTitles(
							t,
							n.metaInfo(),
							a,
						);
