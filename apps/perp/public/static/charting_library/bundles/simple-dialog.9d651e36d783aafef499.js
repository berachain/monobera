	...
	[8890],
	{
					...
					(e.disableBodyScroll = (e, o) => {
						if (l) {
							...
							if (e && !a.some((t) => t.targetElement === e)) {
								const m = { targetElement: e, options: o || {} };
								(a = [].concat(t(a), [m])),
									(e.ontouchstart = (e) => {
							...
							(v = o),
								setTimeout(() => {
									if (void 0 === c) {
										const e = !!v && !0 === v.reserveScrollBarGap;
										const t =
		...
		70493: (e, t, n) => {
			...
			function w(e) {
				...
				const { isSmallTablet: u, dialogCloseHandler: d } = (0, o.useContext)(
					E,
				);
				const m = (0, p.ensureNotNull)((0, o.useContext)(C.SlotContext));
				const f = (0, g.useIsMounted)();
				const [w, _] = (0, o.useState)(!1);
			...
			function U(e) {
				...
				const { isSmallTablet: c } = (0, o.useContext)(E);
			...
			const L = (e) => {
				...
				const [g, C] = (0, o.useState)(r || "");
				const [E, N] = (0, o.useState)(() => m(g));
				const w = b(e);
				return o.createElement(S, {
			...
			const P = (e, t, n) => {
				const { title: l } = e;
				const a = `${l}_${"text" in e ? e.text : e.html}`;
				if (M.isOpened(a))
