  ...
  [2306],
  {
    ...
    34381: (t, e, o) => {
      ...
      function k(t) {
        const { index: e, color: r, selected: c, onSelect: d } = t,
          [h, u] = (0, i.useState)(!1),
          p = (0, i.useContext)(E),
          [g, m] = (0, L.useRovingTabindexElement)(null),
      ...
      var H = o(80679);
      const U = "#000000",
        j = s.t(null, { context: "Color Picker" }, o(40276));
      ...
      const G = s.t(null, { context: "Color Picker" }, o(53585)),
        q = s.t(null, { context: "Color Picker" }, o(81865));
      function Y(t) {
        const {
            color: e,
            opacity: o,
    ...
    3809: (t, e, o) => {
      ...
      const b = "floating-toolbar-react-widgets",
        w = `<div class="tv-floating-toolbar i-closed i-hidden"><div class="tv-floating-toolbar__widget-wrapper"><div class="tv-floating-toolbar__drag js-drag">${y}</div><div class="tv-floating-toolbar__content js-content"></div><div class="${b}"></div></div></div>`;
      class C {
        constructor(t) {
          ...
          n = (function (t, e) {
            ...
            s.length > 0 &&
              i.push(
                new Z.Action({
                  ...
                  icon: o(36296),
                  shortcutHint:
                    U.humanReadableModifiers(j.Modifiers.Mod) + n + " Drag",
            ...
            if (a.length > 0) {
              const e = {
                ...
                shortcutHint:
                  U.humanReadableModifiers(j.Modifiers.Mod) + n + " C",
                onExecute: () => {
        ...
        showPropertiesOf(t, e, o) {
          ...
          if (
            ...
            for (var n = {}, s = 0; s < i.length; s++) {
              for (
                var a = i[s], l = e, c = a.name.split("."), d = 0;
                d < c.length;
                ++d
              )
                l = l && l[c[d]];
