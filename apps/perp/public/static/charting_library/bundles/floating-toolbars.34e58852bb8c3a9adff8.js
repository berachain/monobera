	...
	[2306],
	{
		...
		70114: (t, e, o) => {
			...
			function v(t) {
				...
				const w = (0, g.useProperty)(e);
				const C = (0, i.useRef)(null);
				const T = w ? (0, l.parseRgba)(w)[3] : void 0;
				const x = "" === w;
				const S = String(L()).toLowerCase() === u.white;
				const [P, E, W] = (0, d.useCustomColors)();
				return i.createElement(
					p.ToolWidgetMenu,
					{
						className: b,
					...
					i.createElement(h.ColorPicker, {
						...
						onColorChange: (t, e) => {
							const o = w
								...
								: 0;
							B((0, c.generateColor)(String(t), o, true)),
		...
		61259: (t, e, o) => {
			...
			function b(t) {
				...
				const b = (0, l.useProperty)((0, r.ensureDefined)(e));
				const w = "mixed" === b || !b;
				const C = ((t) => {
				...
				return i.createElement(
					a.ToolWidgetMenu,
					{
						...
						"data-name": t["data-name"],
						menuDataName: `${t["data-name"]}-menu`,
						verticalDropDirection: p
							? h.VerticalDropDirection.FromBottomToTop
							: void 0,
						horizontalDropDirection: p
							? h.HorizontalDropDirection.FromRightToLeft
							: void 0,
						...
						content: i.createElement(
							...
							w
								...
								: i.createElement(
										...
										!m && i.createElement(s.Icon, { icon: C }),
										i.createElement(
											"div",
		...
		34381: (t, e, o) => {
			...
			function u(t) {
				...
				return (
					(0, i.useLayoutEffect)(() => {
						...
						const t = (0, l.ensureNotNull)(e.current);
						const o = () => {
							const o = (0, a.queryTabbableElements)(t).sort(
								a.navigationOrderComparator,
							);
							if (
								0 === o.length ||
								(o[0].parentElement &&
									!m(o[0].parentElement, (0, l.ensureNotNull)(e.current)))
							) {
								const i = ((t) => {
									const o = g(t)
										.sort(a.navigationOrderComparator)
										.find((t) => m(t, (0, l.ensureNotNull)(e.current)));
									if (!o) return null;
								...
								if (null === i) return;
								if (((0, d.becomeMainElement)(i), o.length > 0))
									for (const t of o) (0, d.becomeSecondaryElement)(t);
							}
						};
						return (
					...
					[
						...
						(e) => {
							...
							if (t) {
								...
								(r = t ? Array.from(t.children) : []), (s = r.indexOf(i));
							} else
								(r = ((l = n),
								Array.from(
							...
							const d = (o) => {
								...
								const i = g(n);
								const r = document.activeElement.parentElement;
								if (!r) return;
								const s = Array.from(r.children).indexOf(
									document.activeElement,
								);
								if (-1 === s) return;
								const a = i["down" === o ? i.indexOf(r) + 1 : i.indexOf(r) - 1];
								if (!a) return;
								e.preventDefault();
			...
			function g(t) {
				return Array.from(t.querySelectorAll('[data-role="row"]')).filter(
					(0, a.createScopedVisibleElementFilter)(t),
				);
			}
			function m(t, e) {
				const o = (0, l.ensureNotNull)(t.parentElement).offsetTop;
				const i = o + (0, l.ensureNotNull)(t.parentElement).clientHeight;
				const n = e.scrollTop;
				const r = n + e.clientHeight;
				return o >= n && i <= r;
			}
			function _(t) {
				document.activeElement &&
					(0, d.becomeSecondaryElement)(document.activeElement),
					(0, d.becomeMainElement)(t),
					t.focus();
			}
			const v = o(43688);
			const f = o(93532);
			...
			const w = Math.max;
			const C = (t, e, o) => {
				e = (o ? (0, f.default)(t, e, o) : void 0 === e)
					? 1
					: w((0, y.default)(e), 0);
				const i = null == t ? 0 : t.length;
				if (!i || e < 1) return [];
				for (let n = 0, r = 0, s = Array(b(i / e)); n < i; )
			...
			const D = o(87466);
			function k(t) {
				const { index: e, color: r, selected: c, onSelect: d } = t;
				const [h, u] = (0, i.useState)(!1);
				const p = (0, i.useContext)(E);
				const [g, m] = (0, L.useRovingTabindexElement)(null);
				const _ = Boolean(p) && !x.CheckMobile.any();
				return i.createElement(
					i.Fragment,
					null,
					i.createElement("button", {
						...
						className: n(
							...
							c && D.selected,
							!r && D.empty,
							String(r).toLowerCase() === W.white && D.white,
						),
						onClick: () => {
							d(r);
						},
			...
			function N(t) {
				const { colors: e, color: o, children: n, onSelect: r } = t;
				if (!e) return null;
				const s = o ? (0, T.parseRgb)(String(o)) : void 0;
				const a = C(e, 10);
				return i.createElement(
					"div",
					...
					a.map((t, e) =>
						i.createElement(
							"div",
							{ className: D.row, "data-role": "row", key: e },
							t.map((t, e) =>
								i.createElement(k, {
									key: String(t) + e,
									index: e,
									color: t,
									selected:
										s && (0, T.areEqualRgb)(s, (0, T.parseRgb)(String(t))),
									onSelect: l,
								}),
							),
						),
			...
			function M(t) {
				...
				const a = parseInt(n, 16) / 255;
				const l = parseInt(r, 16) / 255;
				const c = Math.max(s, a, l);
				const d = Math.min(s, a, l);
				let h;
				const u = c;
				const p = c - d;
				const g = 0 === c ? 0 : p / c;
				...
				constructor() {
					super(...arguments),
						...
						(this._handlePosition = (t) => {
							...
							const n = t.clientX - i.left;
							const r = t.clientY - i.top;
							let s = n / i.width;
							s < 0 ? (s = 0) : s > 1 && (s = 1);
							let a = 1 - r / i.height;
						...
						(this._mouseMove = (0, R.default)(this._handlePosition, 100)),
						(this._handleTouch = (t) => {
			...
			const H = o(80679);
			const U = "#000000";
			const j = s.t(null, { context: "Color Picker" }, o(40276));
			class Z extends i.PureComponent {
				constructor(t) {
					...
					const e = t.color || U;
					this.state = { color: e, inputColor: e.replace(/^#/, ""), hsv: M(e) };
				}
				componentDidMount() {
					let t;
					a.PLATFORM_ACCESSIBILITY_ENABLED &&
						!x.CheckMobile.any() &&
						(null === (t = this._inputRef.current) ||
							void 0 === t ||
							t.focus());
				}
				render() {
					...
					return i.createElement(
						...
						i.createElement(
							...
							i.createElement(
								...
								i.createElement("span", { className: H.inputHash }, "#"),
			...
			const $ = o(93402);
			const G = s.t(null, { context: "Color Picker" }, o(53585));
			const q = s.t(null, { context: "Color Picker" }, o(81865));
			function Y(t) {
				const {
					color: e,
					opacity: o,
				...
				const [g, m] = (0, i.useState)(!1);
				const _ = "number" === typeof o ? o : 1;
				const [v, f] = u();
				return (
					(0, i.useLayoutEffect)(() => {
						p?.update();
					...
					g
						...
						: i.createElement(
								...
								i.createElement(
									...
									i.createElement("div", { className: $.separator }),
									i.createElement(
										E.Provider,
										{ value: c },
										i.createElement(
											N,
											{ colors: l, color: e, onSelect: y },
											n &&
												i.createElement(
													i.Fragment,
													null,
		...
		54368: (t, e, o) => {
			...
			class d extends i.PureComponent {
						...
						(this._handlePosition = (t) => {
							null === this._raf &&
								(this._raf = requestAnimationFrame(() => {
									...
									const o = (0, r.ensureNotNull)(this._pointer);
									const i = e.getBoundingClientRect();
									const n = o.offsetWidth;
									const a = t.clientX - n / 2 - i.left;
									const l = (0, s.clamp)(a / (i.width - n), 0, 1);
									this.setState({
				...
				render() {
					...
					const { inputOpacity: s, isPointerDragged: a } = this.state;
					const d = { color: t || void 0 };
					return i.createElement(
						"div",
						{ className: c.opacity },
						i.createElement(
		...
		6914: (t, e, o) => {
			...
			const s = [200, 300, 400, 500, 600, 700, 800, 900].map(
				(t) => `color-cold-gray-${t}`,
			);
		...
		56512: (t, e, o) => {
			...
			function l() {
				...
				s("add_new_custom_color", (o) => e(c(o, t))),
		...
		9629: (t, e, o) => {
			...
			class _ extends n.FloatingToolbar {
				...
				_createLinetoolWidget(t) {
					...
					const o = (0, a.parseHtmlElement)(e);
					return (
						o.addEventListener("click", async (e) => {
							e.preventDefault(),
								await (0, m.initLineTool)(t),
				...
				_attachHandlers() {
					r.LinetoolsFavoritesStore.favoriteAdded.subscribe(
						...
						this.onWidgetsReordered().subscribe(this, (t, e) => {
							if (
								(r.LinetoolsFavoritesStore.favoriteMoved.unsubscribe(
									this,
									this._onFavoriteMoved,
								),
								!r.LinetoolsFavoritesStore.moveFavorite(
									r.LinetoolsFavoritesStore.favorite(t),
									e,
								))
							)
		...
		3809: (t, e, o) => {
			o.d(e, {
				FLOATING_TOOLBAR_REACT_WIDGETS_CLASS: () => b,
				FloatingToolbar: () => C,
			});
			const i = o(59064);
			const n = o(32563);
				...
				constructor(t) {
					...
					(this._helper = null),
						(this._handleDragStart = (t) => {
							...
							const [i, n] = [(0, p.outerWidth)(o), (0, p.outerHeight)(o)];
							(this._helper = {
						...
						(this._handleDragMove = (t) => {
							...
							const r = this._helper.nextTop;
							const s = this._helper.nextLeft;
							const a =
			...
			class _ {
				...
				_getEventTarget() {
					return g.CheckMobile.iOS() || ((0, g.isMac)() && n.touch)
			...
			const y = o(25388);
			o(19619);
			const b = "floating-toolbar-react-widgets";
			const w = `<div class="tv-floating-toolbar i-closed i-hidden"><div class="tv-floating-toolbar__widget-wrapper"><div class="tv-floating-toolbar__drag js-drag">${y}</div><div class="tv-floating-toolbar__content js-content"></div><div class="${b}"></div></div></div>`;
			class C {
				constructor(t) {
					(this._widget = document.createElement("div")),
						...
						(this._options = t),
						(this._widget = (0, v.parseHtmlElement)(w)),
				...
				_correctPosition(t) {
					...
					const o = this._getSavedPosition();
					const i = window.innerWidth - e.right;
				...
				_getSavedPosition() {
					...
					if ("device" === this._options.positionStorageType) {
						...
						e =
							null !==
								(t = (0, s.getJSON)(this._options.positionSettingsKey)) &&
							void 0 !== t
								? t
								: null;
				...
				_resizeResponsive() {
					...
					const o =
						("vertical" === t ? window.innerHeight : window.innerWidth) - e;
		...
		89824: (t, e, o) => {
			o.d(e, { LineToolPropertiesWidgetBase: () => wt });
			const i = o(50959);
			const n = o(962);
			const r = o(44352);
			const s = o(36298);
			...
			class m extends g() {
				...
				subscribe(t, e) {
					...
					const i = { obj: t, method: e, callback: o };
			...
			function T(t) {
				...
				const c = l.hasModel() && l.model().selection().dataSources();
				return c?.length
					? i.createElement(
							y.MatchMediaMap,
							{
			...
			function I(t) {
				...
				const s = e.model().selection().lineDataSources();
				if (0 === s.length) return null;
				const a = s[0].properties().frozen;
				const l = (0, W.useProperty)(a);
				const c = l
					? { tooltip: r.t(null, void 0, o(15101)), icon: k }
					: { tooltip: r.t(null, void 0, o(42284)), icon: N };
			...
			function G(t, e) {
				...
				const n = ((t, e) => {
					const i = [];
					const n = U.isMacKeyboard ? " +" : "";
					const s = e.filter((t) => t.cloneable());
					s.length > 0 &&
						i.push(
							new Z.Action({
								...
								icon: o(36296),
								shortcutHint: `${
									U.humanReadableModifiers(j.Modifiers.Mod) + n
								} Drag`,
					...
					return ((t, e) =>
						...
						e.some((t) => t.isSynchronizable()))(t, e)
			...
			function Y(t) {
				...
				const s = o.model().selection().lineDataSources();
				const [a, l] = (0, i.useState)([]);
				const c = (0, i.useRef)(null);
				const d = (0, i.useMemo)(() => new H.ActionsProvider(o), [o]);
				const h = (0, i.useCallback)(
					() => d.contextMenuActionsForSources(s),
					[d, s],
				);
						...
						n &&
							h().then((e) => {
								window.matchMedia(w.DialogBreakpoints.TabletSmall).matches
									? O.ContextMenuManager.showMenu(K(e), t, {
											mode: "drawer",
											"data-name": "more-menu",
									  })
									: l(K(e));
				...
				return (
					(0, i.useEffect)(() => {
						let t;
						a.length &&
							(null === (t = c.current) || void 0 === t || t.update());
					}, [a]),
					i.createElement(
						V.ToolWidgetMenu,
						{
				...
				const h = (0, i.useMemo)(
					() => [
						new Z.Action({
							...
							onExecute: () => n.setProperty(e, X.LineStyle.Solid, a),
						}),
						new Z.Action({
							...
							onExecute: () => n.setProperty(e, X.LineStyle.Dashed, a),
						}),
						new Z.Action({
							...
							onExecute: () => n.setProperty(e, X.LineStyle.Dotted, a),
						}),
					],
					[n, e, d],
				);
				return i.createElement(
					V.ToolWidgetMenu,
					{
						...
						verticalDropDirection: l
							? J.VerticalDropDirection.FromBottomToTop
							: void 0,
						horizontalDropDirection: l
							? J.HorizontalDropDirection.FromRightToLeft
							: void 0,
			...
			const st = o(57898);
			o(51338), o(26006);
			class at extends b.FloatingToolbar {
				constructor(t) {
				...
				addGroupedWidget(t, e = {}) {
					(0, u.assert)(
						t.states.length > 0 &&
							-1 !== at._getStateIndexById(t, t.currentStateId),
					...
					const n = this._onWidgetClicked.bind(this, i);
					(i.clickListener = n),
				...
				removeGroupedWidget(t) {
					...
					(0, u.assert)(!1, `Unknown groupId(${t})`);
				}
				...
				setGroupedWidgetState(t, e) {
					const o = this._ensuredGetWidgetDataForId(t);
					(0, u.assert)(
						-1 !== at._getStateIndexById(o.statedWidget, e),
						`Unknown stateId (${e})`,
					),
				...
				_createPopup(t) {
					...
					t.statedWidget.states.forEach((i, n) => {
						...
						const s = this._onSubWidgetClicked.bind(this, t, i.id);
				...
				_closePopup() {
					...
					const e = this._currentPopup.element;
					(this._currentPopup = null),
						t.forEach((t) => {
				...
				_updateWidgetPreview(t) {
					...
					t.toolbarWidget.firstChild
						...
						: (t.toolbarWidget.appendChild(o),
						  t.toolbarWidget.appendChild(at._createCaret()));
				}
				...
				_updatePopupPosition() {
					...
					const e = this._getWidget().getBoundingClientRect();
					const o = this._findWrapperForWidget(t);
					if (!o || !this._currentPopup)
						throw new Error(
							"Toolbar has no wrapper for preview's widget or there is no popup",
						);
					const i = o.getBoundingClientRect();
					const n = this._currentPopup.element.getBoundingClientRect();
					const r = this._currentPopup.element;
					if (this.isVertical())
				...
				_onWindowClicked(t) {
					if (
						...
						for (let e = 0; e < this._statedWidgets.length; ++e)
							if (at._isEventInElement(t, this._statedWidgets[e].toolbarWidget))
								return;
						this._closePopup();
					}
				}
			...
			const mt = new s.TranslatedString(
				"change line tool(s) line style",
				r.t(null, void 0, o(54769)),
			);
			const _t =
				(new s.TranslatedString(
					"apply drawing template",
					r.t(null, void 0, o(49037)),
				),
				r.t(null, void 0, o(89517)));
			const vt = r.t(null, void 0, o(34596));
			const ft = r.t(null, void 0, o(41610));
			const yt = r.t(null, void 0, o(32733));
			const bt = r.t(null, void 0, o(17006));
			class wt {
				constructor(t) {
					(this._isDrawingFinished = new l.WatchedValue(!0)),
						...
						this._iconToolSpawn.subscribe(() =>
							this._onToolChanged(d.tool.value()),
						),
				...
				onSourceChanged(t) {
					...
					if (
						...
						this.activeChartWidget().model().model().dataSourceForId(e.id())
							? (!e.userEditEnabled() ||
									(!(0, dt.isLineDrawnWithPressedButton)(e.toolname) &&
				...
				hide() {
					this._updateVisibilityTimeout &&
						...
						(this._propertyApplier = undefined);
				}
				templatesList() {
				...
				_propertyApplierImpl() {
					return (
						this._propertyApplier ||
							(this._propertyApplier = new ut.PropertyApplierWithoutSavingChart(
				...
				_createSettingsButton() {
					const t = {
						component: E,
						props: { title: _t, activeChartWidget: this.activeChartWidget() },
					};
				...
				_unmountFixedToolbar() {
					null !== this._fixedContainer &&
						(n.unmountComponentAtNode(this._fixedContainer),
						(this._fixedToolbarRendered = !1));
				}
				_unmountToolbar() {
		...
		26916: (t, e, o) => {
			const i = o(36298).TranslatedString;
			const n = o(89824).LineToolPropertiesWidgetBase;
			const r = o(70114).ColorPickerButton;
			const s = o(61259).LineWidthButton;
			const a = o(94071);
			const l = o(21065);
			const c = o(48984);
			const d = new i(
				"change line tool(s) color",
				o(44352).t(null, void 0, o(68519)),
			);
			const h = new i(
				"change line tool(s) background color",
				o(44352).t(null, void 0, o(74350)),
			);
			const u = new i(
				"change line tool(s) text color",
				o(44352).t(null, void 0, o(16631)),
			);
			const p = new i(
				"change line tool(s) line width",
				o(44352).t(null, void 0, o(41648)),
			);
			const g = o(44352).t(null, void 0, o(40054));
			const m = o(44352).t(null, void 0, o(12928));
			const _ = o(44352).t(null, void 0, o(19221));
			const v = o(44352).t(null, void 0, o(21327));
			const f = o(44352).t(null, void 0, o(38455));
			const y = o(44352).t(null, void 0, o(71845));
			const b = o(44352).t(null, void 0, o(32733));
			const w = o(44352).t(null, void 0, o(23886));
			const C = o(44352).t(null, void 0, o(86327));
			const T = o(44352).t(null, void 0, o(47059));
			const x = o(44352).t(null, void 0, o(36785));
			const S = o(44352).t(null, void 0, o(49593));
			const P = o(44352).t(null, void 0, o(67455));
			const E = o(44352).t(null, void 0, o(79964));
			const W = o(44352).t(null, void 0, o(45320));
			class L extends n {
				constructor(t) {
				...
				_getPossibleProperty(t) {
					for (
						let e = [], o = this._defaultToolProperties(), i = 0;
						i < o.length;
						i++
					) {
						const n = o[i];
				...
				showPropertiesOf(t, e, o) {
					...
					if (
						...
						for (let n = {}, s = 0; s < i.length; s++) {
							for (
								let a = i[s], l = e, c = a.name.split("."), d = 0;
								d < c.length;
								++d
							)
								l = l?.[c[d]];
				...
				_createToolExceptionCases() {
					return {
						...
						LineToolRiskRewardShort:
							L.prototype._riskPropertiesExceptionCases(),
