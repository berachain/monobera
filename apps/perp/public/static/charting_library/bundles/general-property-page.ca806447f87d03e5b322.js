(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[3596],
	{
		73023: (e, t, i) => {
			...
			const r = i(44352);
			const n = i(14483);
			const l = (i(67980), i(40493), i(97145));
			const a = i(46141);
			const s = i(73955);
			const c = i(78159);
			const d = i(3228);
			...
			const x = r.t(null, void 0, i(15474));
			const M = r.t(null, void 0, i(67369));
			const O = r.t(null, void 0, i(99487));
			const R = r.t(null, void 0, i(22519));
			const G = r.t(null, void 0, i(1111));
			const A = r.t(null, void 0, i(31326));
			const H = r.t(null, void 0, i(68791));
			const F = r.t(null, void 0, i(91322));
			const Z = r.t(null, void 0, i(27331));
			const B = r.t(null, void 0, i(75991));
			const N = r.t(null, void 0, i(24248));
			const E = n.enabled("symbol_info_price_source");
			const j =
			...
			const Q = new v.TranslatedString(
				"change symbol labels visibility",
				r.t(null, void 0, i(9402)),
			);
			const X = new v.TranslatedString(
			...
			const ee = new v.TranslatedString(
			...
			const oe = new v.TranslatedString(
				"change no overlapping labels",
				r.t(null, void 0, i(83935)),
			);
			const re = new v.TranslatedString(
			...
			const ge = r.t(null, void 0, i(27767));
			const ye =
				(r.t(null, void 0, i(40847)),
				r.t(null, void 0, i(25084)),
				r.t(null, void 0, i(9654)));
			const Pe = (r.t(null, void 0, i(29687)), r.t(null, void 0, i(34905)));
			const fe =
				(r.t(null, void 0, i(47586)),
				r.t(null, void 0, i(74823)),
				r.t(null, void 0, i(95036)));
			const be = r.t(null, void 0, i(60971));
			const me = r.t(null, void 0, i(42502));
			const we = r.t(null, void 0, i(78905));
			const Se = r.t(null, void 0, i(94370));
			const _e = r.t(null, void 0, i(50985));
			const De = r.t(null, void 0, i(77534));
			const Ve = r.t(null, void 0, i(17319));
			const Te = r.t(null, void 0, i(47926));
			const Ce = r.t(null, void 0, i(97378));
			const ke = r.t(null, void 0, i(53224));
			const Le = r.t(null, void 0, i(18219));
			const We = r.t(null, void 0, i(64859));
			const xe = r.t(null, void 0, i(25209));
			const Me = r.t(null, void 0, i(97316));
			const Oe = r.t(null, void 0, i(43637));
			const Re =
			...
			const Ze = new v.TranslatedString(
				"change sessions breaks color",
				r.t(null, void 0, i(1579)),
			);
			const Be = new v.TranslatedString(
			...
			const Ee = r.t(null, void 0, i(59827));
			...
			const qe = new v.TranslatedString(
			...
			const Ke = new v.TranslatedString(
			...
			const ct = r.t(null, void 0, i(27331));
			const dt = r.t(null, void 0, i(37174));
			const ut = r.t(null, void 0, i(36426));
			const ht = r.t(null, void 0, i(34403));
			const pt = r.t(null, void 0, i(49199));
			const vt = r.t(null, void 0, i(39392));
			const gt = r.t(null, void 0, i(37229));
			const yt = r.t(null, void 0, i(83182));
			const Pt = r.t(null, void 0, i(73908));
			const ft = r.t(null, void 0, i(46720));
			const bt = r.t(null, void 0, i(77705));
			const mt = r.t(null, void 0, i(74343));
			const wt = r.t(null, void 0, i(50446));
			const St = r.t(null, void 0, i(65994));
			const _t = r.t(null, void 0, i(91757));
			const Dt = r.t(null, void 0, i(21141));
			const Vt = r.t(null, void 0, i(36014));
			const Tt = r.t(null, void 0, i(16812));
			const Ct = r.t(null, { context: "unit" }, i(50831));
			function kt(e, t, o, s, c, d, u, h, p, v) {
				...
				const b = [];
				const m = [];
				const w = (0, a.createColorPropertyDefinition)(
					{
						color: (0, a.getColorDefinitionProperty)(e, t.background, null, je),
				...
				const S = t.vertGridProperties.childs();
				const _ = t.horzGridProperties.childs();
				const D = (0, a.createOptionalTwoColorsPropertyDefinition)(
					{
				...
				const V = (0, y.createWVFromGetterAndSubscription)(
					() => 1 !== e.model().panes().length,
					e.model().panesCollectionChanged(),
				);
				const T = (0, a.createLinePropertyDefinition)(
					{
				...
				const C = t.crossHairProperties.childs();
				const k = (0, a.createLinePropertyDefinition)(
					{
						color: (0, a.getColorDefinitionProperty)(
							e,
							C.color,
				...
				const L = (0, a.createTextPropertyDefinition)(
					{
						color: (0, a.getColorDefinitionProperty)(e, s.textColor, null, Je),
						size: (0, a.convertToDefinitionProperty)(e, s.fontSize, Ke),
					},
					{ id: "scalesText", title: gt },
				);
				const W = (0, a.createLinePropertyDefinition)(
					{
						color: (0, a.getColorDefinitionProperty)(e, s.lineColor, null, Qe),
					},
				...
				const M = (0, a.createOptionsPropertyDefinition)(
			...
			const It = r.t(null, void 0, i(89053));
			const qt = r.t(null, void 0, i(79194));
			const Jt = r.t(null, void 0, i(43115));
			const Kt = r.t(null, void 0, i(23238));
			const Qt =
			...
			class Yt {
				constructor(e, t, i) {
					...
					const r = (0, y.createWVFromProperty)(o.gridLinesMode);
					...
					const o = ((e, t, o, n, s) => {
						...
						if (j) {
							const i = (0, a.createCheckablePropertyDefinition)(
								{
									checked: (0, a.convertToDefinitionProperty)(e, t.showLogo, w),
								},
								{ id: "showLogo", title: x },
							);
							d.push(i);
						...
						const I = (0, a.createCheckableSetPropertyDefinition)(
							{
								checked: (0, a.convertToDefinitionProperty)(
									e,
									t.showStudyTitles,
						...
						const q = (0, a.createCheckablePropertyDefinition)(
							{
								checked: (0, a.convertToDefinitionProperty)(
									e,
									t.showStudyValues,
						...
						const J = (0, y.createWVFromGetterAndSubscription)(
							() =>
								e
									.model()
									.priceDataSources()
									.some(
										(e) =>
											!(0, P.isActingAsSymbolSource)(e) && e.showInObjectTree(),
									),
						...
						const K = [];
						const Q = (0, a.createTransparencyPropertyDefinition)(
							{
								checked: (0, a.convertToDefinitionProperty)(
									e,
									t.showBackground,
				...
				_createScalesDefinitions() {
					...
					const c = this._model.mainSeriesScaleRatioProperty();
					return ((e, t, i, o) => {
						...
						if (o.seriesHasClosePrice) {
							...
							const o = (0, a.createOptionsPropertyDefinition)(
								{
									checked: (0, a.convertToDefinitionProperty)(
										e,
						...
						const p = (0, a.createCheckablePropertyDefinition)(
							{
								checked: (0, a.convertToDefinitionProperty)(
									e,
							...
							const i =
								o.currencyConversionEnabled && o.unitConversionEnabled
									...
									: o.currencyConversionEnabled
									  ? ne
									  : ae;
							const r = (0, a.createOptionsPropertyDefinition)(
								{
									option: (0, a.convertToDefinitionProperty)(
										e,
						...
						const b = (0, a.createOptionsPropertyDefinition)(
							{
				...
				_createMaxOffsetPropertyObject() {
					...
					const t = new l.WatchedValue(Math.floor(e.maxRightOffset()));
				...
				_createAppearancePropertyPage() {
					...
					const t = e.paneProperties.childs();
					const i = e.scalesProperties.childs();
					const r = this._model.watermarkSource();
					let n = null;
					null !== r && (n = r.properties().childs());
					const l = { property: c.property(), values: c.availableValues() };
					const a = { property: d.property(), values: d.availableValues() };
					...
					const h = (0, o.ensureNotNull)(
						this._defaultRightOffsetPercentageWatchedValue,
					);
					const p = (0, o.ensureNotNull)(
						this._useRightOffsetPercentageWatchedValue,
					);
					const v = kt(
						this._undoModel,
