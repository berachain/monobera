		...
		79059: (t, e, i) => {
			...
			class y extends c.BitmapCoordinatesPaneRenderer {
				...
				hitTest(t) {
					...
					const o = (0, d.interactionTolerance)().anchor;
				...
				_drawImpl(t) {
					...
					for (let t = 0; t < this._data.points.length; ++t) {
						...
						const o = this._data.backgroundColors[t];
				...
				_drawPoints(t, e, i, n, r) {
					...
					f % 2 !== g % 2 && (f += 1);
					const y = (g % 2) / 2;
					const m = (0, d.interactionTolerance)().anchor;
		...
		60305: (t, e, i) => {
			...
			class h extends u.StudyInputsPaneView {
				...
				_fillInformationAboutPointsAndCursors(t, e) {
					...
					this._inputs.forEach((i, r) => {
						...
						if (Array.isArray(i)) {
							...
							const e = "price" === i[0].type ? i[0] : i[1];
							const n = this._getInputValue(t.id);
							const r = this._getInputValue(e.id);
							null !== n &&
								null !== r &&
				...
				_createStudyAnchor(t, e, i) {
					...
					const r = this._getStudyAnchorRenderer(i);
					const a = this._inputs.indexOf(this._model.activeItemBeingMoved());
					...
					return (
						this._editable || (h.disableInteractions = !0), r.setData(h), r
					);
				}
				...
				_fillCompositeRendrer(t, e) {
					this._inputs.forEach((t) => {
						if (Array.isArray(t)) {
							const e = t[0];
							const i = t[1];
							const n = this._getInputValue(e.id);
							const r = this._getInputValue(i.id);
							if (null !== n && null !== r) {
								const t = this._createLineRendererForinput(n, e);
								const s = this._createLineRendererForinput(r, i);
								null !== t &&
									null !== s &&
		...
		81824: (t, e, i) => {
			...
			class s {
				...
				_convertTimeToCoordinate(t) {
					...
					const i = e.timePointToIndex(t / 1e3);
