	...
	[1859],
	{
		...
		90744: (e, t, a) => {
			...
			const m = (e, t) => {
				...
				const o = (0, r.useContext)(l.ControlGroupContext);
				const { isInButtonGroup: c, isGroupPrimary: d } = (0, r.useContext)(u);
				const {
					className: m,
					isSelected: p,
					children: y,
			...
			function y(e) {
				...
				const N = S ? (null != D ? D : 2) : 1;
				const z =
					N > 0 ? { ...k, "--ui-lib-light-button-content-max-lines": N } : k;
				return r.createElement(
					"button",
					{
						...T,
		...
		35057: (e, t, a) => {
			...
			class z extends r.PureComponent {
					...
					super(...arguments),
						...
						(this._handleKeyDown = (e) => {
							if (!e.defaultPrevented) {
								if (
									(this.props.onKeyDown?.(e), 27 === (0, i.hashFromEvent)(e))
								) {
									...
									const r = (0, n.ensureNotNull)(this._reference);
									if (null !== a) {
										if (
											(e.preventDefault(),
				...
				render() {
					...
					const Q = "after" !== y ? _ : void 0;
					const G = "after" === y ? _ : void 0;
					const V = "string" === typeof o ? o : Y || "";
					const Z = (0, k.filterDataProps)(this.props);
					const $ = (0, D.mergeRefs)([this._handleReference, H]);
					return r.createElement(
						m.MatchMedia,
		...
		91952: (e, t, a) => {
			...
			function h(e) {
				...
				const s = n.valueOf() <= (0, i.resetToDayEnd)(new Date()).valueOf();
				const l = (0, r.useMemo)(
			...
			function p(e) {
				...
				const [n, o] = (0, r.useState)(t.from);
				const [s, i] = (0, r.useState)(t.to);
				const l = n.valueOf() <= s.valueOf();
				const u = (0, r.useMemo)(
					() => ({
						dateFrom: n,
						dateTo: s,
			...
			function L(e) {
				...
				return r.createElement(w.TimeInput, {
					value:
						((s = t),
						`${(0, i.twoDigitsFormat)(s.getHours())}:${(0, i.twoDigitsFormat)(
							s.getMinutes(),
						)}`),
					onChange: n,
					disabled: a,
			...
			function Y(e) {
				...
				const { date: s, setDate: i } = (0, o.ensureNotNull)(
					(0, r.useContext)(d),
				);
				const l = (0, r.useRef)(null);
			...
			function Q(e) {
				...
				const [h, p] = (0, r.useState)(0);
				const { date: _, isValid: g } = (0, o.ensureNotNull)(
					(0, r.useContext)(d),
				);
				const {
					dateFrom: M,
			...
			const X = a(27365);
			const ee = "goTo";
			const te = new l.DialogsOpenerManager();
			function ae(e) {
				if (te.isOpened(ee)) return;
				if (!e.hasModel()) return;
				const t = e.model();
				const a = document.createElement("div");
				const o = r.createElement(V, {
					onClose: l,
					...
					onGoToRange: (t, a) => {
						!((e, t, a) => {
							...
							const o = n && (0, Z.normalizeIntervalString)(n);
							const l = c().get_timezone(r);
							const d = (e) => (0, u.cal_to_utc)(l, new Date(e));
							const h = (0, i.addLocalTime)(t).valueOf();
							const m = (0, i.addLocalTime)(a).valueOf();
							const p = {
								val: {
									type: "time-range",
									from: d(h) / 1e3,
			...
			function ne(e) {
				const t = ((e) => {
					...
					const n = r.nearestIndex(
						a.firstBar(),
						$.PlotRowSearchMode.NearestRight,
					);
					const s = r.nearestIndex(
						a.lastBar(),
