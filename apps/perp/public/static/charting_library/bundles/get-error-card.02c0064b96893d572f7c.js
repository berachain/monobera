(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[139],
	{
		...
		95257: (e, t) => {
			...
			let s = Symbol.for("react.context");
			...
			function R(e, t, n) {
				...
				if (1 === s) u.children = n;
					...
					for (let c = Array(s), l = 0; l < s; l++) c[l] = arguments[l + 2];
					u.children = c;
				}
				if (e?.defaultProps)
			...
			(t.Children = {
				...
				(t.cloneElement = (e, t, n) => {
					...
					if (1 === c) o.children = n;
						...
						s = Array(c);
						for (let l = 0; l < c; l++) s[l] = arguments[l + 2];
						o.children = s;
					}
					return {
						$$typeof: r,
				...
				(t.useCallback = (e, t) => V.current.useCallback(e, t)),
				(t.useContext = (e) => V.current.useContext(e)),
				(t.useDebugValue = () => {}),
				(t.useDeferredValue = (e) => V.current.useDeferredValue(e)),
				(t.useEffect = (e, t) => V.current.useEffect(e, t)),
				(t.useId = () => V.current.useId()),
				(t.useImperativeHandle = (e, t, r) =>
					V.current.useImperativeHandle(e, t, r)),
				(t.useInsertionEffect = (e, t) => V.current.useInsertionEffect(e, t)),
				(t.useLayoutEffect = (e, t) => V.current.useLayoutEffect(e, t)),
				(t.useMemo = (e, t) => V.current.useMemo(e, t)),
				(t.useReducer = (e, t, r) => V.current.useReducer(e, t, r)),
				(t.useRef = (e) => V.current.useRef(e)),
				(t.useState = (e) => V.current.useState(e)),
				(t.useSyncExternalStore = (e, t, r) =>
					V.current.useSyncExternalStore(e, t, r)),
				(t.useTransition = () => V.current.useTransition()),
				(t.version = "18.2.0");
		},
		50959: (e, t, r) => {
			e.exports = r(95257);
