(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
	[4862],
	{
		...
		67029: (e, t, n) => {
			n.d(t, { ControlSkeleton: () => b, InputClasses: () => p });
			const o = n(50959);
			const r = n(97754);
			const i = n(50151);
			const s = n(38528);
			...
			function g(e, t, n, o) {
				...
				const y = h(null != i ? i : (0, c.getGroupCellRemoveRoundBorders)(n));
				return r(
					d().container,
					d()[`container-${u}`],
					d()[`intent-${l}`],
			...
			function v(e, t) {
				...
				return o.createElement(
					...
					w,
					C,
					o.createElement("span", { className: m(e, k, I) }),
				);
			}
		...
		31261: (e, t, n) => {
			...
			function b(e) {
				...
				const [b, y] = (0, u.useFocus)();
				const _ = t ? void 0 : b ? -1 : r;
				const S = t ? void 0 : b ? r : -1;
				const {
						isMouseDown: w,
						handleMouseDown: C,
						handleMouseUp: T,
					} = (0, d.useIsMouseDown)();
				const E = (0, s.createSafeMulticastEventHandler)(
						y.onFocus,
						(e) => {
				...
				const I = (0, s.createSafeMulticastEventHandler)(y.onBlur, h);
		...
		21593: (e, t, n) => {
			...
			const r = n(38952);
			function i(e) {
				return o.createElement("a", { ...(0, r.renameRef)(e) });
			}
			o.PureComponent;
		},
		48027: (e, t, n) => {
			...
			function i(e) {
				...
				const [a, c] = (0, r.useFocus)(void 0, l);
				const u = (0, o.createSafeMulticastEventHandler)(l ? void 0 : c.onFocus, t);
				const d = (0, o.createSafeMulticastEventHandler)(l ? void 0 : c.onBlur, n);
				return {
					...e,
		...
		23263: (e, t, n) => {
			n.d(t, { ManageDrawings: () => O });
			const o = n(50959);
			const r = n(43370);
			const i = (n(50151), n(9745));
			const s = n(44352);
			const l = n(36298);
			const a = n(97145);
			const c = n(59224);
			...
			function S(e) {
				...
				const c = ((e, t) => {
						...
						const f = ((e, t) => !!t && "black" === e)(o, h);
						return m(
							n,
							e["round-button"],
							f ? e[`color-inverted${o}`] : e[`color-${o}`],
							e[`variant-${r}`],
							e[`size-${i}`],
							l && e.animated,
							s && e.stretch,
				...
				return o.createElement(
					...
					!(0, v.isIconOnly)(n, r) &&
						o.createElement("span", { className: y().content }, n),
					l &&
						o.createElement(i.Icon, {
			...
			n(21593);
			function w(e, t) {
				const { align: n = "start", size: o = "xsmall" } = t;
				return m(e["round-tabs"], e[`align-${n}`], e[`size-${o}`]);
			}
			function C(e, t) {
				const { variant: n = "primary", isChecked: o } = t;
				return m(e.tab, e[`tab-${n}`], o && e.checked);
			}
			const T = n(48729);
			const E = n.n(T);
			const I = o.forwardRef((e, t) => {
				...
				return o.createElement(
					"div",
					{ className: w(s, e), ref: t },
					n.map((e) => {
						const { isChecked: t, ...n } = e;
						return o.createElement(S, {
							...n,
							className: C(s, { ...n, variant: i, isChecked: t }),
							size: r,
							variant: i,
						});
					}),
			...
			s.t(null, void 0, n(87871)),
				s.t(null, void 0, n(10538)),
				s.t(null, void 0, n(74860));
			const M = n(29540);
			const k = n(28355);
			const D = (0, c.getLogger)("Chart.ManageDrawings");
			const N = new Map();
			function L(e) {
				let t = N.get(e);
			...
			const x = new l.TranslatedString(
					...
					s.t(null, void 0, n(23481)),
				);
			const z = (e) =>
					s
						.t(null, { plural: "{drawingsCount} drawings", count: e }, n(88143))
						.format({ drawingsCount: e.toString() });
			const j = s.t(null, void 0, n(85128));
			const A = s.t(null, void 0, n(18570));
			function R(e) {
				const [t, n] = o.useState(null);
				const [i, s] = o.useState(null);
				const [l, a] = o.useState(null);
				const [c, d] = (o.useRef(null), o.useState([]));
				return (
					o.useEffect(
						() => (
							e.withModel(null, () => {
					...
					o.useEffect(() => {
						if (null !== t) {
							const e = {};
							const n = (0, r.default)(f, 250, { leading: !1 });
							return (
								f(),
					...
					if (t && l) {
						...
						if (o) {
							const n = Array.from(o)
								...
								.filter(h.notNull);
							n.length > 0 && t.removeSources(n, !1, x.format({ symbol: e }));
							const r = L(t.model().id());
							r.setValue([...r.value(), e]);
							try {
								await f();
							} catch (e) {
								D.logError(`Error removing line tools: ${e}`);
							}
						...
						const t = [new Map(), new Map(), new Map()];
						{
							...
							e.forEach((e) => {
								...
								if ((0, u.isLineTool)(e) && e.showInObjectTree()) {
									const o = null !== (t = e.symbol()) && void 0 !== t ? t : "";
									const r = n.get(o) || new Set();
									r.add(e.id()), n.set(o, r);
								}
							});
						}
						return t;
				...
				async function f() {
					null !== t && a(await p(t.dataSources()));
				}
			}
			function O(e) {
				const { isMobile: t, chartWidget: r, onClose: l, onInitialized: a } = e;
				const {
						currentSymbol: c,
				...
				const [f, v] = o.useState(0);
				const [b, y, _] = o.useMemo(() => {
						let e;
						if (null !== c && null !== u) {
							const t = [];
							let n = 0;
							...
							o.createElement(
								...
								`${
									...
									s
										...
										.format({ drawingsCount: e.toString() }))(y)}`,
							),
						0 === b.length
							? null === u
								? o.createElement(g.Spinner, { className: k.spinner })
								: o.createElement(
										"div",
										{ className: k.empty },
										o.createElement(i.Icon, { className: k.image, icon: M }),
										o.createElement("span", null, A),
								  )
							: b.map(
									({ symbol: e, drawingsCount: n, onRemove: r, onClick: i }) =>
										o.createElement(d.DialogContentItem, {
											key: e,
											title: e,
											subtitle: z(n),
											removeBtnLabel: j,
		...
		67165: (e, t, n) => {
			n.r(t), n.d(t, { ObjectTreeDialogRenderer: () => Xo });
			const o = n(50959);
			const r = n(962);
			...
			async function s(e, t) {
				return i(e, t, () => Promise.resolve());
			}
			const l = n(59224);
			const a = (0, l.getLogger)("DataSourcesIcons");
			let c = null;
			function u() {
				const e = n.c[57673];
				return e
			...
			function g() {
				return (
					...
					h.then((e) => ((c = { linetool: e[0], series: e[1] }), c))
				);
			}
			const m = n(41590);
			const p = n(37558);
			...
			function P(e) {
				const { hideTitle: t } = e;
				const { viewModel: r } = (0, T.ensureNotNull)((0, o.useContext)(L));
				const i = (0, N.useForceUpdate)();
				const s = r.selection();
				(0, o.useEffect)(() => {
					const e = {};
					return (
				...
				const a = r.isSelectionCopiable();
				const c = r.isSelectionCloneable();
				const u = !a && !c;
				const d = r.canSelectionBeGrouped();
				const h = !1;
				return o.createElement(
					z.Toolbar,
					{ orientation: "horizontal", className: B.toolbar },
					!t &&
						o.createElement(
							"div",
							{ className: E(B.title, B.withoutIcon) },
							v.t(null, void 0, n(31095)),
							h,
						),
					o.createElement(
						"div",
						...
						o.createElement(
							D.ToolbarMenuButton,
							{
								...
								isDisabled: u,
								content: o.createElement(M.Icon, { icon: A }),
						...
						o.createElement(
							D.ToolbarMenuButton,
							{
								...
								isDisabled: l,
								content: o.createElement(M.Icon, { icon: R }),
						...
						t &&
							o.createElement(
								o.Fragment,
								null,
								o.createElement("div", { className: B.spacing }),
								o.createElement(x.ToolbarIconButton, {
									className: B.button,
			...
			const G = n(7809);
			const U = n(23642);
			const Z = ((K = "OBJECT_TREE"), (e) => `${K}__${e}`);
			let K;
			const Y = Z("SET_NODES");
			const $ = Z("SYNC_NODES");
			const q = Z("UPDATE_NODE");
			const J = Z("UPDATE_NODES");
			const Q = Z("RESET_TREE");
			const X = Z("SET_SELECTED_IDS");
			const ee = Z("DROP_SELECTION");
			const te = Z("SELECT_PREVIOUS");
			const ne = Z("SELECT_NEXT");
			const oe = Z("MULTI_SELECT_PREVIOUS");
			const re = Z("MULTI_SELECT_NEXT");
			const ie = Z("PROCESS_DROP_TARGET");
			const se = Z("UPDATE_DROP_TARGET");
			const le = Z("HIDE_DROP_TARGET");
			const ae = Z("START_MULTI_SELECT");
			const ce = Z("STOP_MULTI_SELECT");
			const ue = (Z("REMOVE_NODE"), Z("SET_FOCUSED_NODE"));
			const de = Z("SCROLL_TO_ID");
			const he = Z("SET_IS_SELECTED");
			const ge = Z("SET_IS_EXPANDED");
			const me = Z("SET_DISABLED_NODES");
			const pe = Z("MOVE_NODES");
			const fe = (Z("START_DRAG"), Z("END_DRAG"));
			const ve = () => ({ type: te });
			const be = () => ({ type: ne });
			const ye = () => ({ type: oe });
			const _e = () => ({ type: re });
			...
			const we = () => ({ type: ee });
			const Ce = (e) => ({ type: X, ids: e });
			const Te = (e, t, n) => ({ type: pe, ids: e, targetId: t, dropType: n });
			const Ee = () => ({ type: ae });
			const Ie = () => ({ type: ce });
			const Me = (e) => ({ type: ue, nodeId: e });
			const ke = (e) => ({ type: de, nodeId: e });
			const De = (e, t, n = 0) => ({ type: he, nodeId: e, isSelected: t, mode: n });
			const Ne = (e, t) => ({ type: ge, nodeId: e, isExpanded: t });
			const Le = (e) => ({ type: me, ids: e });
			const xe = () => ({ type: fe });
			const ze = n(77145);
			const je = (e) => e.nodes;
			const Ae = (e) => e.selection;
			const Re = (e) => e.dropTarget;
			const Oe = (e) => e.expanded;
			const Be = (e) => e.scrollToId;
			const Fe = (e, t) => t;
			const Pe = (0, ze.createSelector)([je, Fe], (e, t) => e[t]);
			const We = (0, ze.createSelector)([Ae, Fe], (e, t) => e.ids.includes(t));
			const He = (0, ze.createSelector)([Oe, Fe], (e, t) => e.includes(t));
			const Ve = (0, ze.createSelector)(
					[(e) => e.disabled, Ae, Fe],
					(e, t, n) => !t.ids.includes(n) && e.includes(n),
				);
			const Ge = (0, ze.createSelector)(je, (e) => Object.keys(e));
			const Ue = (0, ze.createSelector)(Ae, ({ ids: e }) => e);
			const Ze = (0, ze.createSelector)(Ae, ({ lastFocusedNodeId: e }) => e);
			const Ke = (0, ze.createSelector)(Ae, ({ isMultiSelecting: e }) => e);
			const Ye = (0, ze.createSelector)([je, Ue], (e, t) => t.map((t) => e[t]));
			const $e = (0, ze.createSelector)(je, (e) =>
					Object.values(e).filter((e) => 0 === e.level),
				);
			const qe = (0, ze.createSelector)([je, $e], (e, t) =>
					t.reduce((t, n) => [...t, ...Je(e, (0, T.ensureDefined)(n))], []),
				);
			function Je(e, t) {
				const n = [];
			...
			const Qe = (0, ze.createSelector)([je, $e, Oe], (e, t, n) => {
					const o = new Set(n);
					return t.reduce(
						(t, n) => [...t, ...et(e, (0, T.ensureDefined)(n), o)],
						[],
					);
				});
			const Xe = (0, ze.createSelector)([je, Ue, Oe], (e, t, n) => {
					const o = new Set(n);
			...
			function et(e, t, n) {
				...
				for (const r of t.children) {
					const t = e[r];
					void 0 !== t && (o.push(t), n.has(r) && o.push(...et(e, t, n)));
				}
				return o;
			}
			function* tt(e) {
				const { selectedIds: t, nodes: n } = yield (0, S.call)(e);
				const o = {};
				for (let e = 0; e < n.length; ++e) {
					const t = n[e];
					o[t.id] = t;
				}
				yield (0, S.put)(((e) => ({ type: Y, nodes: e }))(o)),
					yield (0, S.put)(Ce(t));
				!Ze(yield (0, S.select)()) &&
					t.length > 0 &&
					(yield (0, S.put)(Me(t[0])), yield (0, S.put)(ke(t[0])));
			}
			function* nt(e) {
				for (;;) {
					if ((yield (0, S.take)([ae, ce])).type === ae) {
						const t = Ge(yield (0, S.select)()).filter((t) => !e(t));
						yield (0, S.put)(Le(t));
					} else yield (0, S.put)(Le([]));
				}
			}
			function* ot() {
				for (;;) {
					const { type: e } = yield (0, S.take)([re, oe]);
					const t = yield (0, S.select)();
					const n = qe(t);
					const o = n.length;
					const r = Ze(t);
					const i = [...Ue(t)];
					const s = 1 === i.length && i[0] !== r;
					const l = n.findIndex((e) => e.id === (s ? i[0] : r));
					if ((e === oe && 0 === l) || (e === re && l === o - 1)) continue;
					const a = ut(t, e === re ? "next" : "previous", n, l);
					const { id: c } = a;
					i.includes(c) && r
						? (yield (0, S.put)(De(r, !1, 1)), yield (0, S.put)(Me(c)))
						: yield (0, S.put)(De(c, !0, 1)),
						yield (0, S.put)(ke(c));
				}
			}
			function* rt(e, t) {
				for (;;) {
					const { type: n } = yield (0, S.take)([ne, te]);
					const o = yield (0, S.select)();
					const r = qe(o);
					const i = Ye(o);
					const s = Ze(o);
					if (1 === i.length && i[0].id !== s && !s) {
						...
						if (n === te) {
							...
							const t = ut(o, "previous", r, e);
							yield (0, S.put)(Me(t.id));
							continue;
						}
					}
					const l = r.findIndex((e) => e.id === s);
					const a = n === ne ? "next" : "previous";
					const c = ut(o, a, r, l);
					const { id: u } = c;
					e ? e([u], a) : yield (0, S.put)(Ce([u])),
						t?.(u),
						yield (0, S.put)(Me(u));
				}
			}
			function* it(e, t = () => !0) {
				for (;;) {
					const { mode: n, nodeId: o, isSelected: r } = yield (0, S.take)(he);
					let i = [...Ue(yield (0, S.select)())];
					const s = qe(yield (0, S.select)());
					if (1 === n) r ? i.push(o) : i.splice(i.indexOf(o), 1);
					else if (2 === n && i.length > 0) {
						const e = Ze(yield (0, S.select)());
			...
			function* st(e, t) {
				...
				const l = Re(yield (0, S.select)());
				const a = Pe(yield (0, S.select)(), (0, T.ensureDefined)(n.parentId));
				const c = s && "after" === o;
				const u = Ye(yield (0, S.select)());
				const d = !c || (!r && e(u, n, o)) ? n : a;
				const h = (l.node && l.node.id !== d.id) || l.dropType !== o;
				u.map((e) => e.id).includes(d.id)
					? yield (0, S.put)({ type: le })
					: h &&
					  e(u, d, o) &&
					  (yield (0, S.put)(
							((e, t, n) => ({ type: se, node: e, dropType: t, boundBox: n }))(
								d,
								o,
								i,
							),
			...
			function* lt(e) {
				yield (0, S.throttle)(0, ie, st, e);
			}
			function* at(e) {
				for (;;) {
					yield (0, S.take)(ee);
					const t = Ye(yield (0, S.select)());
					const { node: n, dropType: o } = Re(yield (0, S.select)());
					if (n && o) {
						const r = new CustomEvent("tree-node-drop", {
							detail: { nodes: t, target: n.id, type: o },
						});
						if ((e?.(r), !r.defaultPrevented)) {
							const e = Ue(yield (0, S.select)());
							yield (0, S.put)(Te(e, n.id, o));
						}
					}
				}
			}
			...
			function ut(e, t, n, o) {
				...
				while (
					...
					(Math.abs(s) < r &&
						(l = i).level > 1 &&
						!He(e, (0, T.ensureDefined)(l.parentId)))
				)
			...
			function* dt(e = {}) {
				...
				for (
					t && c.push((0, S.fork)(t)),
						r && c.push((0, S.fork)(ct, r)),
						a && c.push((0, S.fork)(nt, a));
					;
				) {
					l && (yield (0, S.call)(tt, l));
					const e = yield (0, S.all)(c);
					yield (0, S.take)(Q);
					for (const t of e) yield (0, S.cancel)(t);
				}
			}
			const ht = n(91622);
			const gt = n(1722);
			const mt = (0, l.getLogger)("Platform.GUI.ObjectTree.CallApi");
			const pt = { ids: [], lastFocusedNodeId: void 0, isMultiSelecting: !1 };
			const ft = { node: void 0, dropType: void 0, boundBox: void 0 };
			const vt = (0, ht.combineReducers)({
				nodes: (e, t) => {
					switch (t.type) {
						case Y:
							return t.nodes;
						case $: {
							...
							for (const e of n) {
								...
								if (r.hasOwnProperty(t)) {
									!(0, gt.deepEquals)(r[t].children, e.children)[0] &&
						...
						case pe: {
							...
							const i = (0, T.ensureDefined)(e[o].parentId);
							const s = e[i];
							const l = {};
							for (const t of n) {
								const n = e[t];
				...
				disabled: (e, t) => (t.type === me ? [...t.ids] : e),
				scrollToId: (e, t) =>
					t.type === de ? (null === t.nodeId ? null : { id: t.nodeId }) : e,
			});
			const bt = n(40933);
			const yt = n(20037);
			const _t = n(49483);
			...
			const It = { [C.Modifiers.Mod]: 1, [C.Modifiers.Shift]: 2 };
			const Mt = n(69533);
			const kt = n(75564);
			const Dt = () => {};
				...
				constructor() {
					super(...arguments),
						...
						(this._handleRef = (e) => {
							...
							(0, T.ensureDefined)(n)(this._ref),
								(0, T.ensureDefined)(t)(this._ref),
								(0, T.ensureDefined)(o)((0, wt.getEmptyImage)(), {
						...
						(this._handleTouchStart = (e) => {
							const t = (e, t) => {
									...
									const r = Array.from(t.touches);
									const i = Array.from(t.targetTouches);
			...
			const Lt = (e) => {
					const {
							...
							isLastListItem: m,
							nodeRenderer: p,
							isChildOfSelected: f = !1,
						} = e;
					const { size: v, smallSizeTreeNodeAction: b } = (0, o.useContext)(Et);
					const y = (0, o.useRef)(null);
					const _ = (0, Ct.createSafeMulticastEventHandler)(
							(e) => (y.current = e),
							h,
						);
					let [S, w] = (0, Tt.useHover)();
					return (
						(_t.CheckMobile.any() || _t.CheckMobile.isIPad()) &&
							((S = n), (w = { onMouseOut: Dt, onMouseOver: Dt })),
						o.createElement(
							"div",
							{
								className: E(
								...
								onClick:
									1 === v && 0 === b
										...
										: (e) => {
												...
												const o = It[(0, C.modifiersFromEvent)(e)] || 0;
												!l && s && s(t, !n, o);
												c && 0 === o && c(e, t);
										  },
								onContextMenu: T,
			...
			function zt(e, t) {
				...
				let i = !1;
				let s = o.parentId;
				while (s && !i) (i = We(e, s)), (s = Pe(e, s).parentId);
				return {
					...o,
					isSelected: r,
					isChildOfSelected: i,
			...
			const At = (0, H.connect)(zt, jt, null, { context: xt })((e) => {
					const t = (0, o.useRef)(null);
					const [, n, r] = (0, St.useDrag)({
							type: "node",
							item: (t) => {
					...
					const [, i] = (0, bt.useDrop)({
							...
							hover: (n, o) => {
								...
								const l = s.bottom - s.top;
								const a = o.getClientOffset();
								if (a) {
									const t = a.y - s.top;
									let n;
									let o;
			...
			const Rt = (0, H.connect)(zt, jt, null, { context: xt })(Lt);
			const Ot = n(35749);
			const Bt = n(85783);
			const Ft = n(65718);
			function Pt(e) {
			...
			function Wt(e) {
				...
				const { x: o, y: r } = t;
				const i = n && t ? n.y - t.y : 0;
				const s = `translate(${o + (n && t ? n.x - t.x : 0)}px, ${r + i}px)`;
			...
			const Gt = (0, H.connect)((e) => ({ items: Xe(e) }), null, null, {
				context: xt,
			})((e) => {
				const {
					items: t,
			...
			function Ut(e) {
				return o.createElement(Gt, { ...e, ...(0, Bt.useDragLayer)(Vt) });
			}
			const Zt = n(3085);
			const Kt = n(33127);
			const Yt = o.forwardRef((e, t) => {
				const n = (0, o.useRef)(null);
				return (
					e.connectDropTarget(n),
					(0, o.useImperativeHandle)(
						t,
						() => ({ getNode: () => (0, T.ensureNotNull)(n.current) }),
						[],
					),
					o.createElement("div", {
						ref: n,
			...
			function $t(e) {
				...
				const [, n] = (0, bt.useDrop)({
						...
						hover: (n, o) => {
							...
							const l = e.getContainerElement().getBoundingClientRect();
							if ("first" === e.type) {
								const t = {
							...
							if ("last" === e.type) {
								...
								const o =
										t && 2 === n.level
											? (0, T.ensureDefined)(i.find((e) => e.id === n.parentId))
											: n;
								const a = {
										top: s.top - l.top,
										left: s.left - l.left,
				...
				return o.createElement(Yt, { ...e, connectDropTarget: n, ref: t });
			}
			const qt = o.createContext({ isOver: !1, transform: void 0 });
			const Jt = n(23490);
			function Qt(e) {
				const { dropType: t, boundBox: n } = e;
				const { top: o, bottom: r, left: i } = (0, T.ensureDefined)(n);
				return [i, "before" === t || "inside" === t ? o : r];
			}
			function Xt(e) {
				return { isDragging: e.isDragging() };
			}
			const en = (0, H.connect)(
				(e) => {
					const { boundBox: t, dropType: n, node: o } = Re(e);
				...
				return Pt(() => {
					...
					const l = {
							[Jt.dropTarget]: "inside" !== t,
							[Jt.dropTargetInside]: "inside" === t,
						};
					const { width: a, height: c } = n;
					const [u, d] = s(e);
					const h = `translate(${u}px, ${d}px)`;
			...
			function tn(e) {
				const { isDragging: t } = (0, Bt.useDragLayer)(Xt);
				return o.createElement(en, { ...e, isDragging: t });
			}
			const nn = o.forwardRef((e, t) => {
				const n = (0, o.useContext)(qt);
				return o.createElement(
					"div",
					{ ...e, ref: t },
					e.children,
					n.isOver && o.createElement(tn, { transform: n.transform }),
				);
			});
			const on = n(38223);
			const rn = n(76106);
			const sn = 38 + C.Modifiers.Shift;
			const ln = 40 + C.Modifiers.Shift;
			const an = o.forwardRef((e, t) => {
				const {
						navigationKeys: n,
						renderList: r,
						stopMultiSelect: i,
				...
				(0, o.useEffect)(() => {
					...
					(0, o.useEffect)(() => {
						const e = (e) => {
								[C.Modifiers.Mod, C.Modifiers.Shift].includes(
									(0, C.modifiersFromEvent)(e),
								) && s();
							};
						const t = (e) => {
								l &&
					...
					((e) => {
						(0, o.useEffect)(() => {
							if (_t.isEdge) {
								let t = null;
								const n = (0, T.ensureNotNull)(e.current);
								const o = (e) => {
				...
				const R = (0, o.useCallback)(() => (0, T.ensureNotNull)($.current), []);
				const O = (0, o.useCallback)(() => r, [r]);
				const B = (0, o.useMemo)(() => {
						const e = h ? Rt : At;
						const t = [];
						let n;
				...
				const P = (0, o.useCallback)((e) => {
						...
						const { index: n } = e;
						return (
							n === F.current.length - 1 &&
								((t = { ...t, bottom: 0, minHeight: t.height }),
								t.height = undefined),
							o.createElement("div", { style: t }, F.current[n].node)
						);
					}, []);
				...
				const H = (0, o.useCallback)(
						(e) => (0, T.ensure)(F.current[e].node.key),
						[],
					);
				const V = (0, o.useMemo)(
						() =>
							null === f
								? { index: -1 }
								: { index: F.current.findIndex((e) => e.node.key === f.id) },
						[f],
					);
				d(A);
				const [G, U, Z, K] = (0, Kt.useOverlayScroll)();
				const Y = (0, o.useRef)(null);
				(0, o.useEffect)(
					() => (0, T.ensureNotNull)(Y.current).resetAfterIndex(0, !0),
					[B],
				),
					(0, o.useEffect)(
						() => (0, T.ensureNotNull)(Y.current).scrollToItem(V.index),
						[V],
					);
				const $ = (0, o.useRef)(null);
				const q = (0, o.useMemo)(() => ({ isOver: D, transform: m }), [D, m]);
				const J = (0, o.useRef)(null);
				const Q = (0, o.useRef)({
						startScroll(e) {
							const t = () => {
								null !== Z.current &&
									((J.current = requestAnimationFrame(t)),
									Z.current.scrollBy({ top: e }));
							};
							this.stopScroll(), t();
						},
						stopScroll() {
							null !== J.current &&
								(cancelAnimationFrame(J.current), (J.current = null));
						},
						getListElement: () => Z.current,
					});
				return (
					(0, o.useImperativeHandle)(t, () => Q.current, []),
					(0, o.useEffect)(() => () => Q.current.stopScroll(), [D]),
					(0, o.useEffect)(() => {
						...
						o.createElement(
							"div",
							{
								...
								onKeyDown: (e) => {
									...
									if (
										e.defaultPrevented ||
										(0, Ot.isNativeUIInteraction)(t, e.target)
									)
										return;
									const o = (0, T.ensureDefined)(G.scrollPosTop);
									const r = (0, T.ensureDefined)(G.contentHeight);
									const i = (0, T.ensureDefined)(G.containerHeight);
									if (i) {
										const n = 0.875 * i;
										const s = o + i === r;
										switch (t) {
											case 35:
												s || (e.preventDefault(), X(r));
												break;
											case 36:
												0 !== o && (e.preventDefault(), X(0));
												break;
											case 33:
												0 !== o && (e.preventDefault(), X(Math.max(0, o - n)));
												break;
											case 34:
												s || (e.preventDefault(), X(Math.min(o + n, r)));
										}
									}
							...
							o.createElement(Ut, { dragPreviewRenderer: c, nodeRenderer: a }),
						),
					)
				);
				function X(e) {
			...
			const cn = (0, H.connect)(
					...
					const t = (0, o.useRef)(null);
					const [{ isOver: n }, r] = (0, bt.useDrop)({
							accept: "node",
							drop: (n, o) => {
								let r;
								("touch" === e.drag || _t.isFF) &&
			...
			function dn(e) {
				const {
						...
						lastSyncTimestampRef: g,
						scrollToId: m,
						...p
					} = e;
				const [f, v] = (0, o.useState)(null);
				return (
					(0, o.useEffect)(() => {
						const e = (0, W.default)();
						v(
							((e) => {
								const t = (0, ht.applyMiddleware)(e);
					...
					(0, o.useEffect)(
						() => (
							null !== f &&
								a &&
								(g && (g.current = performance.now()),
								f.dispatch(((e) => ({ type: $, nodes: e }))(a))),
							() => {}
						),
						[f, a],
					),
					...
					null === f
						? null
						: o.createElement(hn, { store: f, scrollToId: m, ...p })
				);
			}
			const hn = o.memo((e) => {
				const { store: t, scrollToId: n, ...r } = e;
				const i = "touch" === e.drag ? G.TouchBackend : V.HTML5Backend;
				return (
					(0, o.useEffect)(() => {
						let e;
						t.dispatch(
					...
					o.createElement(
						U.DndProvider,
						{ backend: i, options: un },
						o.createElement(
							H.Provider,
							{ store: t, context: xt },
							o.createElement(cn, { ...r }),
						),
					)
				);
			});
			...
			function pn(e) {
				return (0, W.eventChannel)((t) => {
					...
					return (
						...
						e.onGroupCreated().subscribe(n, (e) => t(Ne(e, !0))),
						e
							.selection()
							.onChange()
							.subscribe(n, (e) => t(Ce(e))),
						() => {
			...
			function* fn() {
				for (;;) yield (0, S.take)([ne, te]), gn("Select", "Arrow");
			}
			function* vn() {
				for (;;) {
					const { mode: e } = yield (0, S.take)(he);
					1 === e && gn("Multi select", "Ctrl"),
						2 === e && gn("Multi select", "Shift");
				}
			}
			function* bn(e) {
				for (;;) {
					yield (0, S.take)(ee);
					const { node: t, dropType: n } = Re(yield (0, S.select)());
					if (t) {
						const o = Ye(yield (0, S.select)());
						const r = o.map((t) => (0, T.ensureNotNull)(e.entity(t.id)));
						let i = "Drag";
			...
			function* yn(e) {
				yield (0, S.fork)(fn), yield (0, S.fork)(vn), yield (0, S.fork)(bn, e);
			}
			function* _n(e) {
				yield (0, S.fork)(yn, e);
				const t = yield (0, S.call)(pn, e);
				mt.logNormal("Opened object tree data source channel");
				try {
					for (;;) {
						const e = yield (0, S.take)(t);
						yield (0, S.put)(e);
					}
				} finally {
			...
			const Sn = o.createContext(null);
			const wn = n(21861);
			const Cn = n(898);
			const Tn = n(6909);
			const En = w.mobiletouch ? "touch" : "native";
			function In(e) {
				const {
						viewModel: t,
						showHeader: n = !0,
				...
				const [c, u] = (0, Cn.useDimensions)();
				const [d, h] = (0, o.useState)(null);
				const g = (0, o.useMemo)(() => ({ isTouch: w.touch, isDialog: i }), [i]);
				return o.createElement(
					Sn.Provider,
					{ value: g },
					o.createElement(
									...
									o.createElement(dn, {
										...
										onKeyDown: (e) => {
											if (13 === (0, C.hashFromEvent)(e)) {
												...
												const o = n.length > 0 ? t.entity(n[0]) : void 0;
			...
			const zn = n(77975);
			const jn = v.t(null, void 0, n(91073));
			const An = v.t(null, void 0, n(35038));
			const Rn = v.t(null, void 0, n(15101));
			const On = v.t(null, void 0, n(42284));
			const Bn = v.t(null, void 0, n(31971));
			const Fn = v.t(null, void 0, n(81428));
			const Pn = v.t(null, void 0, n(34596));
			const Wn = n(14787);
			const Hn = n(33765);
			const Vn = n(52870);
			const Gn = n(49756);
			...
			function Yn(e) {
				const { id: t } = e;
				const n = (0, o.useContext)(L);
				const { viewModel: r } = (0, T.ensureNotNull)(n);
				const i = r.entity(t);
				return null === i ? null : o.createElement($n, { ...e, entity: i });
			}
			function $n(e) {
				const {
						id: t,
				...
				const h = (0, o.useContext)(L);
				const { viewModel: g } = (0, T.ensureNotNull)(h);
				const m = (0, o.useContext)(Sn);
				const { size: p } = (0, o.useContext)(Et);
				const [f, b] = (0, o.useState)(!1);
				const y = (0, o.useRef)(null);
				const [_, S] = (0, o.useState)(u.title());
				const [w, I] = (0, o.useState)(u.getIcon());
				const [k, D] = (0, o.useState)(u.isLocked());
				const [N, x] = (0, o.useState)(u.isVisible());
				const [z, j] = (0, o.useState)(u.isActualInterval());
				const [A, R] = (0, o.useState)(u.getDrawingSyncState());
				const [O, B] = (0, o.useState)(!1);
				const [F, P] =
						((0, zn.useWatchedValueReadonly)({
				...
				(0, o.useEffect)(() => {
					const e = {};
					u.onLockChanged().subscribe(e, () => D(u.isLocked())),
						u.onVisibilityChanged().subscribe(e, () => x(u.isVisible()));
					const t = u.onTitleChanged();
					t?.subscribe(e, () => S(u.title())),
						u
							.onIsActualIntervalChange()
							.subscribe(e, () => j(u.isActualInterval())),
						u
							.onSyncStateChanged()
							.subscribe(e, () => R(u.getDrawingSyncState()));
					const n = u.onIconChanged ? u.onIconChanged() : void 0;
					return (
						n?.subscribe(e, () => I(u.getIcon())),
						() => {
					...
					(0, o.useEffect)(() => {
						f &&
							y.current &&
							(y.current.focus(), y.current.setSelectionRange(0, _.length));
					}, [f]),
					(0, o.useEffect)(() => {
						const e = {};
						return (
							g.hoveredObjectChanged().subscribe(e, X),
							() => {
				...
				if (c) {
					...
					e && (H["data-parent-name"] = e.title()),
						(H["data-type"] = u.hasChildren() ? "group" : "data-source");
				}
				const V = Dn.enabled("test_show_object_tree_debug")
						? `<${u.id()}> (${u.zOrder()}) ${u.title()}`
						: u.title();
				const G = a || O;
				const U = f && s;
				const Z = !!m && m.isTouch;
				const K = !!m && m.isDialog;
				const Y = z && N ? Un : Zn;
				const $ = u.hasChildren()
						? v.t(null, void 0, n(38207))
						: v.t(null, void 0, n(39781));
				let q = null;
				return (
					w &&
						w.type === kn.Svg &&
						(q = o.createElement(M.Icon, {
							icon: w.content || "",
							className: Kn.icon,
						})),
					o.createElement(
						"span",
						{
							className: E(
								...
								s && Kn.selected,
								r && Kn.offset,
								l && Kn.childOfSelected,
								O && !i && !s && !l && Kn.hover,
								K && !i && !s && !l && Kn.dialog,
							),
							onMouseDown: (e) => {
								f &&
									!(0, T.ensureNotNull)(y.current).contains(e.target) &&
									P(!0);
							},
							onClick:
								1 === p
									...
									o.createElement(xn, {
										...
										onClick: z
											...
											: (e) => {
													if (e.defaultPrevented) return;
													e.preventDefault(),
														g.openProperties(u, Wn.TabNames.visibility);
											  },
										title: (() => {
											if (!z) return $;
											return N ? Bn : Fn;
						...
						U &&
							o.createElement(Nn.InputControl, {
								value: _,
								onChange: (e) => {
								...
								onKeyDown: (e) => {
									27 === (0, C.hashFromEvent)(e)
										? (e.preventDefault(), S(u.title()), b(!1))
			...
			const qn = n(17742);
			class Jn extends o.PureComponent {
				constructor(e) {
					super(e),
						(this._isMounted = !1),
						...
						(this._matchMedia = window.matchMedia(
							y.DialogBreakpoints.TabletSmall,
						)),
						(this.state = {
							showDrawer: !1,
							showDialog: !1,
			...
			class io {
				constructor(e) {
					(this._onChange = new to.Delegate()),
						(this._recalculate = () => {
							const e = this._groupModel
									.groups()
									.map((e) => oo(e.id, e.instanceId()));
						...
						(this._model = e),
						(this._selectionApi = new no.SelectionApi(this._model)),
				...
				set(e) {
					...
					this._selectionApi.set(t.map((e) => ro(e).persistentId)),
						(this._selected = n),
						this._onChange.fire(this._selected);
				}
				canBeAddedToSelection(e) {
				...
				buildTree() {
					...
					for (const t of this._controller.model().panes()) {
						...
						for (const n of this._groupModel.groups()) {
							const o = oo(n.id, n.instanceId());
							const r = (0, T.ensureNotNull)(this._facade.getObjectById(o));
							if (r.pane() === t) {
								const o = [...n.lineTools()]
									.sort((e, t) => (e.zorder() > t.zorder() ? -1 : 1))
									.map((e) => oo(e.id(), e.instanceId()));
								(e[r.id()] = lo(r.id(), 1, t.id(), o)),
									e[t.id()].children.push(r.id());
								for (const t of o) e[t] = lo(t, 2, r.id());
							}
						}
						for (const o of n) {
							const n = oo(o.id(), o.instanceId());
							e[n] || ((e[n] = lo(n, 1, t.id())), e[t.id()].children.push(n));
						}
						e[t.id()].children.sort((e, t) => {
							const n = (0, T.ensureNotNull)(this._facade.getObjectById(e));
							const o = (0, T.ensureNotNull)(this._facade.getObjectById(t));
							return (
								(0, T.ensureNotNull)(o.zOrder()) -
								(0, T.ensureNotNull)(n.zOrder())
							);
						});
					}
			...
			const bo = n(57674);
			const yo = n(37591);
			const _o = new ao.TranslatedString(
					"show {title}",
					v.t(null, void 0, n(87358)),
				);
			const So = new ao.TranslatedString(
					"hide {title}",
					v.t(null, void 0, n(70301)),
				);
			const wo = new ao.TranslatedString(
					"lock {title}",
					v.t(null, void 0, n(50193)),
				);
			const Co = new ao.TranslatedString(
					"unlock {title}",
					v.t(null, void 0, n(92421)),
				);
			const To = new ao.TranslatedString(
					"change {sourceTitle} title to {newSourceTitle}",
					v.t(null, void 0, n(40001)),
				);
			const Eo = new ao.TranslatedString(
					"insert source(s) after",
					v.t(null, void 0, n(8343)),
				);
			const Io = !1;
			function Mo(e, t) {
				return t.every(
			...
			function ko(e) {
				return e instanceof ho.DataSource && e.showInObjectTree()
					? oo(e.id(), e.instanceId())
					: null;
			}
			function Do(e) {
				return new ao.TranslatedString(
					e.name(),
					e.title(yo.TitleDisplayTarget.DataWindow),
				);
			}
			const No = new to.Delegate();
			class Lo {
				constructor(e, t) {
					(this._syncStateChanged = new to.Delegate()),
						(this._updateSyncState = () => {
							this._syncStateChanged.fire(
								(0, T.ensureNotNull)(this.getDrawingSyncState()),
							);
						}),
						(this._undoModel = e),
						(this._dataSource = t),
				...
				title() {
					...
					return (0, co.isLineTool)(e)
						? e.properties().title.value() || e.translatedType()
						: (0, go.isSeries)(e) && this._undoModel.mainSeries() === e
						  ? e.symbolTitle(
									yo.TitleDisplayTarget.DataWindow,
									void 0,
									void 0,
									(0, _t.onWidget)() ? "exchange" : "listed_exchange",
							  )
						  : e.title(yo.TitleDisplayTarget.DataWindow);
				}
				gaLabel() {
					return (0, uo.isStudy)(this._dataSource)
						? "Study"
						: (0, co.isLineTool)(this._dataSource)
						  ? "Drawing"
						  : "Symbol";
				...
				getIcon() {
					const e = c;
					const t = this._dataSource.getSourceIcon();
					const n = (0, uo.isStudyStrategy)(this._dataSource);
					let o = { type: kn.Svg, content: n ? fo : vo };
					if (e && t)
						if ("loadSvg" === t.type) {
							const [n, r] = t.svgId.split(".");
							const i = "linetool" === n ? e.linetool[r] : e.series[Number(r)];
							o = { type: kn.Svg, content: i || vo };
						} else
							"svgContent" === t.type &&
				...
				setVisible(e) {
					const t = (e ? _o : So).format({ title: Do(this._dataSource) });
				...
				detachFromParent() {
					if ((0, co.isLineTool)(this._dataSource)) {
						...
						const t = this._undoModel.lineToolsGroupController();
						const n = e.lineToolsGroupModel().groupForLineTool(this._dataSource);
				...
				_insertSources(e, t) {
					...
					const o = this._undoModel.lineToolsGroupController();
					this._undoModel.beginUndoMacro(Eo);
					const r = () => {
							e.forEach((e) => e.detachFromParent());
						};
					const i = e.reduce((e, t) => t.addSourcesToArray(e), []);
					if ((0, co.isLineTool)(this._dataSource)) {
						const t = n
							.lineToolsGroupModel()
							.groupForLineTool(this._dataSource);
						null !== t
							? ((0, T.assert)(!e.some((e) => e.hasChildren())),
							  i.forEach((e) => {
									(0, co.isLineTool)(e) &&
			...
			class xo {
				constructor(e, t) {
					(this._onTitleChanged = new to.Delegate()),
						(this._onVisibilityChanged = new to.Delegate()),
						(this._onLockChanged = new to.Delegate()),
						(this._onIsActualIntervalChanged = new to.Delegate()),
						(this._syncStateChanged = new to.Delegate()),
						(this._linkKeyChangedBound = this._linkKeyChanged.bind(this)),
						(this._undoModel = e),
						(this._group = t),
						(this._lineTools = t.lineTools()),
						(this._paneId = (0, T.ensureNotNull)(
				...
				childrenIds() {
					...
					return (
						...
						new Set(e.map((e) => oo(e.id(), e.instanceId())))
					);
				}
				hasChildren() {
					return !0;
			...
			class zo {
				constructor(e) {
					(this._hoveredObjectChanged = new to.Delegate()),
				...
				getObjectById(e) {
					if (this._entitiesCache.has(e))
						return (0, T.ensureDefined)(this._entitiesCache.get(e));
				...
				canBeGroupped(e) {
					...
					if (
						...
						return !1;
					const n = this._undoModel.model();
					const o = t.map((e) => n.paneForSource(e));
					return !(new Set(o).size > 1);
				}
				contextMenuActions(e, t, n) {
					const o = new mo.ActionsProvider(e, n);
					const r = [];
					return (
				...
				_createObjectById(e) {
					const t = ro(e).persistentId;
					const n = this._undoModel.model();
					const o = n.dataSourceForId(t);
			...
			const Ho = n(33055);
			const Vo = n(35149);
			const Go = (0, l.getLogger)("Platform.GUI.ObjectTree");
			const Uo = new ao.TranslatedString(
					"move objects",
					v.t(null, void 0, n(40566)),
				);
			const Zo = new ao.TranslatedString(
					"lock objects",
					v.t(null, void 0, n(68163)),
				);
			const Ko = new ao.TranslatedString(
					"unlock objects",
					v.t(null, void 0, n(66824)),
				);
			const Yo = new ao.TranslatedString(
					"show objects",
					v.t(null, void 0, n(63549)),
				);
			const $o = new ao.TranslatedString(
					"hide objects",
					v.t(null, void 0, n(28506)),
				);
			const qo = new ao.TranslatedString(
					"remove objects",
					v.t(null, void 0, n(57428)),
				);
			class Jo {
				constructor(e) {
					(this._nodes = {}),
						(this._onChange = new to.Delegate()),
						(this._onGroupCreated = new to.Delegate()),
						(this._subscriptions = []),
						...
						(this._isContextMenuOpened = new Oo.WatchedValue(!1)),
						...
						(this._init = () => {
							...
							e.hasModel() &&
								...
								(this._selection = new io(this._model)),
								this._update());
						}),
						(this._update = () => {
							null === this._timeout &&
						...
						(this._ensuredEntity = (e) =>
							(0, T.ensureNotNull)(this._getEntityById(e))),
						(this._chart = e),
						this._init();
				}
				destroy() {
				...
				insertSelection(e, t) {
					...
					const o = this.selection().selected().map(this._ensuredEntity);
					const [r, i] = this._normalizeTargetAndDropType(e, t);
					this._controller.withMacro(Uo, () => {
						switch (i) {
							case "before":
								n.insertBefore(o, r);
								break;
				...
				setIsLocked(e, t) {
					...
					const o = n.every((e) => e.doNotAffectChartInvalidation());
					const r = t ? Zo : Ko;
				...
				isSelectionDropable(e, t) {
					...
					const [o, r] = this._normalizeTargetAndDropType(e, t);
					switch (r) {
						case "after":
				...
				openProperties(e, t) {
					const n = this._model.dataSourceForId(ro(e.id()).persistentId);
				...
				canSelectionBeUnmerged() {
					...
					return (
						1 === e.length &&
						this.canNodeWithIdBeUnmerged(ro(e[0].id()).persistentId)
					);
				}
				...
				copySelection() {
					...
					const t = e.map((e) =>
							(0, T.ensureNotNull)(
								this._model.dataSourceForId(ro(e.id()).persistentId),
							),
						);
					this._chart
						.value()
				...
				cloneSelection() {
					...
					t.every(co.isLineTool) &&
						(this._controller.cloneLineTools([...t], !1), gn("Clone", mn(e)));
				}
				rename(e, t) {
				...
				async openContextMenu(e, t, n) {
					...
					if (i.length > 0) {
						...
						const t = ro(e.id()).persistentId;
						const r = this._model.dataSourceForId(t);
						const s = r instanceof go.Series;
						const l = 0 !== e.childrenIds().size;
						let a;
						(a = s
							? {
							...
							Ao.ContextMenuManager.showMenu(
								i,
								n,
				...
				getNextNodeIdAfterRemove(e) {
					...
					const o = ro(e).persistentId;
					const r = n.find((t) => t.id === e);
					const i = this.entity(e);
					if (!(r?.parentId && i && i.canBeRemoved())) return null;
					if (
						...
						const t = this._takeNextOrPrevElement(e, r.parentId);
						return (0, T.ensureDefined)(n.find((e) => e.id === t)).children[0];
					}
					const s = (0, T.ensureDefined)(
				...
				_getRenameAction(e) {
					return new Ro.Action({
						...
						icon: Ho,
						onExecute: () => {
							e(), gn("Context menu rename", mn(this._objects));
						},
					});
				}
				_getActionsForGroupItem(e, t, n) {
					...
					1 === this._objects.length &&
						r.unshift(this._getRenameAction(t), new Ro.Separator()),
						n && r.unshift(this._getGroupAction(), new Ro.Separator());
					const i = (0, mo.createSyncDrawingActions)(
						this._chart.value(),
						o.filter(co.isLineTool),
					);
					i.length && (i.shift(), i.push(new Ro.Separator()), r.push(...i));
				...
				_unmergeSelection(e) {
					...
					const n = t[0];
					const o = (0, T.ensureNotNull)(
							this._model.dataSourceForId(ro(n.id()).persistentId),
						);
				...
				_recalculateTree() {
					const e = new so(this._controller, this._facade);
			...
			const Qo = n(85067);
			class Xo extends Qo.DialogRenderer {
				constructor() {
					super(),
						(this._handleClose = () => {
					...
					const e = (0, Xn.service)(eo.CHART_WIDGET_COLLECTION_SERVICE);
					(this._activeChartWidget = e.activeChartWidget.value()),
						(this._viewModel = new Jo(e.activeChartWidget));
				}
				hide() {
					this._handleClose();
				}
		...
		77975: (e, t, n) => {
			...
			const r = (e, t = !1) => {
				...
				const r = "defaultValue" in e ? e.defaultValue : e.watchedValue.value();
				const [i, s] = (0, o.useState)(n ? n.value() : r);
				return (
		...
		81261: (e, t, n) => {
			...
			function a(e) {
				...
				const l = h(e.currentTarget).sort(o.navigationOrderComparator);
				...
				if (-1 === c) return;
				const m = g(a);
				const p = m.indexOf(document.activeElement);
				const f = -1 !== p;
				const v = (e) => {
				...
				switch (t) {
					case 37:
						if (!m.length) return;
						e.preventDefault(),
							v(0 === p ? l[c] : f ? u(m, p, -1) : m[m.length - 1]);
						break;
					case 39:
						if (!m.length) return;
						e.preventDefault(),
							p === m.length - 1 ? v(l[c]) : v(f ? u(m, p, 1) : m[0]);
						break;
					case 38: {
						e.preventDefault();
						const t = u(l, c, -1);
		...
		48889: (e, t, n) => {
			...
			const l = (0, o.forwardRef)((e, t) => {
				const { tooltip: n, ...l } = e;
				const [a, c] = (0, r.useRovingTabindexElement)(t);
		...
		50298: (e, t, n) => {
			...
			const u = (0, o.forwardRef)((e, t) => {
				...
				const [h, g] = (0, s.useRovingTabindexElement)(null);
				const m = (0, r.useFunctionalRefObject)(u);
				return (
		...
		54079: (e, t, n) => {
			...
			const d = (0, o.forwardRef)((e, t) => {
				...
				const p = l.PLATFORM_ACCESSIBILITY_ENABLED
						? { role: "toolbar", "aria-orientation": d }
						: {};
				const f = (0, c.useFunctionalRefObject)(t);
				return (
					(0, o.useLayoutEffect)(() => {
					...
					o.createElement("div", {
						...
						onKeyDown: (0, i.createSafeMulticastEventHandler)((e) => {
							...
							const o = (0, l.queryFocusableElements)(n).sort(
									l.navigationOrderComparator,
								);
