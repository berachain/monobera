				...
				async function d(t) {
					...
					const n = (() => {
						...
						const r = t.name
							...
							: o.t(null, { replace: { studyShortDescription: u } }, i(42917));
						const n = t.name
							? o.t(
									null,
									{
							...
							: o.t(null, { replace: { studyShortDescription: u } }, i(6083));
						return e ? r : n;
					})();
					const s = e ? t.id : void 0;
					const p = e ? void 0 : t.id;
					await S(t, r, n, s, p);
				}
							...
							if (void 0 !== o)
								if (void 0 !== s)
									if (i.has(o)) {
										...
										const p = { id: o, groupType: "group", children: [r] };
										const u = new Map();
