	...
	[5093],
	{
		...
		967: (e, t, s) => {
			...
			const a = {
				...
				[l.WeekDays.WEDNESDAY]: i.t(null, { context: "day_of_week" }, s(26230)),
				[l.WeekDays.THURSDAY]: i.t(null, { context: "day_of_week" }, s(24793)),
				[l.WeekDays.FRIDAY]: i.t(null, { context: "day_of_week" }, s(19801)),
				[l.WeekDays.SATURDAY]: i.t(null, { context: "day_of_week" }, s(63331)),
			};
		},
		76266: (e, t, s) => {
			const i = s(11417).TVLocalStorage;
			const l = s(57898).Delegate;
			s(49483);
			const o = new l();
			(TradingView.FeatureToggle = {
				...
				onFeaturesStateChanged: () => o,
			}),
				(TradingView.isFeatureEnabled = ((e) => {
					const t = "featuretoggle_seed";
					function s(e) {
						try {
							const s = undefined(
								e +
					...
					return (t) =>
						!(
							...
							!((e) => {
								...
								const i = new RegExp(`broker_${s}_dev`, "g");
								const l = new RegExp(`hide_${s}_on_ios`, "g");
								const o = new RegExp(`hide_${s}_on_android`, "g");
								const a = new RegExp(`hide_${s}_on_mobile_web`, "g");
								return (
									-1 === t.indexOf(e) &&
		...
		93251: (e, t, s) => {
			...
			function o(e, t = i.LogoSize.Medium) {
				const s = e.logoid;
				const o = e["base-currency-logoid"];
				const a = e["currency-logoid"];
				const n = s && l.getSymbolLogoUrl(s, t);
				if (n) return [n];
				const r = o && l.getSymbolLogoUrl(o, t);
				const d = a && l.getSymbolLogoUrl(a, t);
		...
		77975: (e, t, s) => {
			...
			const l = (e, t = !1) => {
				...
				const l = "defaultValue" in e ? e.defaultValue : e.watchedValue.value();
				const [o, a] = (0, i.useState)(s ? s.value() : l);
				return (
		...
		33283: (e, t, s) => {
			...
			const E = (0, c.humanReadableModifiers)(c.Modifiers.Shift, !1);
			const V = (0, c.humanReadableModifiers)(c.Modifiers.Mod, !1);
			const k = (0, u.hotKeySerialize)({ keys: [C, "R"], text: "{0} + {1}" });
			const A = (0, u.hotKeySerialize)({
				keys: [C, "Click", C, "Enter"],
				text: "{0} + {1}, {2} + {3}",
			});
			const L = (0, u.hotKeySerialize)({ keys: [y], text: "{0}" });
			const W = (0, u.hotKeySerialize)({ keys: [S], text: "{0}" });
			const T = (0, u.hotKeySerialize)({ keys: [V, f], text: "{0} + {1}" });
			const x = (0, u.hotKeySerialize)({ keys: [V, M], text: "{0} + {1}" });
			const H = (0, u.hotKeySerialize)({
				keys: [C, E, S],
				text: "{0} + {1} + {2}",
			});
			const D = l.t(null, void 0, s(47602));
			const P = l.t(null, void 0, s(61311));
			const B = l.t(null, void 0, s(56470));
			const I = l.t(null, void 0, s(48293));
			const z = l.t(null, void 0, s(40653));
			const N = l.t(null, void 0, s(35809));
			const O = l.t(null, void 0, s(34301));
			const F = l.t(null, void 0, s(26721));
			const R = `<div class="control-bar-wrapper">\n\t<div class="control-bar control-bar--hidden">\n\t\t<div class="control-bar__group js-btn-group js-btn-group-zoom">\n\t\t\t<div class="control-bar__btn control-bar__btn--zoom-out apply-common-tooltip" title="${D}" data-tooltip-hotkey="${x}">\n\t\t\t\t${_}\n\t\t\t</div>\n\t\t\t<div class="control-bar__btn control-bar__btn--zoom-in apply-common-tooltip" title="${P}" data-tooltip-hotkey="${T}">\n\t\t\t\t${m}\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-bar__group js-btn-group js-btn-group-maximize">\n\t\t\t<div class="control-bar__btn control-bar__btn--maximize apply-common-tooltip" title="${B}" data-tooltip-hotkey="${A}">\n\t\t\t\t${v}\n\t\t\t</div>\n\t\t\t<div class="control-bar__btn control-bar__btn--minimize js-hidden apply-common-tooltip" title="${I}" data-tooltip-hotkey="${A}">\n\t\t\t\t${b}\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-bar__group js-btn-group js-btn-group-scroll">\n\t\t\t<div class="control-bar__btn control-bar__btn--move-left apply-common-tooltip" title="${z}" data-tooltip-hotkey="${L}">\n\t\t\t\t${p}\n\t\t\t</div>\n\t\t\t<div class="control-bar__btn control-bar__btn--move-right apply-common-tooltip" title="${N}" data-tooltip-hotkey="${W}">\n\t\t\t\t${p}\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-bar__group js-btn-group js-btn-group-reset-scale">\n\t\t\t<div class="control-bar__btn control-bar__btn--turn-button control-bar__btn--btn-hidden apply-common-tooltip js-btn-reset" title="${O}" data-tooltip-hotkey="${k}">\n\t\t\t\t${g}\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>`;
			const U = `<div class="control-bar control-bar__btn control-bar__btn--back-present control-bar__btn--btn-hidden apply-common-tooltip" title="${F}" data-tooltip-hotkey="${H}">\n\t${w}\n</div>`;
			const G = h.CheckMobile.any();
			const $ = "control-bar__btn--btn-hidden";
			const j = {
				zoomInOut: !0,
				maximize: !0,
				scrollLeftRight: !0,
			...
			class Y {
				...
				_initHandlers() {
					...
					const t = o.mobiletouch ? ["touchend"] : ["mouseup", "mouseout"];
				...
				_visibilityMouseHandler(e) {
					...
					if ("mousemove" === e.type) {
						...
						const i = 100 - this._bottomMargin();
						t =
				...
				_updateBtnGroupVisibility() {
					...
					const t = (e + this._rightPriceScaleWidth) / 2;
		...
		85109: (e, t, s) => {
			...
			class f {
				...
				_renderTitle() {
					...
					for (let s = 0; s < this._titlesSpawns.length; s++) {
						const i =
							null !== (e = this._titlesSpawns[s].title.value()) && void 0 !== e
								? e
								: "";
						const l = this._titlesSpawns[s].class;
			...
			const G = B.t(null, void 0, s(28705));
			const $ = B.t(null, void 0, s(51072));
			class j {
				constructor(e, t, s) {
					(this._el = null),
			...
			const X = d.enabled("object_tree_legend_mode");
			class J {
				constructor(e, t) {
				...
				_setCustomBg() {
					...
					const t = this._themedColor.value();
					const s = this._backgroundTransparency.value();
					let i = "";
					if (e) {
			...
			const re = new te.TranslatedString(
				"hide {title}",
				B.t(null, void 0, s(70301)),
			);
			const de = B.t(null, void 0, s(81428));
			const ue = B.t(null, void 0, s(31971));
			class he {
			...
			class ve {
				...
				_quoteSymbolChanged() {
					...
					const l = (0, o.ensureNotNull)(this.symbol());
					const a = ge.get(l);
					(this._quoteDataForLogos = {
						logoid:
			...
			const Ee = B.t(null, void 0, s(93666));
			const Ve = B.t(null, void 0, s(8209));
			const ke = d.enabled("show_hide_button_in_legend");
			const Ae = d.enabled("hide_resolution_in_legend");
			class Le extends he {
				constructor(e, t, s, i, l) {
					super(e, t, s, i, l),
						(this._titles = {
				...
				_updateValues() {
					...
					const t = this._values.value();
					const s = e.marketTitle();
					const i = e.marketTitle().length > 0;
					if (0 === t.length) {
						const t = {
			...
			const Re = B.t(null, void 0, s(66324));
			const Ue = B.t(null, void 0, s(34596));
			const Ge = B.t(null, void 0, s(41610));
			const $e =
			...
			const Ye = d.enabled("property_pages");
			const qe = d.enabled("format_button_in_legend");
			const Ze = d.enabled("delete_button_in_legend");
			class Xe extends he {
				constructor(e, t, s, i, l) {
					super(e, t, s, i, l),
						(this._titles = {
					...
					const o = this._model
						...
						.paneProperties.childs()
						.legendProperties.childs();
					const n = [o.showSeriesTitle, o.showStudyTitles];
					for (const e of n)
						e.subscribe(this, () => {
							this._isTitleHidden.setValue(this._getTitleHiddenValue());
						});
			...
			const ot = new te.TranslatedString(
				"change open market status visibility",
				B.t(null, void 0, s(18644)),
			);
			const at = new te.TranslatedString(
				"change OHLC values visibility",
				B.t(null, void 0, s(57889)),
			);
			const nt = new te.TranslatedString(
				"change bar change visibility",
				B.t(null, void 0, s(45110)),
			);
			const rt = new te.TranslatedString(
				"change indicator titles visibility",
				B.t(null, void 0, s(31325)),
			);
			const dt = new te.TranslatedString(
				"change indicator arguments visibility",
				B.t(null, void 0, s(96162)),
			);
			const ut = new te.TranslatedString(
				"change indicator values visibility",
				B.t(null, void 0, s(99774)),
			);
			const ht = new te.TranslatedString(
				"change volume values visibility",
				B.t(null, void 0, s(9455)),
			);
			const ct = new te.TranslatedString(
				"change symbol field visibility",
				B.t(null, void 0, s(6091)),
			);
			const _t = B.t(null, void 0, s(63143));
			const pt = B.t(null, void 0, s(75991));
			const mt = B.t(null, void 0, s(99487));
			const gt = B.t(null, void 0, s(22519));
			const vt = B.t(null, void 0, s(1111));
			const bt = B.t(null, void 0, s(26315));
			const wt = B.t(null, void 0, s(26935));
			const yt = B.t(null, void 0, s(84098));
			const St = B.t(null, void 0, s(46041));
			const ft = (0, tt.appendEllipsis)(B.t(null, void 0, s(89517)));
			const Mt = d.enabled("symbol_info_price_source");
			const Ct = s(78071);
			const Et = s(38618);
			const Vt = s(61146);
			const kt = s(967);
			...
			function Pt(e) {
				while (e > Lt.minutesPerDay) e -= Lt.minutesPerDay;
				const t = e % 60;
				const s = (e - t) / 60;
				return `${(0, Vt.numberToStringWithLeadingZero)(s, 2)}:${(0,
				Vt.numberToStringWithLeadingZero)(t, 2)}`;
			}
			const Bt = {
				[At.WeekDays.MONDAY]: {
			...
			function Nt(e) {
				const t = e.start();
				const s = e.length();
				const i = e.sessionStartDayOfWeek();
				const l = e.sessionEndDayOfWeek();
				const o = Pt(t);
				const a = Pt(t + s);
			...
			function Ft(e, t, s) {
				for (const i of t) {
					...
					for (let l = 0; l < n.length; l++) {
						const o = n[l];
						const [a, r] = o;
						const d = a / Lt.minutesPerDay;
						const u = (0, Ct.lowerbound)(
							e[t].entries,
							d,
							(e, t) => e.start.value < t,
						);
			...
			class Rt {
				...
				_updateEntriesBySubSessions(e) {
					...
					let s = this._createSubSessionSpecs(e);
					const i =
						(l =
							(null === (t = this._todayInExchangeTime) || void 0 === t
								? void 0
								: t.getUTCDay()) || new Date().getDay()) < At.WeekDays.SATURDAY
							? l + 1
							: At.WeekDays.SUNDAY;
					let l;
			...
			const Jt = B.t(null, void 0, s(80227));
			function Qt(e) {
				const { segment: t, forceStart: s, forceEnd: i } = e;
				const l = t.end.value - t.start.value;
				const o = l < 0.03;
				const a = {
			...
			function Kt(e) {
				...
				const i = C(jt.sessionDay, t.isActive && jt.active);
			...
			function es(e) {
				...
				const o = t[l];
				const a = o.entries.filter(
					(e) => e.start.value <= s && e.end.value >= s,
				)[0];
				...
				const d = 100 * (2 === i.length ? i[1].value - i[0].value : 0);
				const u = C(
					d > 12 && jt.timeMarkSegmentAlignByEnds,
					jt.timeMarkSegment,
				);
				return Ut.createElement(
					"div",
				...
				renderer(e, t) {
					...
					return (
						...
						: ((e) => {
								...
								const o = (0, Gt.useWatchedValueReadonly)({
									watchedValue: e.sessionDays,
								});
								const a = Object.values(o).filter((e) => e.isActive)[0];
								const n = C(s, jt.wrapper);
								return Ut.createElement(
									"div",
									{ key: t, className: n },
									Ut.createElement(
			...
			const ws = ss.colorsPalette["color-eod-mode"];
			const ys = ss.colorsPalette["color-notaccurate-mode"];
			const Ss =
			...
			const fs = B.t(null, void 0, s(59315));
			const Ms = B.t(null, void 0, s(15815));
			const Cs = B.t(null, void 0, s(45e3));
			const Es = B.t(null, void 0, s(7435));
			const Vs =
			...
			const ks = (0, is.htmlEscape)(B.t(null, void 0, s(1084)));
			const As = (0, is.htmlEscape)(B.t(null, void 0, s(52984)));
			const Ls = (0, is.htmlEscape)(B.t(null, void 0, s(89022)));
			const Ws = (0, is.htmlEscape)(B.t(null, void 0, s(52916)));
			const Ts = (0, is.htmlEscape)(B.t(null, void 0, s(49321)));
			const xs = (0, is.htmlEscape)(B.t(null, void 0, s(25978)));
			const Hs = (0, is.htmlEscape)(B.t(null, void 0, s(28412)));
			const Ds = (0, is.htmlEscape)(B.t(null, void 0, s(91459)));
			const Ps = B.t(null, void 0, s(6667));
			const Bs =
				(B.t(
					null,
					{
			...
			const Is = B.t(null, void 0, s(29512));
			...
			class Js extends os {
				...
				async _getHtmls() {
					...
					const l = {};
					const o = this._model.symbolName();
					let a = null;
					let n = null;
					try {
						...
						js.logError(
							`Can't get exchange description, reason: ${(0, $s.errorToString)(
								e,
							)}`,
						);
					}
			...
			class ci extends os {
				...
				async _updateFullTooltip() {
					...
					const t = this._dataProblems.value();
				...
				_updateStatus(e) {
					...
					const i =
						null !==
							(s = null === (t = e[0]) || void 0 === t ? void 0 : t.severity) &&
						void 0 !== s
							? s
							: null;
					const l = this._status.value() !== i;
					this._status.setValue(i),
						this._isDataProblemCritical.setValue(((e) => "high" === e)(i)),
			...
			const vi = B.t(null, void 0, s(73717));
			const bi = new Map([
				[
					!0,
					new Map([
			...
			class Ei {
				...
				destroy() {
					this._visible.destroy(),
						this._icon.destroy(),
						this._isBlinking?.destroy();
				}
				onClick() {
					this._turnOffBlinking?.();
				}
				visible() {
					return this._visible;
				}
			...
			class ki {
				...
				_onClick(e) {
					...
					const l = { x: i.left - s, y: i.bottom + 4 };
			...
			const Ni = B.t(null, void 0, s(56042));
			const Oi = B.t(null, void 0, s(29985));
			const Fi = B.t(null, void 0, s(95814));
			const Ri = B.t(null, void 0, s(88958));
			const Ui = B.t(null, void 0, s(69419));
			const Gi = B.t(null, void 0, s(1653));
			const $i = B.t(null, void 0, s(40519));
			const ji = B.t(null, void 0, s(57048));
			const Yi = B.t(null, void 0, s(56086));
			const qi = B.t(null, void 0, s(39348));
			const Zi = B.t(null, void 0, s(7827));
			const Xi = B.t(null, void 0, s(19830));
			const Ji = B.t(null, void 0, s(35701));
			const Qi = B.t(null, void 0, s(98105));
			const Ki = B.t(null, void 0, s(50634));
			const el = B.t(null, void 0, s(74537));
			const tl = new Map([
				[
					"market",
					new Map([
			...
			function dl(e) {
				...
				const i = Math.floor((e - 86400 * t) / 3600);
				const l = Math.floor((e - 86400 * t - 3600 * i) / 60);
				return 0 === t && 0 === i && 0 === l
					? qi
					: t > 0
					  ? Zi.format({
			...
			const ul = {
				...
				pre_market: (e) => Ji.format({ remainingTime: dl(e.remainingSeconds) }),
				post_market: (e) =>
				...
				_recreateWidgets() {
					...
					if (
						...
						if (null === this._customStatusViewModel) {
							...
							const i = { visible: s, model: this._customStatusViewModel };
				...
				_handleToggleDropdown(e) {
					...
					(this._menuPosition = e),
						...
						this._menuOpened &&
							...
							(s = `Open full tooltip for statuses: ${this._tooltips
								.value()
								.join(", ")}`),
			...
			const yl =
				(d.enabled("hide_legend_by_default"), d.enabled("fundamental_widget"));
			const Sl = d.enabled("legend_context_menu");
			const fl = 2 * parseInt(y.marginlegendhoriz);
			class Ml {
				constructor(e, t, s, i, o, r, d, u) {
					...
					const _ = this._model.model().properties().childs();
					...
					const m = new a.WatchedValue(p.value());
					p.subscribe(this, () => {
						m.setValue(p.value());
					});
					...
					const v = new a.WatchedValue(g.value());
					g.subscribe(this, () => {
						v.setValue(g.value());
					}),
				...
				updateLayout() {
					...
					const t = Array.from(this._statusProviders.keys()).filter(
						(t) => !e.includes(t),
					);
					for (const e of t) {
					...
					const l = [];
					const a = [];
					const n = this._dataSourceViewModels.length;
					if (0 === n)
				...
				_updateCollapsedSourcesMode() {
					...
					const t = this._hideAllExceptFirstLine.value();
					if (this._availableHeight > 0 && e > 2) {
						const s = Number(this._renderer.getMainSourceHeight());
						const i = this._renderer.getDataSourceHeight();
						const l = this._getCustomWidgetsHeight();
						if (null !== i) {
							const o = Math.floor((this._availableHeight - s - l) / i);
							const a = Math.max(o, 2) - 1;
							if (e > a + 1) {
								let s = "";
								for (let i = 0; i < e; i++) {
									const e = i < a;
				...
				_updateLegendVisibilities() {
					...
					const t = this._hideNotMainSources.value() || e;
					this._studiesLegendHidden.setValue(t);
					const s =
						null === this._mainSeriesRowHidden ||
						this._mainSeriesRowHidden.value();
					const i = this._customWidgetsVisibilities.some((e) => e.value());
		...
		69289: (e, t, s) => {
			...
			class m {
				...
				_updateWidgetMode() {
					...
					const s = (0, d.ensureNotNull)(this._listActionsWrapperEl);
					const i = (0, d.ensureNotNull)(this._listActionsElements.more);
			...
			const E = C;
			const V = (0, a.humanReadableModifiers)(a.Modifiers.Mod) + C;
			const k = s(97145);
			const A = s(5286);
			const L = s(61814);
			const W = s(72237);
			...
			const O = o.t(null, void 0, s(83498));
			const F = o.t(null, void 0, s(70343));
			const R = o.t(null, void 0, s(39899));
			const U = o.t(null, void 0, s(19603));
			const G = o.t(null, void 0, s(91029));
			const $ = o.t(null, void 0, s(39589));
			const j = o.t(null, void 0, s(35732));
			const Y = o.t(null, void 0, s(68854));
			const q = (0, L.hotKeySerialize)({ keys: [""], text: Y });
			const Z = (0, L.hotKeySerialize)({
			...
			class X {
				...
				_getDownButtonVisibility() {
					const e = this._paneWidget.state();
					const t = this._model.model().panes();
						...
						this._moreCMShown ||
							((e, t, s) => {
								...
								if (e.maximize.visible.value()) {
									...
									const s = (0, d.ensureNotNull)(e.maximize.action);
									i.push(
										new g.Action({
									...
									const s = (0, d.ensureNotNull)(e.minimize.action);
									i.push(
										new g.Action({
								...
								if (e.collapse.visible.value()) {
									...
									const s = (0, d.ensureNotNull)(e.collapse.action);
									i.push(
										new g.Action({
								...
								if (e.restore.visible.value()) {
									...
									const s = (0, d.ensureNotNull)(e.restore.action);
									i.push(
										new g.Action({
								...
								if (e.up.visible.value()) {
									...
									const s = (0, d.ensureNotNull)(e.up.action);
									i.push(
										new g.Action({
								...
								if (e.down.visible.value()) {
									...
									const s = (0, d.ensureNotNull)(e.down.action);
									i.push(
										new g.Action({
								...
								if (e.close.visible.value()) {
									...
									const s = (0, d.ensureNotNull)(e.close.action);
									i.push(
										new g.Action({
