(() => {
	...
	function r(e) {
		...
		const c = (t[e] = { id: e, loaded: !1, exports: {} });
	...
	(r.m = b),
		...
		(r.O = (a, c, d, f) => {
			if (!c) {
				...
				for (i = 0; i < e.length; i++) {
					for (let [c, d, f] = e[i], t = !0, o = 0; o < c.length; o++)
			...
			f = f || 0;
			for (let i = e.length; i > 0 && e[i - 1][2] > f; i--) e[i] = e[i - 1];
			e[i] = [c, d, f];
		}),
		(r.n = (e) => {
			const a = e?.__esModule ? () => e.default : () => e;
			return r.d(a, { a }), a;
		}),
		...
		(r.t = function (e, d) {
			...
			const b = {};
			a = a || [null, c({}), c([]), c(c)];
			for (let t = 2 & d && e; "object" === typeof t && !~a.indexOf(t); t = c(t))
		...
		(r.l = (e, a, c, b) => {
			if (d[e]) d[e].push(a);
				...
				if (void 0 !== c)
					for (
						let n = document.getElementsByTagName("script"), i = 0;
						i < n.length;
						i++
					) {
						const s = n[i];
		...
		(() => {
			...
			const a = r.g.document;
			if (!e && a && (a.currentScript && (e = a.currentScript.src), !e)) {
				const c = a.getElementsByTagName("script");
	...
	(r.e = (e) => {
				...
				const e = (e) =>
						new Promise((a, c) => {
							...
							if (
								((e, a) => {
									for (
										let c = document.getElementsByTagName("link"), d = 0;
										d < c.length;
										d++
									) {
										const f =
									...
									const b = document.getElementsByTagName("style");
									...
									(b.onerror = b.onload =
										(c) => {
											if (((b.onerror = b.onload = null), "load" === c.type))
												...
												const t = c && ("load" === c.type ? "missing" : c.type);
												const r = (c?.target?.href) || a;
												const o = new Error(
		...
		(() => {
			const e = { 3666: 0, 3515: 0 };
			(r.f.j = (a, c) => {
				let d = r.o(e, a) ? e[a] : void 0;
				if (0 !== d)
					if (d) c.push(d[2]);
					else if (
						...
						const f = new Promise((c, f) => (d = e[a] = [c, f]));
						c.push((d[2] = f));
						const b = r.p + r.u(a);
						const t = new Error();
						r.l(
							...
							(c) => {
								if (r.o(e, a) && (0 !== (d = e[a]) && (e[a] = void 0), d)) {
									const f = c && ("load" === c.type ? "missing" : c.type);
									const b = c?.target?.src;
									(t.message =
			...
			const a = (a, c) => {
					...
					for (a?.(c); n < b.length; n++)
						(f = b[n]), r.o(e, f) && e[f] && e[f][0](), (e[f] = 0);
					return r.O(i);
				};
			const c = (self.webpackChunktradingview = self.webpackChunktradingview || []);
