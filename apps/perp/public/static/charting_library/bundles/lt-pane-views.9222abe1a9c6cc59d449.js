	...
	[1583],
	{
		...
		24424: (e, t, i) => {
			...
			class _ extends u.LineSourcePaneView {
				...
				_updateImpl() {
					...
					const t = new s.CompositeRenderer();
					const i = (t, i) => ({
							points: [t],
							text: i,
			...
			class p extends c.LineSourcePaneView {
				...
				_updateImpl() {
					...
					if (this._points.length >= 3) {
						...
						const [n, r, a] = this._source.points();
						const l =
								Math.round(
									1e3 * Math.abs((a.price - r.price) / (r.price - n.price)),
								) / 1e3;
						const h = i(e, this._numericFormatter.format(l));
					...
					if (this._points.length >= 4) {
						...
						const [, n, r, o] = this._source.points();
						const l =
								Math.round(
									1e3 * Math.abs((o.price - r.price) / (r.price - n.price)),
								) / 1e3;
						const d = i(e, this._numericFormatter.format(l));
		...
		37803: (e, t, i) => {
			...
			class p extends c.MediaCoordinatesPaneRenderer {
				...
				hitTest(e) {
					...
					const o = this._data.points[1];
					let a = this._data.points[2];
					let l = (0, n.distanceToLine)(i, o, a).distance;
					if (l < 1)
						return (
				...
				_drawImpl(e) {
					...
					const c = i.add(o).scaled(0.5);
					const u = new r.Point(-h.y, h.x).normalized();
					(a = c.add(u.scaled(l))),
						(t.strokeStyle = this._data.color),
						(t.lineWidth = this._data.linewidth);
					const p = h.length();
					...
					let x = (0, s.translationMatrix)(-c.x, -c.y);
			...
			class _ extends l.LineSourcePaneView {
				...
				_updateImpl() {
					...
					y < 0 && (T = -T);
					let b = t.points[2];
					let P = (0, s.translationMatrix)(-v.x, -v.y);
					...
					i.append(
						this.createLineAnchor({ points: d, pointsCursorType: S }, 0),
					);
				}
			}
		},
						...
						switch (
							...
							case "down":
								!((e, t, i, n) => {
									...
									const s = "up" === i ? 1 : -1;
									const o = s * Math.round(12 * n);
									const a = (0, h.ceiledEven)(19.5 * n) / 2 + r;
									const l = s * Math.round(10 * n);
									const d = (0, h.ceiledEven)(10 * n) / 2 + r;
									const c = Math.round(t.x * n) + r;
									const u = Math.round(t.y * n);
									e.beginPath(),
										e.moveTo(c, u),
										e.lineTo(c + a, u + o),
										e.lineTo(c + d, u + o),
							...
							case "right":
								!((e, t, i, n) => {
									const r = Math.max(1, Math.floor(n)) % 2 ? 0.5 : 0;
									const s = "left" === i ? 1 : -1;
									const o = s * Math.round(12 * n) + r;
									const a = (0, h.ceiledEven)(19.5 * n) / 2 + r;
									const l = s * Math.round(22 * n) + r;
									const d = (0, h.ceiledEven)(10 * n) / 2 + r;
									const c = Math.round(t.x * n) + r;
									const u = Math.round(t.y * n) + r;
									e.beginPath(),
										e.moveTo(c, u),
										e.lineTo(c + o, u + a),
										e.lineTo(c + o, u + d),
		...
		97747: (e, t, i) => {
			...
			class c extends a.MediaCoordinatesPaneRenderer {
				...
				hitTest(e) {
					...
					let i = this._data.points[1].subtract(t);
					const n = i.length();
					...
					const s = i.dotProduct(r) / n;
					if (s < 0 || s > n) return null;
					const o = i.scaled(1 / n);
					const a = t.addScaled(o, s);
					const h = e.subtract(a);
					const c = (0, d.interactionTolerance)().line;
					const u = this._hittestGeometry(n);
				...
				_drawImpl(e) {
					...
					const a = this._arrowGeometry(i.length());
					const l = i.normalized();
					(t.lineWidth = ((e) => {
					...
					for (let e = 0; e < a.length; e++) {
						const i = a[e];
						const n = r.addScaled(l, i.x).addScaled(s, i.y);
						t.lineTo(n.x, n.y);
					}
			...
			class _ extends n.LineSourcePaneView {
				...
				_updateImpl() {
					...
					if (
						...
						const n = i[0].index - i[1].index;
						const r = i[0].price - i[1].price;
						if (
							...
							const n = new o.Point(e[0].x + 9, e[0].y + 9);
		...
		74718: (e, t, i) => {
			...
			class p extends c.MediaCoordinatesPaneRenderer {
				...
				hitTest(e, t) {
					...
					const n = this._data.points[0].y - (this._geometryCache.innerHeight + 9);
					const r = (0, a.box)(
							new a.Point(i, n),
							new a.Point(
				...
				_drawImpl(e) {
					...
					const l = this._data.points[0].y - (r + 9);
					t.translate(a, l),
						t.beginPath(),
						t.moveTo(24, r),
						t.lineTo(15, r),
				...
				_measureInfo(e, t, i) {
					if (this._geomertryCacheInvalidated) {
						...
						const r = i;
						const s = 15;
						const o = Math.round(r / 1.3);
						const a = n.width + 2 * s;
						const l = r + 2 * o;
						const d = (0, h.calcTextHorizontalShift)(e, n.width);
						(this._geometryCache = {
							paddingLeft: s,
							innerWidth: a,
							innerHeight: l,
		...
		45371: (e, t, i) => {
			...
			class x extends _.LineSourcePaneView {
				...
				_updateImpl() {
					...
					const p = this._source.pattern();
					const _ = p.length;
					const x = new l.CompositeRenderer();
					if (_ > 0 && 2 === u.length) {
						const e = this._source.properties().childs();
						const t = e.mode.value();
						const l = e.color.value();
						const d = Math.abs((this._points[0].x - this._points[1].x) / (_ - 1));
						const f = this._source.getScale();
						const m = (e) => i.priceToCoordinate(e, r) * f;
						const [{ index: w }, { index: R }] = u;
						const y = w < R ? this._points[0] : this._points[1];
						const T = y.x;
						const b = y.y - m(this._source.firstPatternPrice());
						if (
							...
							for (let t = 0; t < _; t++) {
								...
								const r = e(p[t]).map(
										(e, t) =>
											new n.Point(i + (2 * t - 1), Math.round(m(e)) + b),
									);
								const s = new c.RectangleRenderer();
								s.setData({
									points: r,
									color: l,
									backcolor: l,
							...
							const e = v[t];
							const i = p.map((t, i) => new n.Point(T + i * d, m(e(t)) + b));
							x.append(
			...
			class p extends s.MediaCoordinatesPaneRenderer {
				...
				hitTest(e, t) {
					...
					if (4 === i.points.length) {
						...
						const [n, r, s, l] = i.points;
						const d = l.subtract(n);
						const u = s.subtract(d.scaled(0.25));
						const p = s.add(d.scaled(0.25));
						const _ = r.subtract(s);
						const g = l.subtract(_.scaled(0.25));
						const f = l.add(_.scaled(0.25));
						if (
				...
				_drawImpl(e) {
					...
					if (2 === this._data.points.length)
						...
						const r = this._data.points[3];
						const s = r.subtract(i);
						const o = e.subtract(s.scaled(0.25));
						const a = e.add(s.scaled(0.25));
						const c = n.subtract(e);
						const u = r.subtract(c.scaled(0.25));
						const p = r.add(c.scaled(0.25));
						this._data.fillBack &&
			...
			class v extends r.LineSourcePaneView {
				...
				_updateImpl(e, t) {
					...
					if (4 === this._source.points().length) {
						...
						const a = (0, f.ensureNotNull)(
								this._source.pointToScreenPoint(this._source.points()[2]),
							);
						const l = (0, f.ensureNotNull)(
								this._source.pointToScreenPoint(this._source.points()[3]),
							);
						const d = l.subtract(n);
						const h = a.subtract(d.scaled(0.25));
						const c = o.subtract(a);
						const u = l.add(c.scaled(0.25));
						i.extendLeft.value() &&
					...
					const a = this._source.controlPoints();
					null !== a &&
						(o.push(
							(0, f.ensureNotNull)(this._source.pointToScreenPoint(a[0])),
						),
						o.push(
							(0, f.ensureNotNull)(this._source.pointToScreenPoint(a[1])),
						));
					const l = {
						points: o,
			...
			class h extends s.LineSourcePaneView {
				...
				_updateImpl(e, t) {
					...
					if (3 === this._source.points().length) {
						...
						const l = (0, n.ensureNotNull)(
								this._source.pointToScreenPoint(this._source.points()[2]),
							);
						const d = o.subtract(r);
						const h = l.subtract(d.scaled(0.25));
						const c = l.add(d.scaled(0.25));
						i.extendLeft.value() &&
					...
					const d = this._source.controlPoint();
					null !== d &&
			...
			class p extends r.MediaCoordinatesPaneRenderer {
				...
				hitTest(e, t) {
					if (null !== this._data && 3 === this._data.points.length) {
						...
						const l = r.subtract(s.scaled(0.25));
						const h = r.add(s.scaled(0.25));
						if (
				...
				_drawImpl(e) {
					...
					if (
						...
						const o = n.subtract(e.scaled(0.25));
						const a = n.add(e.scaled(0.25));
						this._data.fillBack &&
							this._data.points.length > 2 &&
			...
			class d extends l.LineSourcePaneView {
				...
				_updateImpl() {
					...
					for (let n = 1; n < t.length; n++) {
						...
						const s = r.length();
						const o = Math.min(5, Math.floor(s / e));
						const a = r.normalized().scaled(s / o);
					...
					if (
						...
						if (e > 0) {
							...
							const i = new s.SelectionRenderer({
									points: t,
				...
				_smoothArray(e, t) {
					...
					for (let r = 0; r < e.length; r++) {
						...
						for (let i = 0; i < t; i++) {
							...
							const n = Math.min(r + i, e.length - 1);
		...
		70326: (e, t, i) => {
			...
			class p extends c.MediaCoordinatesPaneRenderer {
				...
				_drawImpl(e) {
					...
					const i = this._data.points[1].clone();
					const n = e.context;
					(n.lineCap = "round"),
					...
					const s = this._data.textData.maxWidth;
					const o = s + 20;
					const a = r + 20;
			...
			class v extends _.LineSourcePaneView {
				...
				_updateImpl() {
					...
					const s = new n.Point(i, this._points[1].y);
					const o = this._fontStyle();
					const a = e.wordWrap.value() ? e.wordWrapWidth.value() : void 0;
					const l = (0, g.wordWrap)(e.text.value(), o, a);
					let d;
					d =
						void 0 !== a
							? a
					...
					if (
						...
						const e = h.points[1];
						const t = new n.Point(e.x + a / 2 + 8 + 2, e.y);
						(t.data = 1),
				...
				_fontStyle() {
					...
					const i = e.fontsize.value();
					return (0, s.makeFont)(i, a.CHART_FONT_FAMILY, t);
				}
			}
		},
		71090: (e, t, i) => {
			const n = i(86441).Point;
			const r = i(79191).LineSourcePaneView;
			const s = i(71254).VerticalLineRenderer;
			const o = i(99031).TrendLineRenderer;
			const a = i(18807).HitTarget;
			const l = i(19266).CompositeRenderer;
			const d = i(73436).LineEnd;
				...
				_updateImpl() {
					if (
						...
						if (
							...
							const t = this._source.points()[0];
							const i = this._source.points()[1];
							const r = i ? i.index - t.index : 1;
							if (((this._lines = []), 0 !== r)) {
								const o = e.visibleBarsStrictRange();
								if (r > 0)
									for (let h = t.index; h <= o.lastBar(); h += r)
								...
								if (!(this._points.length < 2)) {
									...
									const _ = this._model.timeScale().width();
									const g = this._source.priceScale().height();
		...
		79104: (e, t, i) => {
			...
			class h {
				...
				draw(e, t) {
					...
					const d = Math.max(1, Math.floor(l));
					const h = (d % 2) / 2;
					const c = Math.round(i.x * l) + h;
					const u = Math.round(i.y * l) + h;
					const p = Math.round(c + n * l);
					const _ = Math.max(1, Math.floor(r * l));
					const g = p - c - _;
					o &&
						g > 0 &&
						((e.fillStyle = a),
				...
				hitTest(e, t) {
					...
					const r = (0, d.interactionTolerance)().curve;
			...
			class c extends o.LineSourcePaneView {
				...
				_updateTextRenderer() {
					...
					const l = o.subtract(a).length() * Math.sqrt(2);
					const d = {
							points: [o],
							text: e.value(),
							color: t.value(),
		...
		37662: (e, t, i) => {
			...
			class g extends u.MediaCoordinatesPaneRenderer {
				...
				hitTest(e, t) {
					...
					const n = this._data.points[0].y - this._geometryCache.innerHeight;
					const r = (0, l.box)(
							new l.Point(i, n),
							new l.Point(
								i + this._geometryCache.innerWidth,
				...
				_drawImpl(e) {
					...
					const a = Math.min(s, r) / 2;
					const l = this._data.points[0].x;
					const d = this._data.points[0].y - r;
					t.translate(l, d),
				...
				_measureInfo(e, t, i) {
					if (this._geomertryCacheInvalidated) {
						...
						const a = n.width + 2 * s;
						const l = r + 2 * o;
						const d = (0, c.calcTextHorizontalShift)(e, n.width);
						(this._geometryCache = {
							paddingLeft: s,
							innerWidth: a,
							innerHeight: l,
		...
		99734: (e, t, i) => {
			...
			class a extends o.LineSourcePaneView {
				constructor() {
					super(...arguments),
						(this._customTextrenderer = new s.TextRenderer());
				}
				_updateCustomTextRenderer(e, t) {
					...
					if (i.visible.value() && i.text.value().length > 0) {
						const [o, a] = this._points;
						const l = Math.round((o.y + a.y) / 2);
						const d = new n.Point(o.x, l);
						const h = new n.Point(a.x, l);
						const c = d.x < h.x ? d : h;
						const u = c === d ? h : d;
						const p = "middle";
						const _ = "center";
						const g = new n.Point((d.x + h.x) / 2, (d.y + h.y) / 2);
						const f = Math.atan((u.y - c.y) / (u.x - c.x));
						const v = {
								points: [g],
								text: i.text.value(),
								color: i.color.value(),
		...
		54306: (e, t, i) => {
			...
			const w = new c.PercentageFormatter();
			const R = new f.VolumeFormatter();
			const y = s.t(null, void 0, i(33355));
			const T = s.t(null, { context: "study" }, i(32819));
			class b extends x.DateAndPriceRangeBasePaneView {
				...
				_updateImpl(e, t) {
					...
					const f = this._updateCustomTextRenderer(e, t);
					const x = Math.round((h.y + c.y) / 2);
					const b = new r.Point(h.x + Math.sign(c.x - h.x) * _, x);
					const P = new r.Point(c.x + Math.sign(h.x - c.x) * _, x);
					...
					const S = new r.Point(L, h.y + Math.sign(c.y - h.y) * _);
					const C = new r.Point(L, c.y + Math.sign(h.y - c.y) * _);
					this._distancePriceRenderer.setData({
						...
						leftend: p.LineEnd.Normal,
						rightend:
							Math.abs(S.y - C.y) >= 25 * d.linewidth.value()
								? p.LineEnd.Arrow
								: p.LineEnd.Normal,
						excludeBoundaries: null != f ? f : void 0,
					}),
					...
					const I = this._source.points()[1].price;
					const A = I - M;
					const k = (100 * A) / Math.abs(M);
					const N = this._source.points()[0].index;
					const D = this._source.points()[1].index;
					const B = D - N;
					const z = (0, o.forceLTRStr)(`${B}`);
					const E = this._model.timeScale().indexToUserTime(N);
					const H = this._model.timeScale().indexToUserTime(D);
					let O = "";
					if (E && H) {
					...
					const F =
							`${(null !==
								...
								? s
								: W.format(A))} (${w.format(Math.round(100 * k) / 100)}) ${this._pipFormatter ? this._pipFormatter.format(A) : ""}`;
					...
					const G = (0, a.calculateLabelPosition)(X, h, c, q, e);
		...
		55762: (e, t, i) => {
			...
			const v = r.t(null, void 0, i(33355));
			const x = r.t(null, { context: "study" }, i(32819));
			class m extends g.DateAndPriceRangeBasePaneView {
				...
				_updateImpl(e, t) {
					...
					const a = r.extendTop.value();
					const l = r.extendBottom.value();
					const [d, p] = this._points;
					const g = a ? 0 : Math.min(d.y, p.y);
					const m = l ? this._height() : Math.max(d.y, p.y);
					...
					const y = new n.Point(d.x, R);
					const T = new n.Point(p.x, R);
					const b = this._updateCustomTextRenderer(e, t);
					this._distancePriceRenderer.setData({
						points: [y, T],
						color: r.linecolor.value(),
						linewidth: r.linewidth.value(),
					...
					const L = this._source.points()[1].index;
					const S = L - P;
					const C = this._model.timeScale().indexToUserTime(P);
					const M = this._model.timeScale().indexToUserTime(L);
					let I = "";
					if (C && M) {
					...
					const k = Number.isNaN(A) ? "" : `\n${x} ${f.format(A)}`;
					const N = v.format({ count: (0, s.forceLTRStr)(S.toString()) }) + I + k;
					const D = { x: 0, y: 10 };
					const B = r.fontsize.value();
					const z = {
							text: N,
					...
					const H = (0, o.calculateLabelPosition)(E, d, p, D, e);
		...
		53288: (e, t, i) => {
			let n = i(23966).DisjointChannelRenderer;
			const r = i(99031).TrendLineRenderer;
			const s = i(80657).TextRenderer;
			const o = i(19266).CompositeRenderer;
			const a = i(66103).PaneCursorType;
			const l = i(46501);
			const d = i(33295).AlertableLineSourcePaneView;
			const h = [a.Default, a.Default, a.VerticalResize, a.Default];
			t.DisjointChannelPaneView = class extends d {
				...
				_updateImpl() {
					if (
						...
						let e = this._source.points()[0];
						let t = this._source.points()[1];
						...
						if (!(this._points.length < 2)) {
							...
							if (this._points.length >= 3) {
								...
								if (
									...
									const _ = c.timeScale().width();
									const g = u.priceScale().height();
									const f = d.extendLeft.value();
									const v = d.extendRight.value();
							...
							const w = (e, t, i, n, r, s) => {
									if (this._source.properties().showPrices.value()) {
										let o = {
											points: [i],
											text: r,
		...
		14417: (e, t, i) => {
			...
			class p {
				...
				hitTest(e) {
					...
					const i = this._data.circleRadius;
					const n = {
				...
				draw(e, t) {
					...
					const r = this._center();
					const s = Math.round(r.x * i) + n;
					const o = Math.round(r.y * i) + n;
			...
			class v extends n.LineSourcePaneView {
				...
				_updateImpl() {
					...
					for (let e = 0; e < this._points.length - g; e++, u = -u) {
						...
						const r = f[t.group];
						const s = new l.HitTestResult(l.HitTarget.ChangePoint, {
								pointIndex: e,
							});
						h.append(
							new p(
		...
		11756: (e, t, i) => {
			...
			class f extends _.MediaCoordinatesPaneRenderer {
				...
				hitTest(e) {
					...
					const a = i.subtract(t);
					const l = t.add(i).scaled(0.5);
					const d = new r.Point(-a.y, a.x).normalized();
					s = l.add(d.scaled(o));
					const h = a.length();
					const u = a.x / h;
					const _ = a.y / h;
					...
					(v = (0, c.rotationMatrix)(-f)),
						...
						(x = (0, c.transformPoint)(v, x));
					const m = e.length();
					const w = (0, g.interactionTolerance)().curve;
				...
				_drawImpl(e) {
					...
					const d = t.add(i).scaled(0.5);
					const h = new r.Point(-l.y, l.x).normalized();
					(o = d.add(h.scaled(a))),
						(s.strokeStyle = this._data.color),
						(s.lineWidth = this._data.linewidth);
					const p = l.length();
					...
					g < 0 && (f = -f);
					let v = this._data.points[2];
					let x = (0, c.translationMatrix)(-d.x, -d.y);
			...
			class v extends h.LineSourcePaneView {
				...
				_updateImpl() {
					...
					const p = a.subtract(o);
					const _ = o.add(a).scaled(0.5);
					const g = new r.Point(-p.y, p.x).normalized();
					c = _.add(g.scaled(u));
					const f = _.add(g.scaled(-u));
					const v = new r.Point(o.x, o.y);
					v.data = 0;
					...
					const y = [l.PaneCursorType.Default, l.PaneCursorType.Default, R, R];
					s.append(
						this.createLineAnchor(
		...
		82080: (e, t, i) => {
			...
			class a extends o.MediaCoordinatesPaneRenderer {
				...
				hitTest(e, t) {
					...
					const n = Math.round(this._data.point.y);
					const r = this._data.arrowHeight;
					let o;
					let a;
					if (
		...
		46406: (e, t, i) => {
			...
			class c extends a.ParallelChannelRenderer {
				...
				_extendAndDrawLineSegment(e, t, i, n) {
					...
					super._extendAndDrawLineSegment(e, t, i, n),
						void 0 !== s && e.restore();
				}
			}
			class u extends d.LineToolPaneViewFibWithLabels {
				...
				_updateImpl(e, t) {
					...
					const v = (0, n.ensureNotNull)(this._norm);
					for (let i = 1; i < f; i++) {
						...
						const x = _.add(a);
						const m = g.add(a);
						const w = v.scaled(o.coeff.value());
						const R = _.add(w);
						const y = g.add(w);
						const T = l.coordinateToPrice(x.y, d);
						const b = this._updateLabelForLevel({
								i: i - 1,
								levelIndex: i,
								leftPoint: x,
								rightPoint: m,
						...
						null !== b &&
							(u.append(b),
							(P =
								null !== (r = (0, h.getTextBoundaries)(b, t, e)) && void 0 !== r
									? r
									: void 0));
						const L = {
								points: [x, m, R, y],
					...
					if (null !== x) {
						...
						if (i.visible.value()) {
							...
							const r = _.add(n);
							const o = g.add(n);
							const c = l.coordinateToPrice(r.y, d);
							const f = this._updateLabelForLevel({
									i: x - 1,
									levelIndex: x,
									leftPoint: r,
									rightPoint: o,
							...
							null !== f &&
								(u.append(f),
								(m =
									null !== (a = (0, h.getTextBoundaries)(f, t, e)) &&
									void 0 !== a
										? a
										: void 0));
							const w = {
							...
							this._lastLevelTrendRenderer.setData(w),
								u.append(this._lastLevelTrendRenderer);
						}
					}
		...
		13616: (e, t, i) => {
			...
			const s = i(99031).TrendLineRenderer;
			const o = i(18807).HitTestResult;
			const a = i(18807).HitTarget;
			const l = i(19266).CompositeRenderer;
			const d = i(70531).EllipseRendererSimple;
			const h = i(73436).LineEnd;
			t.FibCirclesPaneView = class extends r {
				...
				_updateImpl() {
					if (
						...
						const r = Math.abs(t.y - e.y);
						this._levels = [];
						for (
							let s = this._source.properties(),
							...
							const p = s[`level${u}`];
							if (p.visible.value()) {
								const _ = p.coeff.value();
								const g = p.color.value();
								const f = [];
								f.push(
									new n(
								...
								const v = new n(this._center.x, this._center.y + 0.5 * r * _);
								this._levels.push({
									color: g,
									points: f,
									labelPoint: v,
						...
						if (!(this._points.length < 2)) {
							const x = new l();
							const m = s.fillBackground.value();
							const w = s.transparency.value();
							for (u = 0; u < this._levels.length; u++) {
								const R = this._levels[u];
								const y = {};
								(y.points = R.points),
									(y.color = R.color),
									...
									(y.fillBackground = m),
									(y.transparency = w);
								const T = new o(a.MovePoint, null, R.index);
								x.append(new d(y, T));
		...
		95994: (e, t, i) => {
			...
			class u extends c.LineToolPaneViewFibWithLabels {
				...
				_updateImpl(e, t) {
					...
					const f = g.reverse.value();
					if (this._points.length < 2) return;
					const v = this._points[0];
					const x = this._points[1];
					const m = Math.min(v.x, x.x);
					const w = Math.max(v.x, x.x);
					const R = g.fillBackground.value();
					const y = g.transparency.value();
					const T = g.extendLinesLeft.value();
					const b = g.extendLines.value();
					const P = c.isLog() && g.fibLevelsBasedOnLogScale.value();
					const L = !((m > t && !T) || (w < 0 && !b));
					this._levels = [];
					const S = f ? p.price : _.price;
					const C = f ? _.price : p.price;
					const M = C - S;
					const I = c.priceToCoordinate(S, u);
					const A = { price: S, coordinate: I };
					const k = { price: M, coordinate: c.priceToCoordinate(C, u) - I };
					const N = this._source.levelsCount();
					for (let e = 1; e <= N; e++) {
						const t = g[`level${e}`].childs();
						if (!t || !t.visible.value()) continue;
						const i = t.coeff.value();
						const n = (0, h.fibLevelCoordinate)(A, k, i, c, u, P);
						const r = (0, h.fibLevelPrice)(A, k, i, c, u, P);
						this._levels.push({
							color: t.color.value(),
							y: n,
							price: r,
					...
					if (R && L)
						for (let e = 0; e < this._levels.length; e++)
							if (e > 0 && R) {
								...
								const s = new r.RectangleRenderer(void 0, void 0, !0);
					...
					for (let i = 0; i < this._levels.length; i++) {
						...
						const h = new n.Point(B, this._levels[i].y);
						const c = this._updateLabelForLevel({
								i,
						...
						if (
							...
							const p = new s.TrendLineRenderer();
							p.setData(u),
								p.setHitTest(
									new a.HitTestResult(
										a.HitTarget.MovePoint,
		...
		91331: (e, t, i) => {
			...
			class u extends c.MediaCoordinatesPaneRenderer {
				...
				hitTest(e) {
					...
					const n = (0, h.interactionTolerance)().curve;
			...
			class _ extends p.LineToolPaneViewFibWithLabels {
				...
				_updateImpl() {
					...
					const d = i.subtract(l).length();
					this._levels = [];
					const h = this._source.properties().childs();
					const c = this._source.levelsCount();
					for (let e = 1; e <= c; e++) {
						const t = `level${e}`;
						const s = this._source.properties().child(t).childs();
						if (!s.visible.value()) continue;
						const o = s.coeff.value();
						const a = s.color.value();
						const h = l.subtract(i).length() * o;
						const c = (0, r.sign)(l.y - i.y);
						const u = new n.Point(i.x, i.y + c * d * o);
						this._levels.push({
							color: a,
							radius: h,
							dir: c,
					...
					const _ = h.fillBackground.value();
					const g = h.transparency.value();
					for (let e = 0; e < this._levels.length; e++) {
						...
						const r = new s.HitTestResult(s.HitTarget.MovePoint, void 0, t.index);
						p.append(new u(n, r));
		...
		80724: (e, t, i) => {
			...
			class _ extends u.LineSourcePaneView {
				...
				_updateImpl() {
					...
					const t = (0, n.ensureNotNull)(this._source.ownerSource()).firstValue();
					if (
						null === t ||
						!e ||
						e.isEmpty() ||
					...
					const s = this._source.points()[1];
					const u = this._source.properties().childs();
					const _ = u.reverse.value();
					const g = [];
					const f = _ ? s.price - i.price : i.price - s.price;
					const v = _ ? i.price : s.price;
					for (let i = 1; i <= 7; i++) {
						const n = `hlevel${i}`;
						const r = this._source.properties().child(n).childs();
						if (!r.visible.value()) continue;
						const s = r.coeff.value();
						const o = r.color.value();
						const a = v + s * f;
						const l = e.priceToCoordinate(a, t);
						g.push({ coeff: s, color: o, y: l, index: i });
					}
					const x = [];
					const m = _ ? s.index - i.index : i.index - s.index;
					const w = _ ? i.index : s.index;
					for (let e = 1; e <= 7; e++) {
						const t = `vlevel${e}`;
						const i = this._source.properties().child(t).childs();
						if (!i.visible.value()) continue;
						const n = i.coeff.value();
						const r = i.color.value();
						const s = Math.round(w + n * m);
						const o = this._model.timeScale().indexToCoordinate(s);
						x.push({ coeff: n, color: r, x: o, index: e });
					}
					const R = new l.CompositeRenderer();
					const y = this._points[0];
					const T = this._points[1];
					const b = Math.min(y.x, T.x);
					const P = Math.min(y.y, T.y);
					const L = Math.max(y.x, T.x);
					const S = Math.max(y.y, T.y);
					const C = u.grid.childs().color.value();
					const M = u.grid.childs().linewidth.value();
					const I = u.grid.childs().linestyle.value();
					for (let e = 0; e < g.length; e++) {
						const t = new r.Point(b, g[e].y);
						const i = new r.Point(L, g[e].y);
						if (u.grid.childs().visible.value()) {
							...
							const n = new c.TrendLineRenderer();
			...
			class u extends h.MediaCoordinatesPaneRenderer {
				...
				_drawImpl(e) {
					...
					for (let e = 0; e < 50 * (c.length - 1); e++) {
						const i = d * e * a;
						const n = this._continiusFib(e / 50);
						if (null === n) break;
						const r = Math.cos(i) * n;
						const s = Math.sin(i) * n;
						t.lineTo(r, s);
					}
				...
				_updateImpl(e, t) {
					...
					if (p.fillBackground.value()) {
						...
						for (let i = 1; i < this._levels.length; i++) {
							...
							const a = new o.RectangleRenderer(void 0, void 0, !0);
					...
					for (let o = 0; o < this._levels.length; o++) {
						...
						const u = new l.HitTestResult(
								l.HitTarget.MovePoint,
								void 0,
								this._levels[o].index,
							);
						const _ = new r.VerticalLineRenderer();
		...
		60322: (e, t, i) => {
			const { LineToolPaneViewFibWithLabels: n } = i(134);
			const r = i(86441).Point;
			const s = i(99031).TrendLineRenderer;
			const o = i(18807).HitTestResult;
			const a = i(18807).HitTarget;
			const l = i(19266).CompositeRenderer;
			const d = i(81139).ArcWedgeRenderer;
			const h = i(73436).LineEnd;
			t.FibWedgePaneView = class extends n {
				...
				_updateImpl() {
					if (
						...
						const i = e[1];
						const n = e[2];
						const s = i.subtract(t).normalized();
						const o = n.subtract(t).normalized();
						const a = new r(1, 0);
						const l = new r(0, 1);
						...
						for (
							let c = this._source.properties(), u = 1;
							...
							if (p.visible.value()) {
								const _ = p.coeff.value();
								const g = p.color.value();
								const f = i.subtract(t).length() * _;
								const v = s.add(o).scaled(0.5).normalized().scaled(f);
								const x = t.add(v);
								this._levels.push({
									coeff: _,
									color: g,
				...
				_updateRenderer() {
					if (!((x = this._points).length < 2)) {
						...
						let s = x[2];
						const c = s.data;
						const u = n.subtract(i).length();
						const p = s.subtract(i).normalized();
						...
						for (let _ = this._levels.length - 1; _ >= 0; _--) {
							const g = this._levels[_];
							const f = {};
							...
							const v = new d();
							v.setData(f),
								v.setHitTest(new o(a.MovePoint, null, g.index)),
								e.append(v);
		...
		85377: (e, t, i) => {
			...
			const o = i(19266).CompositeRenderer;
			const a = i(46501);
			const l = i(33295).AlertableLineSourcePaneView;
					...
					if (
						...
						if (!(this._points.length < 2)) {
							...
							if (
								...
								const c = d.timeScale().width();
								const u = h.priceScale().height();
								const p = l.extendLeft.value();
								const _ = l.extendRight.value();
								this._disjointChannelRenderer.setData({
									width: c,
									height: u,
									extendleft: p,
		...
		99631: (e, t, i) => {
			...
			class u extends r.LineSourcePaneView {
				...
				_updateImpl() {
					...
					const s = r.isReversed();
					s && ([n, i] = t);
					const o = n.x - i.x;
					const l = n.y - i.y;
					const d = i;
					const h = n;
					const c = this._getModel();
					const u = {
							barsCoordsRange: o,
							priceCoordsRange: l,
							startPoint: d,
				...
				_prepareLevels(e, t) {
					...
					const a = this._getSource().levels();
					for (const t of a) {
						...
						const u = this._verticalLevelsRenderers[t.index];
						...
						const g = this._horizontalLevelsRenderers[t.index];
				...
				_prepareFanLines(e, t) {
					...
					const h = this._getSource().fanLines();
					for (const t of h) {
						if (!t.visible) continue;
						const h = t.x;
						const c = t.y;
						...
						const g = this._fanRenderers[t.index];
						g.setData(_), e.append(g);
					}
				}
				_prepareArcs(e, t) {
					...
					const h = d.isArcsBackgroundFilled();
					const c = d.arcsBackgroundTransparency();
					const u = d.arcs();
					for (const t of u) {
						if (!t.visible) continue;
						const i = t.x / 5;
						...
						const g = this._arcRenderers[t.index];
				...
				_prepareLabels(e, t) {
					...
					const l = a.ownerSource();
					let d = a.getPriceDiff();
					let h = a.getIndexDiff();
					if (null === d || null === h || null === l) return;
					o && ((d = -d), (h = -h));
					const u = new n.Point(i.x, r.y);
					const p = (0, c.forceLTRStr)(l.formatter().format(d));
					const _ = this._getLabelData(u, p);
					...
					const f = (0, c.forceLTRStr)(h.toString());
					const v = this._getLabelData(g, f);
					...
					const w = (0, c.forceLTRStr)(m.format(x));
					const R = this._getLabelData(r, w);
			...
			class u extends h.LineSourcePaneView {
				...
				_updateImpl() {
					...
					for (let e = 1; e <= 9; e++) {
						...
						const o = r.coeff2.value();
						const a = s / o;
						const l = r.color.value();
						const d = `${s}/${o}`;
						let c;
						let _;
						s > o
					...
					const f = _.fillBackground.value();
					const v = _.transparency.value();
					for (let e = 0; e < h.length; e++) {
							...
							}
						{
							...
							const s = new d.TrendLineRenderer();
							s.setData(n),
								s.setHitTest(
									new r.HitTestResult(
			...
			class h extends r.LineSourcePaneView {
				...
				_updateImpl() {
					...
					if (s.length < 2)
						return this.addAnchors(a), void (this._renderer = a);
					const l = s[0];
					const d = 3 === s.length ? s[2] : s[1];
					const h = d.x - l.x;
					const c = d.y - l.y;
					const u = l;
					const p = d;
					const _ = this._getModel();
					const g = {
							barsCoordsRange: h,
							priceCoordsRange: c,
							startPoint: u,
				...
				_prepareLevels(e, t) {
					...
					const d = this._getSource().levels();
					for (const t of d) {
						if (!t.visible) continue;
						const d = t.index / 5;
						const h = i.x + d * s;
		...
		97449: (e, t, i) => {
			...
			const r = i(79191).LineSourcePaneView;
			const s = i(80657).TextRenderer;
			const o = i(72739).RectangleRenderer;
			const a = i(99031).TrendLineRenderer;
			const l = i(19266).CompositeRenderer;
			const d = i(87663).NumericFormatter;
			const h = i(73436).LineEnd;
			const c = i(46501);
			t.GannSquarePaneView = class extends r {
				...
				_updateImpl() {
					if (
						...
						let e = this._source.points()[0];
						let t = this._source.points()[1];
						const i = (C = this._source.properties()).reverse && C.reverse.value();
						this._hlevels = [];
						for (
							let r = i ? e.price - t.price : t.price - e.price,
								d = i ? t.price : e.price,
							...
							if ((w = C[`hlevel${p}`]).visible.value()) {
								const _ = w.coeff.value();
								const g = w.color.value();
								const f = d + _ * r;
								const v = this._source.priceScale().priceToCoordinate(f, u);
								this._hlevels.push({ coeff: _, color: g, y: v });
							}
						}
						this._vlevels = [];
						const x = i ? e.index - t.index : t.index - e.index;
						const m = i ? t.index : e.index;
						for (p = 1; p <= 7; p++) {
							let w;
							if ((w = C[`vlevel${p}`]).visible.value()) {
								(_ = w.coeff.value()), (g = w.color.value());
								const R = Math.round(m + _ * x);
								const y = this._model.timeScale().indexToCoordinate(R);
						...
						const b = Math.min(e.x, t.x);
						const P = Math.min(e.y, t.y);
						const L = Math.max(e.x, t.x);
						const S = Math.max(e.y, t.y);
						let C = this._source.properties();
						const M = this._source.properties().fillHorzBackground.value();
						const I = this._source.properties().horzTransparency.value();
						const A = this._source.properties().fillVertBackground.value();
						const k = this._source.properties().vertTransparency.value();
						for (p = 0; p < this._hlevels.length; p++) {
							if (p > 0 && M) {
								const N = this._hlevels[p - 1];
						...
						for (p = 0; p < this._vlevels.length; p++) {
							...
							if (
								((O = new a()).setData(D), T.append(O), C.showTopLabels.value())
							) {
								const V = {
									points: [e],
						...
						const Y = new n(this._points[0].x, this._points[1].y);
						Y.data = 2;
						const j = new n(this._points[1].x, this._points[0].y);
						(j.data = 3),
							T.append(
				...
				_updateImpl() {
					...
					this._segments = this._source
						...
						.map((e, t) => {
							...
							const s = u[t].price;
							const o = u[t + 1].price;
							const a = i.priceToCoordinate(s, n);
							const l = i.priceToCoordinate(o, n);
							const d = u[t + 1].index - u[t].index;
							const h = this._model.timeScale().barSpacing() * Math.sign(d);
							const c = (l - a) / (e.bars().length - 1);
							const p = g.upColor.value();
							const _ = g.downColor.value();
							const f = g.borderUpColor.value();
							const v = g.borderDownColor.value();
							return {
								bars: e.bars().map((e, t) => {
									const s = a + t * c;
									const o = i.coordinateToPrice(s, n);
									const l = e.c >= e.o;
									return {
										time: r + t * h,
										exactTime: r + t * h,
					...
					for (let e = 1; e < this._points.length; e++) {
						...
						const i = new h.TrendLineRenderer();
						i.setData(t),
							i.setHitTest(new o.HitTestResult(o.HitTarget.MovePoint)),
							f.append(i);
					}
					const v = g.drawWick.value();
					const x = g.drawBorder.value();
					const m = g.borderColor.value();
					const w = g.wickColor.value();
		...
		45495: (e, t, i) => {
			...
			class g extends u.LineSourcePaneView {
				...
				_updateImpl() {
					...
					if (this._points.length < 2) return;
					const g = this._source.properties().childs();
					const f = new d.CompositeRenderer();
					const v = (e, t) => ({
							points: [e],
							text: t,
		...
		74660: (e, t, i) => {
			...
			class u extends h.AlertableLineSourcePaneView {
				...
				_updateImpl(e, t) {
					...
					const a = new l.CompositeRenderer();
					let h;
					let u = !0;
					if (
						s.showLabel.value() &&
						...
						const l = s.horzLabelsAlign.value();
						let c = 0;
						let p = 0;
						"left" === l
							? (p = 3)
		...
		57964: (e, t, i) => {
			...
			class _ extends u.BitmapCoordinatesPaneRenderer {
				...
				_drawImpl(e) {
					...
					const s = r.width;
					const o = this._data.points[0].y;
					const a = Math.max(0, this._data.points[0].x);
					const l = Math.max(s, this._data.points[0].x);
					(t.lineCap =
			...
			class g extends l.AlertableLineSourcePaneView {
				...
				_updateImpl(e, t) {
					...
					const d = new r.CompositeRenderer();
					let h;
					let c = this._points[0].clone();
					if (l.showLabel.value() && 1 === this._points.length) {
						const r = l.vertLabelsAlign.value();
						const a = l.horzLabelsAlign.value();
						const u = 0;
						let p = 0;
						const _ = l.text.value();
						const g = l.bold.value();
						const f = l.italic.value();
						const v = o.CHART_FONT_FAMILY;
						const x = l.fontsize.value();
						if ("right" === a) {
							const e = this._labelRenderer.measure().width;
							const t = this._model.timeScale().width();
							c.x + e + 3 >= t
		...
		79191: (e, t, i) => {
			...
			function u(e, t) {
				const i = t.x - e.x;
				const n = t.y - e.y;
				const r = Math.abs(Math.atan2(i, n));
			...
			class p {
				...
				priceToCoordinate(e) {
					...
					const n = null !== i ? i.firstValue() : null;
				...
				isLocked() {
					return Boolean(this._source.isLocked?.());
				}
				addAnchors(e, t) {
					let i = this._points;
					this._model.lineBeingCreated() === this._source &&
				...
				createLineAnchor(e, t) {
					...
					const r = this._getLineAnchorRenderer(t);
					return (
						r.setData({
							...e,
							...
							selectedStrokeWidth: n
								? c.TouchSelectedStrokeWidth
								: c.RegularSelectedStrokeWidth,
							visible: this.areAnchorsVisible(),
						}),
						r
					);
				...
				_updateImpl(e, t) {
					...
					for (let e = 0; e < i.length; e++) {
						const t = i[e];
						const n = this._source.pointToScreenPoint(t);
						if (!n) return;
						const r = n;
				...
				_needLabelExclusionPath(e, t) {
					const i = this._source.properties().childs();
					if ("middle" !== (null != t ? t : i.vertLabelsAlign.value()))
						return !1;
				...
				_updateLabelForLevel({
					...
					switch (L) {
						...
						case "right":
							(P = r.y),
								c
									? (b = T ? this._model.timeScale().width() : i.x)
									: ((b = r.x), (L = "left"));
							break;
						default:
		...
		34658: (e, t, i) => {
			...
			class v {
				...
				drawOn(e) {
					...
					const i = new g.Point(Math.round(t.point.x), Math.round(t.point.y)).add(
							this._translate,
						);
					e.drawImage(
				...
				hasPoint(e) {
					const t = (0, n.ensureNotNull)(this._data);
					const i = t.point.add(this._translate);
					const r = new g.Point(t.point.x - this._translate.x, t.point.y);
				...
				_createSource(e, t, i) {
					...
					const { pixelRatio: s } = this._renderParams;
			...
			class x {
				...
				setData(e) {
					(this._data = e), this._source?.update(e);
				}
				draw(e, t) {
					let i;
					if (null === this._data) return;
				...
				_drawTooltipOn(e, t) {
					...
					const r = String(i.text).replace(/^\s+|\s+$/g, "");
					e.font =
						`${(i.bold ? "bold " : "") +
						(i.italic ? "italic " : "") +
						i.fontSize}px ${i.font}`;
					const s = i.tooltipWidth - 2 * i.tooltipPadding;
					const o = (0, d.wordWrap)(r, e.font, s);
					const a = i.point;
					const l = i.tooltipLineSpacing;
					let p = i.tooltipWidth;
					let _ = o.length * i.fontSize + 2 * i.tooltipPadding;
					o.length > 1 && (_ += (o.length - 1) * l);
					let g = Math.round(a.x - p / 2);
					let f = Math.round(a.y - i.height - _ - 8);
					const v = a.x < 20 || a.x + 20 > i.vpWidth;
					let x = v ? null : "top";
					let m = v ? 0 : Math.round(a.x);
					...
					e.moveTo(w, R),
						v ||
							"top" !== x ||
							(e.lineTo(m - y, R), e.lineTo(m, R - y), e.lineTo(m + y, R)),
						e.lineTo(w + p, R),
						e.lineTo(w + p, R + _),
						v ||
							"bottom" !== x ||
		...
		14002: (e, t, i) => {
			function n(e, t, i) {
				...
				if ("percentage" === e.getLineLengthUnit()) {
					...
					const s = Math.round(t - Math.min(n, r));
		...
		61144: (e, t, i) => {
			...
			const g = o.t(null, void 0, i(16075));
			class f extends d.MediaCoordinatesPaneRenderer {
				...
				_drawImpl(e) {
					...
					const n = this._bodyWidth(t);
					const r = this._quantityWidth(t);
					const s = n + r + this._cancelButtonWidth();
					const { left: o, right: a } = (0, p.orderLineLocation)(
							this._adapter,
							i,
							s,
						);
					const l = Math.round(this._data.points[0].y);
					const d = Math.round(l - (this._height() + 1) / 2);
				...
				_drawMovePoints(e, t, i) {
					...
					const n = t + 4;
					const r = n + 2;
					const s = Math.floor((this._height() - 10) / 2) + 1;
					for (let t = 0; t < s; ++t) {
						const s = i + 5 + 2 * t;
			...
			class x extends r.LineSourcePaneView {
				...
				_updateImpl(e) {
					if (
						...
						const i = e - 3.5 - 1;
						const r = this._adapter.hasMoveCallback()
								? h.HitTarget.MovePoint
								: h.HitTarget.Regular;
						const s = [new n.Point(i, t)];
						this._selectionData = {
							barSpacing: this._model.timeScale().barSpacing(),
							points: s,
			...
			class d extends a.AlertableLineSourcePaneView {
				...
				_updateImpl() {
					...
					if (3 === this._points.length) {
						const e = this._points[0];
						const r = this._points[1];
						const s = this._points[2].y - this._points[0].y;
		...
		87202: (e, t, i) => {
			...
			class d extends l.LineSourcePaneView {
				...
				_updateImpl() {
					...
					const u = t.fillBackground.value();
					const p = t.transparency.value();
					for (let t = 0; t <= 8; t++) {
						const i = `level${t}`;
						const s = this._source.properties().child(i);
						if (s.childs().visible.value()) {
							const i = this._medianPoint.addScaled(
									c,
									s.childs().coeff.value(),
								);
							const l = this._medianPoint.addScaled(c, -s.childs().coeff.value());
							if (u) {
								{
									const t = {
											p1: this._points[0],
							...
							h = s.childs().coeff.value();
							{
								...
								const l = new a.TrendLineRenderer();
								l.setData(r),
									l.setHitTest(
							...
							}
							{
								...
								const r = new a.TrendLineRenderer();
								r.setData(i),
									r.setHitTest(
										new n.HitTestResult(n.HitTarget.MovePoint, void 0, t),
									),
		...
		95337: (e, t, i) => {
			...
			class h extends d.LineSourcePaneView {
				...
				_updateRenderer() {
					...
					const t = e.childs().median.childs();
					const i = new o.CompositeRenderer();
					const n = {
							points: [this._points[0], this._medianPoint],
							color: t.color.value(),
					...
					const c = this._medianPoint.subtract(this._points[0]);
					let u = 0;
					const p = e.childs().fillBackground.value();
					const _ = e.childs().transparency.value();
					for (let t = 0; t <= 8; t++) {
						const n = `level${t}`;
						const o = e.childs()[n];
						if (o.childs().visible.value()) {
							...
							const d = n.add(c);
							const g = this._medianPoint.addScaled(h, -o.childs().coeff.value());
							const f = g.add(c);
							if (p) {
								{
							...
							const x = new l.TrendLineRenderer();
							x.setData(v),
								x.setHitTest(
							...
							const w = new l.TrendLineRenderer();
							w.setData(m),
								w.setHitTest(
									new r.HitTestResult(r.HitTarget.MovePoint, void 0, t),
								),
			...
			class c extends h {
				...
				_updateRenderer() {
					...
					const i = e.childs().median.childs();
					{
						const e = {
							points: [this._points[0], this._points[1]],
							color: i.color.value(),
					...
					}
					{
						...
						const n = this._medianPoint.subtract(this._modifiedBase);
						let o = 0;
						const d = e.childs().fillBackground.value();
						const h = e.childs().transparency.value();
						for (let c = 0; c <= 8; c++) {
							const u = `level${c}`;
							const p = e.child(u);
							if (p.childs().visible.value()) {
								...
								const _ = u.add(n);
								const g = this._medianPoint.addScaled(i, -p.childs().coeff.value());
								const f = g.add(n);
								if (d) {
			...
			class u extends c {
				_calcMofifiedBase() {
					if (this._points.length > 2) {
						...
						const t = 0.5 * (this._points[0].y + this._points[1].y);
						const i = new n.Point(e, t);
			...
			class p extends h {
				...
				_updateRenderer() {
					...
					const t = this._source.properties();
					const i = t.childs().median.childs();
					if (3 === this._points.length) {
						const t = {
					...
					}
					{
						...
						const o = this._points[2].subtract(this._modifiedBase);
						let d = 0;
						const h = t.childs().fillBackground.value();
						const c = t.childs().transparency.value();
						const u = {
						...
						for (let i = 0; i <= 8; i++) {
							const u = `level${i}`;
							const p = t.child(u).childs();
							if (p.visible.value()) {
								const u = this._medianPoint.addScaled(n, p.coeff.value());
								const _ = u.add(o);
								const g = this._medianPoint.addScaled(n, -p.coeff.value());
								const f = g.add(o);
								if (h) {
									{
		...
		46258: (e, t, i) => {
			const n = i(79191).LineSourcePaneView;
			const r = i(47043);
			const s = i(18807).HitTestResult;
			const o = i(18807).HitTarget;
			const a = i(82161).splitThousands;
			const l = i(38223);
			const d = i(53180).appendEllipsis;
			const h = i(15187).MediaCoordinatesPaneRenderer;
			const c = i(14002).orderLineLocation;
			const { setLineStyle: u, drawLine: p, drawPoly: _ } = i(68441);
			const { LINESTYLE_SOLID: g } = i(79849);
			class f extends h {
				constructor(e, t) {
				...
				_getQuantity() {
					const e = this._adapter.getQuantity();
					return Number.isNaN(e) ? e : a(this._adapter.getQuantity(), " ");
				}
				_quantityWidth(e) {
					if (0 === this._getQuantity().length) return 0;
					e.save(), (e.font = this._adapter.getQuantityFont());
				...
				_drawReverseButton(e, t, i) {
					...
					const n = this._reverseButtonWidth();
					const r = this._height();
					...
					const o = t + Math.round((this._reverseButtonWidth() - 6) / 2);
					const a = i + 5;
					e.save(),
						e.translate(o, a),
						s(e, 10),
				...
				_drawCloseButton(e, t, i) {
					...
					const n = this._closeButtonWidth();
					const r = this._height();
					e.fillRect(t + 0.5, i + 0.5, n - 1, r - 1), e.strokeRect(t, i, n, r);
					const s = t + n;
					const o = i + r;
					e.strokeStyle = this._adapter.getCloseButtonIconColor();
					const a = (this._closeButtonWidth() - 8) / 2;
					const l = (this._height() - 8) / 2;
					_(
						e,
						[
							{ x: t + a, y: i + l },
				...
				_drawImpl(e) {
					if (
						...
						return;
					const t = e.context;
					const i = this._data.width;
					const n = this._bodyWidth(t);
					const r = this._quantityWidth(t);
					const s = this._reverseButtonWidth(t);
					const o = n + r + s + this._closeButtonWidth();
					const { left: a, right: l } = c(this._adapter, i, o);
					const d = Math.round(this._data.points[0].y);
					const h = Math.round(d - (this._height() + 1) / 2);
							  ...
							  ? new s(o.Custom, {
										...
										tooltip: {
											text:
												...
												d(i(44352).t(null, void 0, i(11810))),
											rect: {
		...
		75061: (e, t, i) => {
			const n = i(86441).Point;
			const r = i(79191).LineSourcePaneView;
			const s = i(36274).Interval;
			const o = i(18807).HitTestResult;
			const a = i(18807).HitTarget;
			const l = i(19266).CompositeRenderer;
			const d = i(12767).getImage;
			const h = i(37160);
			const c = i(93572).PercentageFormatter;
			const u = i(53741).DateFormatter;
			const p = i(79206).TimeFormatter;
			const _ = i(79206).hourMinuteFormat;
			const g = i(79206).hourMinuteSecondFormat;
			const f = i(2043).TimeSpanFormatter;
			const v = i(87095);
			const x = i(21316);
			const m = i(74359).calcTextHorizontalShift;
			const w = i(38223).isRtl;
			const R = i(68441).drawRoundRect;
			const y = i(29764).makeFont;
			const T = i(15187).MediaCoordinatesPaneRenderer;
			const b = i(38223);
			const P = b.forceLTRStr;
			const L = b.startWithLTR;
			const S = i(46501).CHART_FONT_FAMILY;
			class C extends T {
				constructor() {
					super(),
						(this._data = null),
				...
				drawTargetLabel(e) {
					e.save(), e.translate(0.5, 0.5);
					const t = y(this._targetFontSize1, this._font, "normal");
					const n = y(this._targetFontSize2, this._font, "normal");
					const r = this._data.targetLine1;
					const s = this._data.targetLine2;
					const o = this._data.targetLine3;
					const a = this._data.targetLine4;
					e.font = t;
					const l = e.measureText(r).width;
					const d = e.measureText(s).width;
					const h = e.measureText(" ").width;
					e.font = n;
					const c = e.measureText(o).width;
					const u = e.measureText(a).width;
					const p = e.measureText(" ").width;
					const _ = (this._data.clockWhite?.width) || 0;
					(this._targetWidth = Math.max(l + d + h, c + u + _ + 2 * p) + 8 + 4),
						(this._targetHeight =
							this._targetFontSize1 + this._targetFontSize2 + 9 + 4);
					const g = this._data.points[1];
					const f = g.x + this._targetWidth - e.canvas.width + 5;
					this._targetRectLeftOffset = Math.max(
						20,
						Math.min(this._targetWidth - 15, f),
					);
					const T = "up" === this._data.direction ? "down" : "up";
					const b = this.drawBalloon(
							e,
							g,
							this._targetWidth,
							this._targetHeight,
					...
					const P = 2 + b.x + 4;
					const L = 2 + b.y + 3;
					const S = this._targetWidth - 8 - 4;
					(e.font = t), (e.textAlign = w() ? "right" : "left");
					const C = m(e, S - d - h);
					e.fillText(r, P + C, L);
					const M = m(e, S - l);
					e.fillText(s, P + l + h + M, L), (e.font = n);
					const I = L + this._targetFontSize1 + 3;
					const A = m(e, S - u - _ - p);
					e.fillText(o, P + A, I);
					const k = m(e, S - c - p - _ - u);
					...
					if ((e.fillText(a, P + c + _ + 2 * p + N, I), this._data.status)) {
						...
						switch (
							...
							case x.AlertStatus.Success:
								(D = i(44352).t(null, void 0, i(26787))),
									(B = v.generateColor(
						...
						const H = this._targetFontSize1 + 4;
						const O = e.measureText(D).width;
						const V = Math.round((this._targetWidth - O) / 2);
						const W = m(e, O);
						(e.fillStyle = B),
				...
				drawStartLabel(e) {
					e.save(), e.translate(0.5, 0.5);
					const t = y(this._sourceFontSize1, this._font, "normal");
					const i = y(this._sourceFontSize2, this._font, "normal");
					e.font = t;
					const n = e.measureText(this._data.sourceLine1).width;
					e.font = i;
					const r = e.measureText(this._data.sourceLine2).width;
					(this._sourceWidth = Math.max(n, r) + 6 + 4),
						(this._sourceHeight =
							this._sourceFontSize1 + this._sourceFontSize2 + 6 + 4);
					const s = this._data.points[0];
					const o = s.x + this._sourceWidth - e.canvas.width + 5;
					this._sourceRectLeftOffset = Math.max(
						20,
						Math.min(this._sourceWidth - 15, o),
					);
					const a = this.drawBalloon(
						e,
						s,
						this._sourceWidth,
						this._sourceHeight,
					...
					const l = m(e, this._sourceWidth - 6 - 4);
					const d = 2 + a.x + 3 + l;
					const h = 2 + a.y + 2;
					(e.font = t),
				...
				_drawImpl(e) {
					if (!(null === this._data || this._data.points.length < 2)) {
						...
						const s = Math.max(8, 4 * this._data.linewidth);
						t.fillStyle = this._data.color;
						const o = r.y < 0 ? 1 : -1;
						if (Math.abs(r.x) < 1 || Math.abs(r.y) < 1)
							let a = Math.atan(r.x / r.y);
						else {
							let l;
							let d;
							const h = Math.abs(r.x);
							...
							if (r.length() > s)
								for (;;) {
									...
									const g = Math.sqrt((l - h) * (l - h) + (d - c) * (d - c));
				...
				targetLabelHitTest(e) {
					if (
						...
						return null;
					let t = this._targetHeight + this._arrowHeight;
					this._data.status && (t += this._targetFontSize1 + 10);
					const i = "up" === this._data.direction ? -1 : 1;
					const n = this._radius;
					const r = this._data.points[1];
					const s = r.x - this._targetRectLeftOffset;
					const l = r.y + i * n;
					const d = r.y + i * (t + n);
					const h = Math.min(l, d);
				...
				sourceLabelHitTest(e) {
					if (
						...
						return null;
					const t = "up" === this._data.direction ? 1 : -1;
					const i = this._radius;
					const n = this._data.points[0];
					const r = n.x - this._sourceRectLeftOffset;
					const s = n.y + i * t;
					const l = n.y + (i + this._sourceHeight + this._arrowHeight) * t;
					const d = Math.min(s, l);
					const h = Math.max(s, l);
					return e.x >= r &&
				...
				hitTest(e) {
					...
					const i = this._data.points[1];
					let n = i.subtract(t);
					const r = ((n = i.subtract(t)), e.subtract(t));
					const s = Math.abs(n.x);
					const l = Math.abs(n.y);
					const d = h.sign(n.y) * (l - l * Math.sqrt(1 - (r.x * r.x) / (s * s)));
					if (Math.abs(d - r.y) < 3) return new o(a.MovePoint);
					const c = this.targetLabelHitTest(e);
			...
			t.PredictionPaneView = class extends r {
				...
				_updateImpl() {
					if (
						...
						const e = this._source.ownerSource().formatter();
						const t = this._source.points()[1];
						const n = this._source.points()[0];
						this._targetLine3 = P(e.format(t.price));
						const r = t.price - n.price;
						const o = (r / Math.abs(n.price)) * 100;
						this._targetLine1 = P(
							`${e.format(r)} (${this._percentageFormatter.format(o)})`,
						);
						let a = this._model.timeScale().indexToUserTime(n.index);
						let d = this._model.timeScale().indexToUserTime(t.index);
						n.time &&
							t.time &&
							...
							(d = TradingView.isString(t.time)
								...
								: t.time));
						const h = this._model.mainSeries().isDWM();
						const c = s.parse(this._model.mainSeries().interval());
						const v = c.isSeconds() || c.isTicks();
						if (d && a) {
							(this._targetLine4 = new u().format(d)),
								h ||
									(this._targetLine4 =
										`${this._targetLine4}  ${new p(v ? g : _).format(d)}`);
							const m = (d.valueOf() - a.valueOf()) / 1e3;
							this._targetLine2 =
								`${i(44352).t(null, { context: "dates" }, i(91481))} ${L(new f().format(m))}`;
						}
						(this._sourceLine1 = e.format(n.price)), (this._sourceLine2 = "");
						const w = this._model.timeScale().indexToUserTime(n.index);
						w &&
		...
		86583: (e, t, i) => {
			...
			const r = n.Point;
			const s = n.box;
			const o = i(34026).pointInBox;
			const a = i(79191).LineSourcePaneView;
			const l = i(80101).SelectionRenderer;
			const d = i(18807).HitTestResult;
			const h = i(18807).HitTarget;
			const c = i(19266).CompositeRenderer;
			const u = i(87095);
			const p = i(74359).calcTextHorizontalShift;
			const _ = i(38223).isRtl;
			const g = i(15187).MediaCoordinatesPaneRenderer;
			const f = i(46501);
			class v extends g {
				constructor(e, t) {
					super(),
				...
				_drawImpl(e) {
					if (
						...
						const r = 5;
						const s = i.width + 2 * n;
						const o = i.height + 2 * r;
						const a = this._points[0].x - -9;
						const l = this._points[0].y - (o + 15);
			...
			t.PriceLabelPaneView = class extends a {
				...
				_updateImpl() {
					if (
						...
						const e = this._source.points()[0].price;
						const t = this._source.priceScale();
		...
		29734: (e, t, i) => {
			...
			class x {
				...
				setData(e) {
					...
					const t = e.points[0];
					const i = e.points[1];
					const n = Math.round((180 * Math.atan2(i.y - t.y, i.x - t.x)) / Math.PI);
				...
				draw(e, t) {
					...
					const r = Math.round(i.points[0].x * n);
					const s = Math.round(i.points[0].y * n);
					const o = Math.round(i.points[1].x * n);
					const a = Math.round(i.points[1].y * n);
					(e.lineCap = "round"),
			...
			class m extends l.LineSourcePaneView {
				...
				_updateImpl(e, t) {
					...
					if (null === d) return;
					const h = this._source.properties().childs();
					const c = this._model.dark().value()
					...
					if (h.showLabel?.value()) {
						const n = l[0];
						const s = l[1];
						const o = n.x < s.x ? n : s;
						const d = o === n ? s : n;
						const c = h.vertLabelsAlign.value();
						const p = h.horzLabelsAlign.value();
						let g;
						g =
							"left" === p
								? o.clone()
			...
			class v extends g.DateAndPriceRangeBasePaneView {
				...
				_updateImpl(e, t) {
					...
					if (
						...
						return;
					const d = this._source.properties().childs();
					const h = d.extendLeft.value();
					const g = d.extendRight.value();
					const [v, x] = this._points;
					const m = Math.min(v.x, x.x);
					const w = Math.max(v.x, x.x);
					d.fillBackground.value() &&
						(this._backgroundRenderer.setData({
					...
					const P = new r.Point(b, v.y);
					const L = new r.Point(b, x.y);
					const S = this._updateCustomTextRenderer(e, t);
					...
					const M = this._source.points()[1].price;
					const I = M - C;
					const A = (100 * I) / Math.abs(C);
							...
							null !==
								(a =
									null === (i = N.formatChange) || void 0 === i
										? void 0
										: i.call(N, M, C)) && void 0 !== a
								? a
								: N.format(I);
					const B = (0, s.forceLTRStr)(
							`${D} (${f.format(A)}) ${this._pipFormatter ? this._pipFormatter.format(I) : ""}`,
						);
					let z;
					z =
						M > C
					...
					const W = (0, o.calculateLabelPosition)(V, v, x, E, e);
		...
		75219: (e, t, i) => {
			const n = i(81139).ArcWedgeRenderer;
			const r = i(60322).FibWedgePaneView;
			const s = i(99031).TrendLineRenderer;
			const o = i(19266).CompositeRenderer;
			const a = i(73436).LineEnd;
			t.ProjectionLinePaneView = class extends r {
				...
				_updateRenderer() {
					if (!(this._points.length < 2)) {
						...
						let l = i[2];
						const d = l.data;
						const h = r.subtract(n).length();
						const c = l.subtract(n).normalized();
		...
		31320: (e, t, i) => {
			...
			class h extends l.LineSourcePaneView {
				...
				_updateImpl() {
					...
					const a = this._points[1];
					if (e.showLabel.value()) {
						const t = Math.min(s.x, a.x);
						const o = Math.max(s.x, a.x);
						const l = Math.min(s.y, a.y);
						const d = Math.max(s.y, a.y);
						let h;
						let c;
						let u;
						let p;
				...
				_updateImpl() {
					super._updateImpl(),
						(this._data = ((e, t) => {
							...
							const o = e.mainSeries().firstBar();
							if (!s || s.isEmpty() || r.isEmpty() || !o) return i;
							const a = t.startIndex();
							const l = t.endIndex();
							if (null === a || null === l) return i;
							const d = [t.baseLine(), t.downLine(), t.upLine()];
							const h = Math.round(r.indexToCoordinate(a));
							const _ = Math.round(r.indexToCoordinate(l));
							const g = t.properties();
							const f = [g.styles.baseLine, g.styles.downLine, g.styles.upLine];
							const v = o[4];
							for (let r = 0; r < d.length; r++) {
								if (1 !== (1 & f[r].display.value())) continue;
								const o = (0, n.ensureNotNull)(d[r]).startPrice;
								const a = (0, n.ensureNotNull)(d[r]).endPrice;
								if (void 0 === o || void 0 === a) continue;
								const l = s.priceToCoordinate(o, v);
								const p = s.priceToCoordinate(a, v);
								const x = new c.Point(h, l);
								const m = new c.Point(_, p);
								const w = f[r].color.value();
								const R = f[r].linewidth.value();
								const y = f[r].linestyle.value();
								const T = {
										points: [x, m],
					...
					for (let t = 1; t < i.length; t++) {
						...
						const r = new a.ParallelChannelRenderer(
		...
		56457: (e, t, i) => {
			...
			const b = s.t(null, void 0, i(72892));
			const P = s.t(null, { context: "line_tool_position" }, i(50140));
			const L = s.t(null, { context: "line_tool_position" }, i(44143));
			const S = s.t(null, void 0, i(53115));
			const C = s.t(null, void 0, i(438));
			const M = s.t(null, void 0, i(15166));
			const I = s.t(null, void 0, i(87061));
			class A extends o.LineSourcePaneView {
				constructor() {
					super(...arguments),
				...
				_updateImpl(e, t) {
					...
					const l = null == a ? void 0 : a.barsProvider().bars();
					if (!l || l.isEmpty()) return;
					if (null === l.last()) return;
					const d = 4 === o.length;
					const h = this._source.lastBarData();
					if (!h) return;
					const c = h.closePrice;
					const u = this._source.stopPrice();
					const p = this._source.profitPrice();
					const g = this._source.calculatePL(c);
					const f = a.symbolSource().symbolInfo();
					if (!f) return;
					const x = a.firstValue();
					if (null === x) return;
					const m = this._points[v.RiskRewardPointIndex.Entry].y;
					const w = s.priceToCoordinate(u, x);
					const R = s.priceToCoordinate(p, x);
					const y = s.priceToCoordinate(h.closePrice, x);
					const b = i.indexToCoordinate(h.index);
					const P = this._points[v.RiskRewardPointIndex.Entry].x;
					const L = this._points[v.RiskRewardPointIndex.ActualEntry]
							? this._points[v.RiskRewardPointIndex.ActualEntry].x
							: this._points[v.RiskRewardPointIndex.Close].x;
					const S = this._points[v.RiskRewardPointIndex.ActualClose]
							? this._points[v.RiskRewardPointIndex.ActualClose].x
							: this._points[v.RiskRewardPointIndex.Close].x;
					const C = this._points[v.RiskRewardPointIndex.Close].x;
					const M = this._source.entryPrice();
					const I = this._source.stopPrice();
					const A = this._source.profitPrice();
					const k = {
							pl: g,
							isClosed: d,
							entryLevel: m,
				...
				_createBackgroundRenderers(e, t) {
					...
					if (e.pl < 0 && e.entryX !== e.right) {
						...
						const r = new n.Point(e.right, e.closeLevel);
						const s = 0.01 * i.stopBackgroundTransparency.value();
						const o = 100 - 100 * (1 - s * s * s);
						const a = {
								points: [t, r],
								color: "white",
								linewidth: 0,
					...
					if (e.pl > 0 && e.entryX !== e.right) {
						const t = new n.Point(e.entryX, e.entryLevel);
						const r = new n.Point(e.right, e.closeLevel);
						const s = 0.01 * i.profitBackgroundTransparency.value();
						const o = 100 - 100 * (1 - s * s * s);
						const a = {
								points: [t, r],
								color: "white",
				...
				_creareMiddleLabel(e, t, i) {
					...
					const p = Math.abs(s - o) / Math.abs(s - a);
					const _ = this._source.properties().childs();
					const g = (0, r.ensureNotNull)(this._source.ownerSource());
					const f = new n.Point((h + c) / 2, Math.round(this._points[0].y));
					let v = "";
					let x = "";
					...
					return (
						d < 0
							? (T = _.stopBackground.value())
							: d > 0 && (T = _.profitBackground.value()),
				...
				_createStopLabel(e, t) {
					...
					const c = this._source.properties().childs();
					const u = (0, r.ensureNotNull)(this._source.ownerSource());
					const p = Math.abs(o - a);
					const _ = Math.round((1e4 * p) / a) / 100;
					const g = new n.Point((l + d) / 2, h);
					let f = "";
					const v = u.formatter();
					const m =
							null !==
								...
								? s
								: v.format(p);
					const w = this._percentageFormatter.format(_);
					return (
						(f = c.compact.value()
				...
				_createTargetLabel(e, t) {
					...
					const u = this._source.properties().childs();
					const p = (0, r.ensureNotNull)(this._source.ownerSource());
					const _ = Math.abs(o - a);
					const g = Math.round((1e4 * _) / a) / 100;
					const f = new n.Point((d + h) / 2, c);
					let v = "";
					const m = p.formatter();
					const w =
							null !==
								...
								? s
								: m.format(_);
					const R = this._percentageFormatter.format(g);
					return (
						(v = u.compact.value()
				...
				_createLabelsRenderers(e, t, i) {
					...
					const a = this._createStopLabel(e, t);
					const l = this._createTargetLabel(e, t);
					const d = [
							this._profitLabelRenderer,
							this._stopLabelRenderer,
							this._middleLabelRenderer,
						].reduce((e, t) => Math.max(e, t.measure().width), 0);
					const h = e.edge - e.left;
					const c = this._anchorRadius();
					if (
						h - d - c <= 8 &&
						...
						const a = (0, r.ensureDefined)(o.points)[0].add(
								new n.Point(
									0,
									i *
										t *
		...
		55832: (e, t, i) => {
			const n = i(86441).Point;
			const r = i(4652).distanceToLine;
			const s = i(79191).LineSourcePaneView;
			const o = i(79191).thirdPointCursorType;
			const a = i(99031).TrendLineRenderer;
			const l = i(79797).PolygonRenderer;
			const d = i(19266).CompositeRenderer;
			const h = i(73436).LineEnd;
			const c = i(66103).PaneCursorType;
				...
				_updateImpl() {
					if (
						...
						if (2 === this._points.length) {
							...
							let v;
							const x = g.subtract(_);
							const m = new n(x.y, -x.x).normalized().scaled(this._distance);
							const w = m.scaled(-1);
							(e = _.add(m)),
								(t = g.add(m)),
								(i = _.add(w)),
		...
		26294: (e, t, i) => {
					...
					e.moveTo(a, Math.round(x(this._data) * r)),
						...
						void 0 !== this._data.plate &&
							((e, t, i, n, r) => {
								...
								const c = Math.round(t.x * s);
								const u = t.inverseAnchorPosition
										? Math.round(t.anchorY * s) +
										  Math.round(o * s) * t.direction
										: Math.round(t.anchorY * s) +
										  Math.round((t.labelHeight + a + o) * s) * t.direction;
								const p = (Math.max(1, Math.floor(s)) % 2) / 2;
								const _ = c + p;
								const g = u + p;
								if (
									((e.shadowOffsetY = 1),
								...
								const x = (0, f.strokeScaledRadius)(o, s, v);
								if (
									((e.lineWidth = v),
									e.beginPath(),
			...
			class L extends l.LineSourcePaneView {
				...
				_updateTimelineRenderer(e) {
					...
					const a = this._model.mainSeries();
					const l = this._source.properties().childs();
					const c = l.position.value();
					const u = this._source.customEvent();
					const p =
							i === a
					...
					const g = r.priceToCoordinate(p.price, s);
					const f = l.showImage.value();
					let v = (0, d.positionToCoordinate)(
						c,
						e,
						g,
				...
				async _updateEmoji() {
					...
					const s = (0, T.fetch)(n, { signal: r.signal }).then((e) => e.text());
					const o = { emoji: t, abortController: r };
					this._emojiCache = o;
		...
		5362: (e, t, i) => {
			...
			class d extends o.MediaCoordinatesPaneRenderer {
				...
				_drawImpl(e) {
					...
					const n = e.mediaSize.width - this._data.point.x + i;
					for (let e = 1; e <= n; e += i) {
						const i = (e * Math.PI) / this._data.width;
						const n = (Math.sin(i - Math.PI / 2) * this._data.height) / 2;
						t.lineTo(
			...
			class h extends r.LineSourcePaneView {
				...
				_updateImpl(e, t) {
					...
					const a = Math.abs(s.x - o.x);
					const l = o.y - s.y;
					const h = this._source.properties().childs();
					const c = h.linewidth.value();
		...
		50761: (e, t, i) => {
			...
			class _ extends c.MediaCoordinatesPaneRenderer {
				...
				hitTest(e, t) {
					...
					const o = (0, r.rotationMatrix)(-n);
					const a = (0, r.transformPoint)(o, e.subtract(s));
			...
			class g extends d.LineSourcePaneView {
				...
				_updateImpl(e, t) {
					...
					const h = this._source.getAnchorLimit();
					let c = new n.Point(Math.max(h, s) / 2, 0);
					let u = new n.Point(0, Math.max(h, s) / 2);
					...
					const m = [l.PaneCursorType.Default, l.PaneCursorType.Default, x, x];
					this._renderer.append(
						this.createLineAnchor(
			...
			class _ extends u.LineSourcePaneView {
				...
				_updateImpl(e, t) {
					...
					if (g && !this._noSelection) {
						...
						const i = this._textRenderer.measure();
						const n = i.width;
						const s = i.height;
						if (_.wordWrapWidth) {
		...
		90042: (e, t, i) => {
			...
			class u extends h.LineSourcePaneView {
				...
				_updateImpl() {
					...
					if (this._points.length < 2) return;
					const i = this._source.properties().childs();
					const s = new r.CompositeRenderer();
					const o = (e, t) => ({
							points: [e],
							text: t,
		...
		65557: (e, t, i) => {
			...
			class c extends s.LineSourcePaneView {
				...
				_updateImpl() {
					...
					const t = e[0];
					const i = e[1];
					const s = Math.min(t.index, i.index);
					const o = Math.max(t.index, i.index);
					const a = o - s;
					const l = this._points[0];
					const d = this._points[1];
					const c = Math.abs(l.x - d.x);
					const u = new r.CompositeRenderer();
					const p = this._source.properties().childs();
					const _ = this._model.timeScale();
					if (0 === a) return;
		...
		67998: (e, t, i) => {
			...
			class m extends x.TrendToolWithStatsPaneView {
				...
				_updateImpl(e, t) {
					...
					const v = this._points[0];
					const x = this._points[1];
					const m = this._source.properties().childs();
					...
					(C.data = 1),
						this._renderer.append(this.createLineAnchor({ points: [v, C] }, 0));
				}
			}
		},
		38058: (e, t, i) => {
			...
			class u extends c.LineToolPaneViewFibWithLabels {
				...
				_updateImpl(e, t) {
					...
					if (3 === this._source.points().length) {
						...
						let o = !1;
						p.reverse?.value() && (o = p.reverse.value()),
							(this._levels = []);
						const a = o ? n.price : r.price;
						const l = o ? r.price : n.price;
						const h = a - l;
						let c;
						let u;
						let _;
						...
						const v = { price: h, coordinate: u };
						const x = this._source.levelsCount();
						for (let i = 1; i <= x; i++) {
							const n = p[`level${i}`].childs();
							if (!n.visible.value()) continue;
							const r = n.coeff.value();
							const s = n.color.value();
							const o = (0, d.fibLevelCoordinate)(f, v, r, e, t, g);
							const a = (0, d.fibLevelPrice)(f, v, r, e, t, g);
							this._levels.push({
								color: s,
								price: a,
								y: o,
					...
					const v = Math.max(g.x, u.x);
					const x = p.fillBackground.value();
					const m = p.transparency.value();
					const w = p.extendLinesLeft.value();
					const R = p.extendLines.value();
					if (x)
						for (let e = 0; e < this._levels.length; e++)
							if (e > 0 && x) {
								const t = this._levels[e - 1];
					...
					for (let i = 0; i < this._levels.length; i++) {
						...
						const d = new n.Point(T, this._levels[i].y);
						let c;
				...
				_updateImpl(e, t) {
					...
					if (3 === this._source.points().length) {
						...
						for (let t = 1; t <= 11; t++) {
							...
							if (!i.visible.value()) continue;
							const n = i.coeff.value();
							const o = i.color.value();
							const l = Math.round(s + n * r);
							const d = {
					...
					const [p, _] = this._points;
					const g = a.trendline.childs();
					if (g.visible.value()) {
						const e = {
							points: [p, _],
							color: g.color.value(),
					...
					for (let o = 0; o < this._levels.length; o++) {
						...
						const h = new l.HitTestResult(
								l.HitTarget.MovePoint,
								void 0,
								this._levels[o].index,
							);
						const p = new r.VerticalLineRenderer();
		...
		96310: (e, t, i) => {
			...
			class g extends _.TrendToolWithStatsPaneView {
				...
				_updateImpl(e, t) {
					...
					const w = this._points[1];
					let R;
					if (x.showLabel?.value() && x.text.value().length > 0) {
						const n = m.x < w.x ? m : w;
						const s = n === m ? w : m;
						const o = x.vertLabelsAlign.value();
						const a = x.horzLabelsAlign.value();
						let d;
						d =
							"left" === a
								? n.clone()
					...
					x.statsPosition.value() === d.StatsPosition.Auto &&
						(P = (0, r.equalPoints)(m, w)
							? !(0, s.pointInBox)(m, b)
							: null ===
							  (0, o.intersectLineSegmentAndBox)((0, r.lineSegment)(m, w), b));
					if (
						(((this.isHoveredSource() || this.isSelectedSource()) &&
							this.isEditMode()) ||
					...
					this._middlePoint &&
						...
						this.addAnchors(this._renderer),
						T.points.length >= 2 &&
							this._addAlertRenderer(this._renderer, T.points);
				}
			}
		},
		48063: (e, t, i) => {
			...
			const L = new (class {
					constructor(e, t) {
						...
						e.forEach((e) => {
							...
							n.set(e.theme, new T(e.imageData, t, i)),
			...
			class C {
				...
				draw(e, t) {
					...
					if (this._rect) {
						if (
							...
							const a = (0, n.ensureNotNull)(this._padding);
							for (const n of this._data.icons) {
								const l = Math.round(r.x + a.left);
								const d = Math.round(r.y + a.top + i * s - o);
				...
				_preRender() {
					...
					const t = this._data.points[0].x;
					let i = t;
					const n = this._data.points[0].y;
					let s = n;
					const o = this._fontSize;
					const a = this._lineSpacing;
					const l = (o + a) * this._lines.length - a;
					(e.textBaseline = "top"), (e.font = this.fontStyle());
					const d = [];
					let h;
			...
			const N = M.fontSize;
			const D = M.lineSpacing;
			const B = M.paddingTopBottom;
			...
			class H {
				...
				destroy() {
					this._canvas = undefined, this._ctx = undefined;
				}
				canvas() {
					return this._canvas;
				}
				...
				rowHeight(e) {
					...
					const i = (0, n.ensureDefined)(this._sourcesToRow.get(t)).effectiveState;
				...
				updateSource(e, t) {
					...
					const o = this._effectiveState(e);
				...
				_effectiveState(e) {
					...
					const s = r.showBarsRange?.value();
					const o = r.showDateTimeRange?.value();
					const a = r.showDistance?.value();
					const l = r.showPriceRange?.value();
					const d =
				...
				_repaintSource(e, t, i) {
					(i.points[0] = new r.Point(0, 0)),
						i.horzAlign = undefined,
						i.vertAlign = undefined;
			...
			class V extends A.AlertableLineSourcePaneView {
				...
				getCacheRects(e, t) {
					...
					const o = (0, n.ensureNotNull)(this._statCache);
					const a = this._source.properties().childs().statsPosition.value();
					const l = this._getPointsForStats();
					const d = {
							left: 0,
					...
					const h = a === O.StatsPosition.Auto ? O.StatsPosition.Center : a;
					let c = l[h].x + 10;
					let u = l[h].y;
					const p =
					...
					p ? (u -= 10 + d.height) : (u += 10),
						a !== O.StatsPosition.Auto ||
							...
							(0, s.intersectLineSegmentAndBox)(
								...
								(c =
									Math.min(l[O.StatsPosition.Center].x, e.cssWidth) -
									d.width)));
					return {
						cacheRect: d,
						targetRect: {
				...
				_priceRange() {
					...
					const [i, r] = this._source.points();
					const s = this._source.properties().childs();
					const o = s.showPriceRange.value();
					const a = s.showPercentPriceRange.value();
					const l = s.showPipsPriceRange.value();
					const d = (0, n.ensureNotNull)(this._source.ownerSource());
					let h;
					if (this._source.priceScale() && (o || a || l)) {
						const n = [];
						const s = r.price - i.price;
						if (o || a) {
				...
				_statLabelData() {
					...
					const f = r.showDateTimeRange?.value();
					const v = r.showDistance?.value();
					const x = r.showAngle?.value();
					if (x || v) {
					...
					if (g || f || v) {
						if (
							...
							const n = this._model.timeScale().indexToUserTime(t.index);
							if (i && n) {
								const e = (n.valueOf() - i.valueOf()) / 1e3;
								const t = (0, a.startWithLTR)(new c.TimeSpanFormatter().format(e));
								t && (l += g ? ` (${t})` : t);
							}
						}
						v &&
					...
					const w = m ? "rgba(67,70,81,0.9)" : "rgba(227,242,253,0.9)";
					const R = m ? "#F8F9FD" : "#2A2E39";
					const y = {
		...
		23545: (e, t, i) => {
			...
			class p extends c.LineSourcePaneView {
				...
				_updateImpl() {
					...
					if (this._points.length < 2) return;
					const p = this._source.properties().childs();
					const _ = new o.CompositeRenderer();
					const g = (e, t) => ({
							points: [e],
							text: t,
		...
		97615: (e, t, i) => {
			const n = i(79191).LineSourcePaneView;
			const r = i(19266).CompositeRenderer;
			const s = i(10695).TriangleRenderer;
		...
		77444: (e, t, i) => {
			...
			class u extends h.AlertableLineSourcePaneView {
				...
				_updateImpl(e, t) {
					...
					const a = new r.CompositeRenderer();
					let h;
					let u = !0;
					if (1 === this._points.length) {
				...
				_needLabelExclusionPath(e) {
					const t = this._source.properties().childs();
					const i = "horizontal" === t.textOrientation.value();
					const n = t.text.value();
					if (i) return "" !== n.trim();
		...
		21477: (e, t, i) => {
			...
			class o {
				...
				draw(e, t) {
					...
					const n = t.pixelRatio;
					const r = this._cacheProvider.getCacheCanvas(t);
					e.drawImage(
						r,
			...
			class o extends s.MediaCoordinatesPaneRenderer {
				...
				hitTest(e) {
					...
					if (Math.abs(i - this._data.radius) <= 4) {
						...
						const i = e.subtract(this._data.p2).length();
						if (
					...
					if (this._data.fillBackground && i <= this._data.radius) {
						...
						const i = this._data.p2.subtract(this._data.center).normalized();
						const n = t.normalized();
						const r = e.dotProduct(i);
						const s = n.dotProduct(e);
						const o = n.dotProduct(i);
		...
		2436: (e, t, i) => {
			...
			function r(e, t, i, r, s) {
				...
				const a = Math.max(3 / o, 0.02);
				let l;
				for (let o = 0; ; o += a) {
					o > 1 && (o = 1);
					const a = e.scaled((1 - o) * (1 - o));
					const d = i.scaled(2 * o * (1 - o));
					const h = t.scaled(o * o);
					const c = a.add(d).add(h);
					if (void 0 !== l) {
			...
			function s(e, t, i, r, s, o) {
				const a =
						...
						r.subtract(i).length() +
						t.subtract(r).length();
				const l = Math.max(3 / a, 0.02);
				let d;
				for (let a = 0; ; a += l) {
					a > 1 && (a = 1);
					const l = e.scaled((1 - a) * (1 - a) * (1 - a));
					const h = i.scaled(3 * (1 - a) * (1 - a) * a);
					const c = r.scaled(3 * (1 - a) * a * a);
					const u = t.scaled(a * a * a);
					const p = l.add(h).add(c).add(u);
					if (void 0 !== d) {
			...
			function o(e, t, i, n, r) {
				...
				const o = ((e, t, i, n, r) => {
					const s = [];
					const o = a(e.y, t.y, i.y, 0).concat(a(e.y, t.y, i.y, r));
				...
				for (let n = 0; n < o.length - 1; n += 2) {
					...
					while (s <= a) {
						...
						const o = i.scaled(2 * s * (1 - s));
						const d = t.scaled(s * s);
						const h = n.add(o).add(d);
						if (l.length > 0) {
		...
		14146: (e, t, i) => {
			...
			class u extends c.MediaCoordinatesPaneRenderer {
				...
				_drawImpl(e) {
					if (null === this._data) return;
					const t = e.context;
					const i = this._visiblePolygon(e.mediaSize);
					if (null !== i) {
			...
			function p(e, t, i, n) {
				const r = (0, s.equalPoints)(i, n[0])
					? (0, s.equalPoints)(i, n[1])
						? null
						: n[1]
					: n[0];
		...
		70531: (e, t, i) => {
			...
			class d extends a.MediaCoordinatesPaneRenderer {
				...
				hitTest(e) {
					...
					const t = this._data.points[0];
					const i = this._data.points[1];
					const n = 0.5 * Math.abs(t.x - i.x);
					const o = Math.abs(t.x - i.x);
					const a = Math.abs(t.y - i.y);
					const l = t.add(i).scaled(0.5);
					let d = e.subtract(l);
		...
		79059: (e, t, i) => {
			...
			class x extends c.BitmapCoordinatesPaneRenderer {
				...
				hitTest(e) {
					...
					const o = (0, h.interactionTolerance)().anchor;
				...
				_drawImpl(e) {
					...
					for (let e = 0; e < this._data.points.length; ++e) {
						...
						const o = this._data.backgroundColors[e];
				...
				_drawPoints(e, t, i, n, r) {
					...
					const c = (0, s.ensureNotNull)(this._data);
					const p = c.currentPoint;
					const _ = c.radius;
					...
					v % 2 !== f % 2 && (v += 1);
					const x = (f % 2) / 2;
					const m = (0, h.interactionTolerance)().anchor;
			...
			class p extends c.MediaCoordinatesPaneRenderer {
				constructor(e, t) {
					super(),
						(this._data = null),
						(this._hittestResult =
							e || new l.HitTestResult(l.HitTarget.MovePoint)),
						(this._backHittestResult =
							t || new l.HitTestResult(l.HitTarget.MovePointBackground));
				}
				setData(e) {
					this._data = e;
				}
				hitTest(e, t) {
					...
					const o = this._extendAndHitTestLineSegment(e, r, s, i);
					if (null !== o) return o;
					if (4 === this._data.points.length && !this._data.skipTopLine) {
						const [, , t, n] = this._data.points;
						const o = this._extendAndHitTestLineSegment(e, t, n, i);
						if (null !== o) return o;
						if (this._data.showMidline && !this._data.skipLines) {
							const o = r.add(t).scaled(0.5);
							const a = s.add(n).scaled(0.5);
							const l = this._extendAndHitTestLineSegment(e, o, a, i);
							if (null !== l) return l;
						}
					}
				...
				_drawImpl(e) {
					...
					if (this._data.points.some((e) => !Number.isFinite(e.y)))
						...
						if (
							...
							this._data.fillBackground &&
								this._drawBackground(t, this._data.points, e.mediaSize),
				...
				_extendAndHitTestLineSegment(e, t, i, n) {
					const r = this._extendAndClipLineSegment(t, i, n);
					if (null !== r) {
						if ((0, o.distanceToSegment)(r[0], r[1], e).distance <= 3)
				...
				_hitTestBackground(e) {
					...
					const o = (n.y - i.y) / (n.x - i.x);
					const a = i.y + o * (e.x - i.x);
					const l = s.y + o * (e.x - s.x);
					const d = Math.max(a, l);
					const h = Math.min(a, l);
					const c = Math.min(i.x, n.x);
					const u = Math.max(i.x, n.x);
		...
		79797: (e, t, i) => {
			...
			class p extends d.MediaCoordinatesPaneRenderer {
				...
				_drawImpl(e) {
					...
					const d = null !== (t = this._data.linecap) && void 0 !== t ? t : a;
					(n.lineCap = d),
				...
				_drawImpl(e) {
					...
					const n =
							(null !== (t = this._data.linestyle) && void 0 !== t
								? t
								: h.LINESTYLE_SOLID) === h.LINESTYLE_SOLID
								? "round"
								: "butt";
					(i.lineCap = n),
						(i.lineJoin = "round"),
						...
						void 0 !== this._data.linestyle &&
							(0, d.setLineStyle)(i, this._data.linestyle);
					const [r, s] = this._data.points;
					const o = 2 === this._data.points.length ? s : this._data.points[2];
					i.beginPath(),
						i.moveTo(r.x, r.y),
						i.lineTo(s.x, s.y),
						i.lineTo(o.x, o.y),
