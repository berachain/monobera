  ...
  [9401],
  {
    ...
    34026: (e, t, n) => {
      ...
      (t.pointInHalfplane = function (e, t) {
        ...
        (t.pointInPolygon = function (e, t) {
          for (
            var n = t.length - 1, r = !1, u = e.x, o = e.y, d = 0;
            d < t.length;
            d++
          ) {
            var i = t[d],
    ...
    5531: (e, t, n) => {
      ...
      (t.intersectLineSegmentAndBox = function (e, t) {
        ...
        for (
          var l = f(n, r, i, a, s, c), _ = f(o, d, i, a, s, c), h = !1, p = 0;
          ;
          ...
          (l.minus = l.sub =
            function (e) {
              ...
              var s = o.c.slice(),
                ...
                l = e.e;
              if (!s[0] || !f[0])
                return f[0] ? (e.s = -a) : s[0] ? (e = new d(o)) : (e.s = 1), e;
              if ((i = c - l)) {
                for (
          ...
          (l.plus = l.add =
            function (e) {
              ...
              var d = u.e,
                ...
                s = e.c;
              if (!i[0] || !s[0])
                return s[0] || (i[0] ? (e = new o(u)) : (e.s = u.s)), e;
              if (((i = i.slice()), (t = d - a))) {
                for (
    ...
    80838: (e, t, n) => {
      ...
      const o = function (e, t) {
        for (
          var n = 0, o = (t = (0, r.default)(t, e)).length;
          null != e && n < o;
    ...
    12644: (e, t, n) => {
      ...
      const r = function (e, t) {
        for (
          var n = -1, r = null == e ? 0 : e.length, u = 0, o = [];
          ++n < r;
    ...
    52222: (e, t, n) => {
      ...
      var d = n(56838),
        i = n(43744);
      const a = function (e) {
        return "function" != typeof e.constructor || (0, i.default)(e)
          ? {}
          : o((0, d.default)(e));
      };
    },
    ...
    14314: (e, t, n) => {
      ...
      const T = function (e, t, n) {
        return (
          ...
          function () {
            for (
              var r = arguments, u = -1, o = I(r.length - t, 0), d = Array(o);
              ++u < o;
    ...
    99094: (e, t, n) => {
      ...
      const O = function (e, t, n) {
        for (
          var r = -1, u = (t = (0, y.default)(t, e)).length, o = !1;
          ++r < u;
      ...
      var d = (function () {
        ...
        return (
          ...
          (e.prototype.unsubscribeBitmapSizeChanged = function (e) {
            this._bitmapSizeChangedListeners =
              this._bitmapSizeChangedListeners.filter(function (t) {
                return t !== e;
              });
          }),
          ...
          (e.prototype._chooseAndInitObserver = function () {
            ...
            this._allowResizeObserver
              ? new Promise(function (e) {
                  ...
                  .then(function (t) {
                    return t
                      ? e._initResizeObserver()
                      : e._initDevicePixelRatioObservable();
                  })
