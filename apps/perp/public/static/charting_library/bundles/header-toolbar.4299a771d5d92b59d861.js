	...
	[3005],
	{
		...
		54079: (e, t, s) => {
			...
			const d = (0, n.forwardRef)((e, t) => {
				...
				const p = o.PLATFORM_ACCESSIBILITY_ENABLED
				...
				return (
					...
					n.createElement("div", {
						...
						onKeyDown: (0, i.createSafeMulticastEventHandler)((e) => {
							...
							const n = (0, o.queryFocusableElements)(s).sort(
								o.navigationOrderComparator,
							);
		...
		46618: (e, t, s) => {
				...
				return (
					((o = class extends n.PureComponent {
							...
							super(e),
								...
								(this._checkButtonsVisibility = () => {
									const { isVisibleLeftButton: e, isVisibleRightButton: t } =
										this.state;
									const s = this.isAtLeft();
									const n = this.isAtRight();
									s || e
						...
						render() {
							...
							const { isVisibleRightButton: g, isVisibleLeftButton: S } =
								this.state;
							const y = d && h;
							return n.createElement(
								_.Measure,
			...
			class j extends n.PureComponent {
				constructor(e, t) {
					super(e, t),
						...
						(this._handleInnerResize = ([e]) => {
							...
							const { onWidthChange: s } = this.props;
							s?.(t);
						}),
				...
				render() {
					...
					const f = this._processCustoms(c);
					const g = this._processCustoms(u);
					const S = d.includes(s);
					return n.createElement(
						q.Toolbar,
						{
			...
			const Q = s(97145);
			const K = s(68456);
			class J extends K.CommonJsonStoreService {
				constructor(e, t, s = []) {
			...
			const $ = s(94025);
			const Z = s(15051);
			class ee extends K.AbstractJsonStoreService {
				constructor(e, t, s) {
			...
			const ne = s(56840);
			const re = s(21097);
			class ie extends K.AbstractJsonStoreService {
				constructor(e, t, s = []) {
					super(
						e,
						t,
			...
			class le {
				...
				add(e, t, s) {
					...
					const r = this.getCustomIntervals();
			...
			class ye extends K.CommonJsonStoreService {
			...
			class Ve extends n.PureComponent {
				...
				render() {
					...
					const d = { ...u, isFake: !0, showScrollbarWhen: Re };
					const h = (0, i.ensureDefined)(t);
					const m = this.props.tools.PublishButtonManager || n.Fragment;
					return n.createElement(
						H.RegistryProvider,
				...
				addDropdown(e, t) {
					...
					const r = { type: "Dropdown", id: e, params: t };
					"left" === t.align
				...
				removeDropdown(e) {
					...
					const s = this.state.leftCustomElements.filter(t);
					const n = this.state.rightCustomElements.filter(t);
				...
				_addCustomHTMLButton(e, t = "left") {
					const s = new Q.WatchedValue(0);
					const n = (0, Ie.parseHtmlElement)(
