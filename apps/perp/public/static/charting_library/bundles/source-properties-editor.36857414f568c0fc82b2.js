	...
	[6780],
	{
		...
		48531: (e, t, i) => {
			...
			function g(e) {
				...
				const [n, r] = (0, m.useHover)();
				const o = a.useCallback(() => s(t), [s, t]);
		...
		75892: (e, t, i) => {
			...
			class E extends a.PureComponent {
				constructor(e) {
					super(e),
						...
						(this._handleSelectPage = (e) => {
							...
							const i = this._getActionPageById(t);
							const a = this._getActionPageById(e);
							const s = this._getActiveTabSettingsName();
							t !== e &&
								(this._unsubscribe(i),
								s && c().setValue(s, e),
								this._subscribe(a),
						...
						(this._closePopupDialog = () => {
							window.lineToolPropertiesToolbar?.refresh(), this.props.onClose();
						});
					const { pages: t } = this.props;
					let i;
				...
				componentDidMount() {
					...
					const t = this._getActionPageById(e);
			...
			const w = i(85067);
			class M extends w.DialogRenderer {
				constructor(e) {
					super(),
						(this._timeout = null),
						(this._handleClose = () => {
		...
		68495: (e, t, i) => {
			...
			function h(e) {
				...
				const [g, f] = (0, a.useState)(p);
				const [b, v] = (0, a.useState)(p);
				return (
					(0, a.useEffect)(() => {
						t &&
							_.current &&
		...
		66512: (e, t, i) => {
			...
			function g(e) {
				...
				const T = g && t.filter((e) => e.id === g).length > 0 ? g : t[0].id;
				const S = b
					.model()
					.lineToolsGroupModel()
					.groupForLineTool(f[0]);
				const k = !!(
					v &&
					S &&
					r &&
				...
				const [y, z] = (0, a.useState)(T);
				const [D, I] = (0, a.useState)(!1);
				const [x, C] = (0, a.useState)(r || _);
				const L = (0, a.useMemo)(
					() =>
						t.map(({ title: e, id: t }) => ({
							label: e,
