	...
	[1584],
	{
				...
				(o = (e) => {
					...
					(e.disableBodyScroll = (e, n) => {
						if (r) {
							...
							const v = { targetElement: e, options: n || {} };
							i = [].concat(t(i), [v]);
						}
						let m;
					}),
		...
		41590: (e, t, o) => {
			...
			function h(e) {
				...
				const [p] = (0, n.useState)(() => (0, s.randomHash)());
				const w = (0, n.useRef)(null);
				const g = (0, n.useContext)(c.CloseDelegateContext);
				return (
					(0, n.useLayoutEffect)(
						() => (
					...
					this._onShow?.(),
						...
						this._render({
							...
							position: (t, o, n, r) => {
								...
								const f = null !== (u = e.marginY) && void 0 !== u ? u : 0;
								let p;
								let w;
								switch (
									((p =
								...
								let g;
								let _ =
									null !== (h = e.attachToYBy) && void 0 !== h ? h : "auto";
								"auto-strict" === _ &&
