	...
	[3179],
	{
		...
		36383: (e, t, n) => {
			...
			function r(e) {
				...
				const d = (0, s.useRef)(new CustomEvent("timestamp").timeStamp);
				return (
					(0, s.useLayoutEffect)(() => {
						const e = { click: t, mouseDown: n, touchEnd: r, touchStart: o };
						const s = a ? a.current : c.current;
				...
				constructor(e) {
					super(e),
						...
						(this._handleMeasure = ({
							...
							const v = (0, o.ensureNotNull)(this._containerRef);
							...
							const W = "function" === typeof _ ? _(M, S, x, y) : _;
							const R =
								null !==
									(i =
							...
							const E =
								...
								(null !==
									...
									? u
									: 0);
							const O = (0, l.clamp)(W.x, R, Math.max(R, E));
							const N =
								(null !==
									(d =
							...
							const D =
								...
								(null !==
									...
									? m
									: 0);
							let T = (0, l.clamp)(W.y, N, Math.max(N, D));
							if (
						...
						(this._restoreScrollPosition = () => {
							...
							const t = (0, o.ensureNotNull)(this._containerRef);
