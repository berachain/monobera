      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <Card className="border-primary">
            <CardHeader className="rounded-t-lg border-b border-y-primary p-3 text-sm text-primary-foreground">
              Effective price: 1 {fromToken.symbol} = 0.5 {toToken.symbol}
            </CardHeader>
            <CardContent className="border-primary p-3">
              <div className="relative -mx-3 grid grid-cols-1 divide-y divide-primary">
                ...
                <div className="absolute right-4 top-[calc(50%-16px)] border-none bg-white">
                  <Icons.arrowDown className="h-8 w-8 rounded-full border border-primary p-1" />
                </div>
        ...
        <div>
          <Card className="border-primary">
            <Tabs defaultValue="tokens" className="">
              <CardHeader className="flex flex-row items-center justify-between rounded-t-lg border-b border-y-primary p-3 text-base font-medium text-primary-foreground">
              ...
              <CardContent className="border-primary px-3 pb-4 pt-1">
