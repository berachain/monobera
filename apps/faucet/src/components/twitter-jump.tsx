...
export default function TwitterJump({
  ...
  const text = `HENLO+%26+OOGA+BOOGA+🐻%0A%0ASnag+your+testnet+tokens+now+%26+join+the+Bera+Brigade!%0A%0ATurn+your+liquidity+into+security+with+@berachain%0AArtio+-+the+first+L1+NOT+backed+by+Paradigm🫵🐻⛓️%0A%0AProof+of+Drip🔑:%23BID=${bid}%0A`;
