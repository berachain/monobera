export const BERA_VAULT_REWARDS_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "incentiveRate", type: "uint256", internalType: "uint256" },
    ],
    outputs: [],
  ...
  },
  {
    ...
    outputs: [
      { name: "minIncentiveRate", type: "uint256", internalType: "uint256" },
      { name: "incentiveRate", type: "uint256", internalType: "uint256" },
  ...
  },
  {
    ...
    name: "setDistributor",
    inputs: [
      { name: "_rewardDistribution", type: "address", internalType: "address" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
