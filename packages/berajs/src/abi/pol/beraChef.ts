export const BERA_CHEF_ABI = [
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: "", type: "address", internalType: "contract IBeaconDeposit" },
    ],
    stateMutability: "view",
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "isFriend", type: "bool", indexed: true, internalType: "bool" },
    ],
    anonymous: false,
  },
  {
  ...
  { type: "error", name: "PayoutTokenIsZero", inputs: [] },
  ...
  { type: "error", name: "RewardCycleStarted", inputs: [] },
