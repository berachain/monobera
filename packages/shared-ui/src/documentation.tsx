  ...
  return (
    <section className={cn(className)}>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="mx-auto flex w-full flex-col items-center justify-between rounded-2xl border bg-muted px-12 py-8 text-center lg:items-start lg:text-left">
          ...
          <p className="mb-8 text-sm font-semibold md:text-2xl">
            Are you a fellow builder in the making? Check out our docs and start
            building on Berachain today.
          </p>
          <Link href={docLink ?? `${docsUrl}/developers/`} target="_blank">
