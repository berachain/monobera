...
export const RewardBanner = () => {
  return (
    <div className="relative flex items-center rounded-md border border-amber-500 bg-honey-gradient p-4 px-8 py-6 md:h-40 md:p-4">
      <Image
      ...
      <div className="flex h-full w-full flex-col justify-between gap-4 md:ml-[204px] md:flex-row md:items-center  lg:px-4">
        ...
        <div className="flex h-full items-center gap-12">
          <div className="flex h-full w-full flex-col gap-2 md:flex-row md:gap-6">
            <div className="bg-whites flex h-full w-full justify-between rounded-md border border-amber-500 bg-gradient-to-br from-white via-white to-amber-50 px-5 py-4 md:w-[138px] md:flex-col">
              <div>
