    ...
    test("with tokens", async () => {
      ...
      addLiquidityOutput.addLiquidityQueryOutput.amountsIn
        ...
        .forEach(({ amount }, index) => {
          const delta = amount - functionOutput.tokenAmounts[index].rawAmount;
          expect(Number(delta)).to.be.closeTo(0, 5); // 5 wei of tolerance
        });
    });
  });
    ...
    const tokens = [
      {
        ...
        address: "0x156c02f3f7fef64a3a9d80ccf7085f23cce91d76" as Address, // vETH/WETH BPT
        decimals: 18,
        index: 0,
      },
      {
        ...
        address: "0x4bc3263eb5bb2ef7ad9ab6fb68be80e43b43801f" as Address, // VETH
        decimals: 18,
        index: 1,
      },
      {
