...
export const VAULT: Record<number, Address> = {
  ...
  [ChainId.BARTIO]: "0x1c69C3e3246f1c5744BB3c7791c7aeA2fc1b3E48",
};
...
export const BALANCER_QUERIES: Record<number, Address> = {
  ...
  [ChainId.BARTIO]: "0xD64a39b70eB097505e08f438062fd217DFd14291",
};
...
export const WEIGHTED_POOL_FACTORY_BALANCER_V2: Record<number, Address> = {
  ...
  [ChainId.BARTIO]: "0x9cEe10E726F9F29C65609d2CeC59203A0E4cB9e8",
};
...
export const COMPOSABLE_STABLE_POOL_FACTORY: Record<number, Address> = {
  ...
  [ChainId.BARTIO]: "0x789445c393c78B595eef56E9b4dEFeE867DA6B99",
};
