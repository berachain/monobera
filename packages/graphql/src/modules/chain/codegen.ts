 ...
 * });
 */
export function useGetBlocksTimeStampQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetBlocksTimeStampQuery,
    GetBlocksTimeStampQueryVariables
  > &
    (
      | { variables: GetBlocksTimeStampQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  ...
  return Apollo.useQuery<
    GetBlocksTimeStampQuery,
    GetBlocksTimeStampQueryVariables
  >(GetBlocksTimeStampDocument, options);
}
export function useGetBlocksTimeStampLazyQuery(
...
export function useGetBlocksTimeStampSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
...
export type GetBlocksTimeStampQueryHookResult = ReturnType<
  typeof useGetBlocksTimeStampQuery
>;
export type GetBlocksTimeStampLazyQueryHookResult = ReturnType<
  typeof useGetBlocksTimeStampLazyQuery
>;
export type GetBlocksTimeStampSuspenseQueryHookResult = ReturnType<
  typeof useGetBlocksTimeStampSuspenseQuery
>;
export type GetBlocksTimeStampQueryResult = Apollo.QueryResult<
  GetBlocksTimeStampQuery,
  GetBlocksTimeStampQueryVariables
>;
