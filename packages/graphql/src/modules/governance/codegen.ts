...
export type GetVotesQuery = { __typename?: 'Query', votes: Array<{ __typename?: 'Vote', id: any, params?: any | null, proposalId: any, voter: any, weight: any, support: number, reason: string, timestamp: any }> };
...
export type GovernanceProposalsQuery = { __typename?: 'Query', proposals: Array<{ __typename?: 'Proposal', proposalId: any, createdAt: any, createdAtBlock: any, id: string, status: string, targets: Array<any>, values: Array<any>, voteEnd: any, voteStart: any, queuedAtBlock?: any | null, signatures: Array<string>, queuedAt?: any | null, proposer: any, executedAtBlock?: any | null, executedAt?: any | null, description: string, canceledAtBlock?: any | null, canceledAt?: any | null, calldatas: Array<any> }> };
...
export type ProposalDetailsQuery = { __typename?: 'Query', proposal?: { __typename?: 'Proposal', proposalId: any, createdAt: any, createdAtBlock: any, id: string, status: string, targets: Array<any>, values: Array<any>, voteEnd: any, voteStart: any, queuedAtBlock?: any | null, signatures: Array<string>, queuedAt?: any | null, proposer: any, executedAtBlock?: any | null, executedAt?: any | null, description: string, canceledAtBlock?: any | null, canceledAt?: any | null, calldatas: Array<any> } | null };
...
export function useGovernanceProposalsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GovernanceProposalsQuery, GovernanceProposalsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GovernanceProposalsQuery, GovernanceProposalsQueryVariables>(GovernanceProposalsDocument, options);
        }
...
export type GovernanceProposalsSuspenseQueryHookResult = ReturnType<typeof useGovernanceProposalsSuspenseQuery>;
 ...
 * });
 */
export function useProposalDetailsQuery(baseOptions: Apollo.QueryHookOptions<ProposalDetailsQuery, ProposalDetailsQueryVariables> & ({ variables: ProposalDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
