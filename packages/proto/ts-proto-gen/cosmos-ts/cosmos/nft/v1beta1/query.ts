...
export const QueryOwnerRequest = {
  ...
  create<I extends Exact<DeepPartial<QueryOwnerRequest>, I>>(
    base?: I,
  ): QueryOwnerRequest {
...
export const QueryOwnerResponse = {
  ...
  create<I extends Exact<DeepPartial<QueryOwnerResponse>, I>>(
    base?: I,
  ): QueryOwnerResponse {
...
export const QuerySupplyRequest = {
  ...
  create<I extends Exact<DeepPartial<QuerySupplyRequest>, I>>(
    base?: I,
  ): QuerySupplyRequest {
...
export const QuerySupplyResponse = {
  ...
  create<I extends Exact<DeepPartial<QuerySupplyResponse>, I>>(
    base?: I,
  ): QuerySupplyResponse {
...
export const QueryNFTsRequest = {
  ...
  create<I extends Exact<DeepPartial<QueryNFTsRequest>, I>>(
    base?: I,
  ): QueryNFTsRequest {
...
export const QueryNFTsResponse = {
  ...
  create<I extends Exact<DeepPartial<QueryNFTsResponse>, I>>(
    base?: I,
  ): QueryNFTsResponse {
...
export const QueryNFTRequest = {
  ...
  create<I extends Exact<DeepPartial<QueryNFTRequest>, I>>(
    base?: I,
  ): QueryNFTRequest {
...
export const QueryNFTResponse = {
  ...
  create<I extends Exact<DeepPartial<QueryNFTResponse>, I>>(
    base?: I,
  ): QueryNFTResponse {
...
export class QueryClientImpl implements Query {
  ...
  Owner(request: QueryOwnerRequest): Promise<QueryOwnerResponse> {
    ...
    return promise.then((data) =>
      QueryOwnerResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  Supply(request: QuerySupplyRequest): Promise<QuerySupplyResponse> {
    ...
    return promise.then((data) =>
      QuerySupplyResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  NFTs(request: QueryNFTsRequest): Promise<QueryNFTsResponse> {
    ...
    return promise.then((data) =>
      QueryNFTsResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  NFT(request: QueryNFTRequest): Promise<QueryNFTResponse> {
    ...
    return promise.then((data) =>
      QueryNFTResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  Class(request: QueryClassRequest): Promise<QueryClassResponse> {
    ...
    return promise.then((data) =>
      QueryClassResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  Classes(request: QueryClassesRequest): Promise<QueryClassesResponse> {
    ...
    return promise.then((data) =>
      QueryClassesResponse.decode(_m0.Reader.create(data)),
    );
  }
}
