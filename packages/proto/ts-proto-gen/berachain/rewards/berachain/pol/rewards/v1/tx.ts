...
export const SetWithdrawAddressRequest = {
  encode(message: SetWithdrawAddressRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SetWithdrawAddressRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<SetWithdrawAddressRequest>, I>>(base?: I): SetWithdrawAddressRequest {
    return SetWithdrawAddressRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SetWithdrawAddressRequest>, I>>(object: I): SetWithdrawAddressRequest {
    const message = createBaseSetWithdrawAddressRequest();
...
export const SetWithdrawAddressResponse = {
  encode(_: SetWithdrawAddressResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): SetWithdrawAddressResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<SetWithdrawAddressResponse>, I>>(base?: I): SetWithdrawAddressResponse {
    return SetWithdrawAddressResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SetWithdrawAddressResponse>, I>>(_: I): SetWithdrawAddressResponse {
    const message = createBaseSetWithdrawAddressResponse();
    return message;
  },
};
...
export const WithdrawDepositorRewardRequest = {
  encode(message: WithdrawDepositorRewardRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.depositorAddress !== "") {
      writer.uint32(10).string(message.depositorAddress);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WithdrawDepositorRewardRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<WithdrawDepositorRewardRequest>, I>>(base?: I): WithdrawDepositorRewardRequest {
...
export const WithdrawDepositorRewardResponse = {
  encode(message: WithdrawDepositorRewardResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WithdrawDepositorRewardResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<WithdrawDepositorRewardResponse>, I>>(base?: I): WithdrawDepositorRewardResponse {
...
export interface MsgService {
  ...
  SetWithdrawAddress(request: SetWithdrawAddressRequest): Promise<SetWithdrawAddressResponse>;
  /** WithdrawDepositorReward defines a method for withdrawing the rewards of a depositor. */
  WithdrawDepositorReward(request: WithdrawDepositorRewardRequest): Promise<WithdrawDepositorRewardResponse>;
}
...
export class MsgServiceClientImpl implements MsgService {
  ...
  SetWithdrawAddress(request: SetWithdrawAddressRequest): Promise<SetWithdrawAddressResponse> {
    ...
    return promise.then((data) => SetWithdrawAddressResponse.decode(_m0.Reader.create(data)));
  }

  WithdrawDepositorReward(request: WithdrawDepositorRewardRequest): Promise<WithdrawDepositorRewardResponse> {
    const data = WithdrawDepositorRewardRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "WithdrawDepositorReward", data);
    return promise.then((data) => WithdrawDepositorRewardResponse.decode(_m0.Reader.create(data)));
  }
}
