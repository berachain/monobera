...
export const Bribe = {
  ...
  fromJSON(object: any): Bribe {
    return {
      ...
      startEpoch: isSet(object.startEpoch) ? Long.fromValue(object.startEpoch) : Long.UZERO,
      numBlockProposals: isSet(object.numBlockProposals) ? Long.fromValue(object.numBlockProposals) : Long.UZERO,
  ...
  toJSON(message: Bribe): unknown {
    ...
    if (!message.numBlockProposals.isZero()) {
      obj.numBlockProposals = (message.numBlockProposals || Long.UZERO).toString();
    }
    if (!message.numBlockProposalsBribed.isZero()) {
      obj.numBlockProposalsBribed = (message.numBlockProposalsBribed || Long.UZERO).toString();
    }
    if (message.bribePerProposal?.length) {
      obj.bribePerProposal = message.bribePerProposal.map((e) => Coin.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Bribe>, I>>(object: I): Bribe {
    ...
    message.startEpoch = (object.startEpoch !== undefined && object.startEpoch !== null)
      ...
      : Long.UZERO;
    message.numBlockProposals = (object.numBlockProposals !== undefined && object.numBlockProposals !== null)
      ? Long.fromValue(object.numBlockProposals)
      : Long.UZERO;
    message.numBlockProposalsBribed =
      (object.numBlockProposalsBribed !== undefined && object.numBlockProposalsBribed !== null)
        ? Long.fromValue(object.numBlockProposalsBribed)
        : Long.UZERO;
    message.bribePerProposal = object.bribePerProposal?.map((e) => Coin.fromPartial(e)) || [];
    return message;
  },
};
