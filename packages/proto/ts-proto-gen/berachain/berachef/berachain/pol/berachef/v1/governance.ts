...
export const UpdateFriendsOfTheChefRequest = {
  encode(message: UpdateFriendsOfTheChefRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateFriendsOfTheChefRequest {
  ...
  fromJSON(object: any): UpdateFriendsOfTheChefRequest {
    return {
      ...
      friendOfTheChef: isSet(object.friendOfTheChef) ? Boolean(object.friendOfTheChef) : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<UpdateFriendsOfTheChefRequest>, I>>(base?: I): UpdateFriendsOfTheChefRequest {
...
export const UpdateFriendsOfTheChefResponse = {
  encode(_: UpdateFriendsOfTheChefResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateFriendsOfTheChefResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<UpdateFriendsOfTheChefResponse>, I>>(base?: I): UpdateFriendsOfTheChefResponse {
    return UpdateFriendsOfTheChefResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpdateFriendsOfTheChefResponse>, I>>(_: I): UpdateFriendsOfTheChefResponse {
    const message = createBaseUpdateFriendsOfTheChefResponse();
    return message;
  },
};
