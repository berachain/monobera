...
export const CuttingBoard = {
  encode(message: CuttingBoard, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.consAddr !== "") {
  ...
  create<I extends Exact<DeepPartial<CuttingBoard>, I>>(base?: I): CuttingBoard {
    return CuttingBoard.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CuttingBoard>, I>>(object: I): CuttingBoard {
    const message = createBaseCuttingBoard();
...
export const Weight = {
  encode(message: Weight, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
