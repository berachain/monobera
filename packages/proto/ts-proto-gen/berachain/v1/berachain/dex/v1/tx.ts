...
function createBaseCreatePoolRequest(): CreatePoolRequest {
  return { name: "", denoms: [], poolType: "", options: new Uint8Array(0), liquidity: [], creator: "" };
}
...
export const CreatePoolRequest = {
  ...
  fromJSON(object: any): CreatePoolRequest {
    return {
      ...
      options: isSet(object.options) ? bytesFromBase64(object.options) : new Uint8Array(0),
...
export const CreatePoolResponse = {
  encode(message: CreatePoolResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): CreatePoolResponse {
    return { poolAddress: isSet(object.poolAddress) ? String(object.poolAddress) : "" };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CreatePoolResponse>, I>>(object: I): CreatePoolResponse {
    const message = createBaseCreatePoolResponse();
...
export const SingleSwapParam = {
  encode(message: SingleSwapParam, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.poolAddress !== "") {
      writer.uint32(10).string(message.poolAddress);
    }
    if (message.kind !== 0) {
  ...
  fromJSON(object: any): SingleSwapParam {
    return {
      ...
      assetIn: isSet(object.assetIn) ? Coin.fromJSON(object.assetIn) : undefined,
      assetOut: isSet(object.assetOut) ? Coin.fromJSON(object.assetOut) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<SingleSwapParam>, I>>(base?: I): SingleSwapParam {
    return SingleSwapParam.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SingleSwapParam>, I>>(object: I): SingleSwapParam {
    const message = createBaseSingleSwapParam();
    message.poolAddress = object.poolAddress ?? "";
...
export const SingleSwapRequest = {
  encode(message: SingleSwapRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.account !== "") {
      writer.uint32(10).string(message.account);
    }
    if (message.singleSwap !== undefined) {
      SingleSwapParam.encode(message.singleSwap, writer.uint32(18).fork()).ldelim();
    }
  ...
  fromJSON(object: any): SingleSwapRequest {
    return {
      ...
      singleSwap: isSet(object.singleSwap) ? SingleSwapParam.fromJSON(object.singleSwap) : undefined,
      deadlineHeight: isSet(object.deadlineHeight) ? Long.fromValue(object.deadlineHeight) : Long.ZERO,
    };
  },
  ...
  create<I extends Exact<DeepPartial<SingleSwapRequest>, I>>(base?: I): SingleSwapRequest {
    return SingleSwapRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SingleSwapRequest>, I>>(object: I): SingleSwapRequest {
    const message = createBaseSingleSwapRequest();
    message.account = object.account ?? "";
    message.singleSwap = (object.singleSwap !== undefined && object.singleSwap !== null)
      ? SingleSwapParam.fromPartial(object.singleSwap)
      : undefined;
    message.deadlineHeight = (object.deadlineHeight !== undefined && object.deadlineHeight !== null)
...
export const SingleSwapResponse = {
  encode(message: SingleSwapResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): SingleSwapResponse {
    return { execution: Array.isArray(object?.execution) ? object.execution.map((e: any) => Coin.fromJSON(e)) : [] };
  },
  ...
  create<I extends Exact<DeepPartial<SingleSwapResponse>, I>>(base?: I): SingleSwapResponse {
    return SingleSwapResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SingleSwapResponse>, I>>(object: I): SingleSwapResponse {
    const message = createBaseSingleSwapResponse();
...
function createBaseBatchSwapStep(): BatchSwapStep {
  return { poolAddress: "", assetInIndex: Long.UZERO, assetOutIndex: Long.UZERO };
}

export const BatchSwapStep = {
  encode(message: BatchSwapStep, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.poolAddress !== "") {
      writer.uint32(10).string(message.poolAddress);
    }
  ...
  fromJSON(object: any): BatchSwapStep {
    return {
      poolAddress: isSet(object.poolAddress) ? String(object.poolAddress) : "",
      assetInIndex: isSet(object.assetInIndex) ? Long.fromValue(object.assetInIndex) : Long.UZERO,
      assetOutIndex: isSet(object.assetOutIndex) ? Long.fromValue(object.assetOutIndex) : Long.UZERO,
    };
  },
  ...
  create<I extends Exact<DeepPartial<BatchSwapStep>, I>>(base?: I): BatchSwapStep {
    return BatchSwapStep.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BatchSwapStep>, I>>(object: I): BatchSwapStep {
    const message = createBaseBatchSwapStep();
    message.poolAddress = object.poolAddress ?? "";
    message.assetInIndex = (object.assetInIndex !== undefined && object.assetInIndex !== null)
      ? Long.fromValue(object.assetInIndex)
      : Long.UZERO;
    message.assetOutIndex = (object.assetOutIndex !== undefined && object.assetOutIndex !== null)
...
function createBaseBatchSwapRequest(): BatchSwapRequest {
  return { kind: 0, account: "", swaps: [], assets: [], deadlineHeight: Long.ZERO };
}

export const BatchSwapRequest = {
  encode(message: BatchSwapRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.kind !== 0) {
  ...
  fromJSON(object: any): BatchSwapRequest {
    return {
      kind: isSet(object.kind) ? Number(object.kind) : 0,
      account: isSet(object.account) ? String(object.account) : "",
      swaps: Array.isArray(object?.swaps) ? object.swaps.map((e: any) => BatchSwapStep.fromJSON(e)) : [],
  ...
  create<I extends Exact<DeepPartial<BatchSwapRequest>, I>>(base?: I): BatchSwapRequest {
    return BatchSwapRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BatchSwapRequest>, I>>(object: I): BatchSwapRequest {
    const message = createBaseBatchSwapRequest();
    message.kind = object.kind ?? 0;
    message.account = object.account ?? "";
    message.swaps = object.swaps?.map((e) => BatchSwapStep.fromPartial(e)) || [];
...
export const BatchSwapResponse = {
  encode(message: BatchSwapResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.execution) {
      Coin.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<BatchSwapResponse>, I>>(base?: I): BatchSwapResponse {
    return BatchSwapResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BatchSwapResponse>, I>>(object: I): BatchSwapResponse {
    const message = createBaseBatchSwapResponse();
    message.execution = object.execution?.map((e) => Coin.fromPartial(e)) || [];
    return message;
  },
...
export const AddLiquidityRequest = {
  encode(message: AddLiquidityRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.poolAddress !== "") {
      writer.uint32(10).string(message.poolAddress);
    }
    if (message.account !== "") {
  ...
  create<I extends Exact<DeepPartial<AddLiquidityRequest>, I>>(base?: I): AddLiquidityRequest {
    return AddLiquidityRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AddLiquidityRequest>, I>>(object: I): AddLiquidityRequest {
    const message = createBaseAddLiquidityRequest();
    message.poolAddress = object.poolAddress ?? "";
    message.account = object.account ?? "";
...
export const AddLiquidityResponse = {
  encode(message: AddLiquidityResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AddLiquidityResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): AddLiquidityResponse {
    return {
      shares: Array.isArray(object?.shares) ? object.shares.map((e: any) => Coin.fromJSON(e)) : [],
  ...
  create<I extends Exact<DeepPartial<AddLiquidityResponse>, I>>(base?: I): AddLiquidityResponse {
    return AddLiquidityResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AddLiquidityResponse>, I>>(object: I): AddLiquidityResponse {
    const message = createBaseAddLiquidityResponse();
    message.shares = object.shares?.map((e) => Coin.fromPartial(e)) || [];
    message.liquidityAdded = object.liquidityAdded?.map((e) => Coin.fromPartial(e)) || [];
    return message;
  },
};
...
export const RemoveLiquidityBurningSharesRequest = {
  encode(message: RemoveLiquidityBurningSharesRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.poolAddress !== "") {
      writer.uint32(10).string(message.poolAddress);
    }
    if (message.account !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RemoveLiquidityBurningSharesRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<RemoveLiquidityBurningSharesRequest>, I>>(
    object: I,
  ): RemoveLiquidityBurningSharesRequest {
    const message = createBaseRemoveLiquidityBurningSharesRequest();
    message.poolAddress = object.poolAddress ?? "";
...
export const RemoveLiquidityBurningSharesResponse = {
  encode(message: RemoveLiquidityBurningSharesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.liquidity) {
      Coin.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RemoveLiquidityBurningSharesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<RemoveLiquidityBurningSharesResponse>, I>>(
    ...
    return RemoveLiquidityBurningSharesResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RemoveLiquidityBurningSharesResponse>, I>>(
    object: I,
  ): RemoveLiquidityBurningSharesResponse {
    const message = createBaseRemoveLiquidityBurningSharesResponse();
    message.liquidity = object.liquidity?.map((e) => Coin.fromPartial(e)) || [];
...
function createBaseRemoveLiquidityExactAmountRequest(): RemoveLiquidityExactAmountRequest {
  return { poolAddress: "", account: "", receiver: "", asset: undefined, maxShares: undefined };
}

export const RemoveLiquidityExactAmountRequest = {
  encode(message: RemoveLiquidityExactAmountRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.poolAddress !== "") {
      writer.uint32(10).string(message.poolAddress);
    }
    if (message.account !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RemoveLiquidityExactAmountRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RemoveLiquidityExactAmountRequest {
    return {
      ...
      maxShares: isSet(object.maxShares) ? Coin.fromJSON(object.maxShares) : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RemoveLiquidityExactAmountRequest>, I>>(
    object: I,
  ): RemoveLiquidityExactAmountRequest {
    const message = createBaseRemoveLiquidityExactAmountRequest();
    message.poolAddress = object.poolAddress ?? "";
    ...
    message.maxShares = (object.maxShares !== undefined && object.maxShares !== null)
...
export const RemoveLiquidityExactAmountResponse = {
  encode(message: RemoveLiquidityExactAmountResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.liquidity) {
      Coin.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    for (const v of message.shares) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RemoveLiquidityExactAmountResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<RemoveLiquidityExactAmountResponse>, I>>(
    object: I,
  ): RemoveLiquidityExactAmountResponse {
    const message = createBaseRemoveLiquidityExactAmountResponse();
    message.liquidity = object.liquidity?.map((e) => Coin.fromPartial(e)) || [];
...
export interface MsgService {
  ...
  RemoveLiquidityExactAmount(request: RemoveLiquidityExactAmountRequest): Promise<RemoveLiquidityExactAmountResponse>;
...
export class MsgServiceClientImpl implements MsgService {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.RemoveLiquidityBurningShares = this.RemoveLiquidityBurningShares.bind(this);
    this.RemoveLiquidityExactAmount = this.RemoveLiquidityExactAmount.bind(this);
  ...
  CreatePool(request: CreatePoolRequest): Promise<CreatePoolResponse> {
    ...
    return promise.then((data) => CreatePoolResponse.decode(_m0.Reader.create(data)));
  }

  AddLiquidity(request: AddLiquidityRequest): Promise<AddLiquidityResponse> {
    const data = AddLiquidityRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "AddLiquidity", data);
    return promise.then((data) => AddLiquidityResponse.decode(_m0.Reader.create(data)));
  }
  ...
  RemoveLiquidityBurningShares(
    ...
    const promise = this.rpc.request(this.service, "RemoveLiquidityBurningShares", data);
    return promise.then((data) => RemoveLiquidityBurningSharesResponse.decode(_m0.Reader.create(data)));
  }

  RemoveLiquidityExactAmount(request: RemoveLiquidityExactAmountRequest): Promise<RemoveLiquidityExactAmountResponse> {
    const data = RemoveLiquidityExactAmountRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "RemoveLiquidityExactAmount", data);
    return promise.then((data) => RemoveLiquidityExactAmountResponse.decode(_m0.Reader.create(data)));
  }

  SingleSwap(request: SingleSwapRequest): Promise<SingleSwapResponse> {
    const data = SingleSwapRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SingleSwap", data);
    return promise.then((data) => SingleSwapResponse.decode(_m0.Reader.create(data)));
  }

  BatchSwap(request: BatchSwapRequest): Promise<BatchSwapResponse> {
    const data = BatchSwapRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "BatchSwap", data);
    return promise.then((data) => BatchSwapResponse.decode(_m0.Reader.create(data)));
  }
}
