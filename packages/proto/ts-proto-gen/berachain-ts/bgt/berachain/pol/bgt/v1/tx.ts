...
export const RedeemBgtRequest = {
  ...
  fromJSON(object: any): RedeemBgtRequest {
    return {
      ...
      bgtBurned: Array.isArray(object?.bgtBurned)
        ? object.bgtBurned.map((e: any) => Coin.fromJSON(e))
        : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<RedeemBgtRequest>, I>>(
    base?: I,
  ): RedeemBgtRequest {
    return RedeemBgtRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RedeemBgtRequest>, I>>(
    object: I,
  ): RedeemBgtRequest {
    const message = createBaseRedeemBgtRequest();
...
export const RedeemBgtResponse = {
  ...
  create<I extends Exact<DeepPartial<RedeemBgtResponse>, I>>(
    base?: I,
  ): RedeemBgtResponse {
    return RedeemBgtResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RedeemBgtResponse>, I>>(
    object: I,
  ): RedeemBgtResponse {
    const message = createBaseRedeemBgtResponse();
...
export class MsgServiceClientImpl implements MsgService {
  ...
  RedeemBgt(request: RedeemBgtRequest): Promise<RedeemBgtResponse> {
    ...
    return promise.then((data) =>
      RedeemBgtResponse.decode(_m0.Reader.create(data)),
    );
  }
}
