...
export interface MsgService {
  ...
  UpdateFriendsOfTheChef(
    request: UpdateFriendsOfTheChefRequest,
  ): Promise<UpdateFriendsOfTheChefResponse>;
...
export class MsgServiceClientImpl implements MsgService {
  ...
  QueueNewCuttingBoard(
    ...
    return promise.then((data) =>
      QueueNewCuttingBoardResponse.decode(_m0.Reader.create(data)),
    );
  }
  ...
  UpdateFriendsOfTheChef(
    ...
    return promise.then((data) =>
      UpdateFriendsOfTheChefResponse.decode(_m0.Reader.create(data)),
    );
  }
