...
const badgeVariants = cva(
  "inline-flex items-center border rounded-full px-2 py-1 font-thin transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 h-fit text-xs",
  {
    variants: {
      variant: {
        default: "bg-primary border-transparent text-primary-foreground",
        secondary: "bg-muted border-border text-muted-foreground",
        outline: "text-foreground border-muted-foreground",
        destructive:
