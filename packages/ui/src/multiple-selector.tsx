...
function transToGroupOption(options: Option[], groupBy?: string) {
  ...
  options.forEach((option: Option) => {
    ...
    (groupOption[key] as Option[]).push(option);
  });
  return groupOption;
}
  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "group rounded-md border border-border px-3 py-2 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2",
            className,
          )}
        >
